...
window.SITE_CONFIG = {
    ...
    psychometrics: [
      {
        ...
        limitations: 'Narzędzie samoopisowe podatne na tendencyjność odpowiedzi.',
        ethicalNotes: 'Wymaga reakcji klinicznej przy odpowiedziach sugerujących ryzyko samobojcze.',
        contraindications: 'Nie zastępuje wywiadu diagnostycznego przy ostrych kryzysach.',
      },
      /* Popularne narzedzia przesiewowe i kliniczne dopisane do katalogu psychometrii. */
      {
        ...
        ethicalNotes: 'Pozycja o myślach samobojczych wymaga natychmiastowej oceny ryzyka i planu bezpieczenstwa.',
      ...
      },
      {
        ...
        population: 'Mlodziez i dorosli w przesiewie zaburzen lękowych',
        ageRange: '13+',
        ...
        validity: 'Dobra trafnosc dla zaburzen lękowych, szczegolnie GAD, z użytecznoscia przesiewowa.',
        normsInfo: 'Wynik interpretowac progowo, z uwzglednieniem kontekstu klinicznego i wspolchorobowosci.',
        limitations: 'Krótka forma moze pomijac specyfike innych zaburzen lekowych niz GAD.',
      ...
      },
      {
        ...
        limitations: 'Narzędzie samoopisowe nie rozstrzyga rozpoznania PTSD bez wywiadu klinicznego.',
      ...
      },
      {
        ...
        reliability: 'Wysoka rzetelnosc obu podskal, szczegolnie dla lęku jako cechy.',
        validity: 'Dobra trafnosc teoretyczna dla rozroznienia stanu i cechy lęku.',
        ...
        contraindications: 'Ostroznosc interpretacyjna w ostrych stanach somatycznych nasilajacych objawy lęku.',
      },
      {
        id: 'dass_21',
        ...
        validity: 'Umiarkowanie dobra trafnosc roznicowa miedzy depresja, lękiem i stresem.',
        normsInfo: 'Interpretacja progowa zalezna od wersji jezykowej i charakterystyki populacji.',
        limitations: 'Narzędzie przesiewowe, bez bezposredniego mapowania na rozpoznania nozologiczne.',
      ...
      },
      {
        ...
        limitations: 'Długi czas badania i wysokie wymagania interpretacyjne.',
    ...
    disorders: [
      {
        ...
        validity: 'Dobra trafnosc treściowa wobec kryteriow DSM dla ADHD dorosłych.',
        normsInfo: 'Brak klasycznych norm stenowych; interpretacja kryterialna.',
        limitations: 'Wynik zalezy od jakości wywiadu retrospektywnego i danych zewnętrznych.',
        ethicalNotes: 'Wymaga triangulacji danych, by ograniczyć nadrozpoznawalnosc.',
        contraindications: 'Ograniczona użytecznosc przy braku wiarygodnych danych z dzieciństwa.',
      },
      {
        id: 'ados_2',
        ...
        ethicalNotes: 'Nie nalezy formułować diagnozy ASD wyłącznie na podstawie ADOS-2.',
    ...
    neuro: [
      {
        ...
        limitations: 'Silny wpływ motywacji, zmeczenia i zaburzen widzenia barw.',
        ethicalNotes: 'Interpretowac lacznie z innymi testami funkcji wykonawczych.',
        contraindications: 'Daltonizm i ostre stany neurologiczne mogą znieksztalcac wynik.',
      },
      {
        id: 'tmt',
        ...
        normsInfo: 'Wyniki należy odnosić do norm wieku i edukacji.',
        limitations: 'Wynik zależy od sprawnosci motorycznej i umiejetnosci wzrokowo-przestrzennych.',
    ...
    spoleczna: [
      {
        ...
        limitations: 'Samoopis sprzyja efektowi aprobaty społecznej.',
      ...
      },
      {
        ...
        limitations: 'Krótka skala nie rozroznia subtelnych profili samooceny.',
  ...
  nav: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'students/wystapienia_publiczne_autoprezentacja', label: 'Wystąpienia publiczne i autoprezentacja', file: 'wiki/students/wystapienia_publiczne_autoprezentacja.md' },
        { id: 'students/psycholog_w_it', label: 'Psycholog w IT', file: 'wiki/students/psycholog_w_it.md' },
    ...
    },
    {
      ...
      items: [
        { id: 'philosophy/wprowadzenie',                 label: 'Filozofia',                   file: 'wiki/philosophy/wprowadzenie.md'        },
    ...
    },
    {
      ...
      domainKey: 'emotions',
      items: [
        { id: 'emotions/emocje_wprowadzenie', label: 'Emocje',   file: 'wiki/emotions/emocje_wprowadzenie.md'  },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'temperament/rozwoj',                  label: 'Temperament, a rozwój',                file: 'wiki/temperament/rozwoj.md'                   },
    ...
    },
    {
      ...
      items: [
        { id: 'individual_diffs/roznice_wprowadzenie', label: 'Różnice ind.', file: 'wiki/individual_diffs/roznice_wprowadzenie.md' },
    ...
    },
    {
      ...
      items: [
        { id: 'psychometrics/psychometria_wprowadzenie', label: 'Psychometria', file: 'wiki/psychometrics/psychometria_wprowadzenie.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'neuro/zachowanie_i_dwie_polkule_mozgu',     label: 'Zachowanie i dwie półkule mózgu',         file: 'wiki/neuro/zachowanie_i_dwie_polkule_mozgu.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'cases/clive_wearing', label: 'Clive Wearing',               file: 'wiki/cases/clive_wearing.md' },
        { id: 'cases/elliot',        label: 'Elliot',                      file: 'wiki/cases/elliot.md'        },
        { id: 'cases/df',            label: 'Pacjentka D.F.',              file: 'wiki/cases/df.md'            },
        { id: 'cases/kc',            label: 'Pacjent K.C.',                file: 'wiki/cases/kc.md'            },
        { id: 'cases/na',            label: 'Pacjent N.A.',                file: 'wiki/cases/na.md'            },
        { id: 'cases/patient_kn',    label: 'Pacjent K.N.',                file: 'wiki/cases/patient_kn.md'    },
        { id: 'cases/patient_rb',    label: 'Pacjent R.B.',                file: 'wiki/cases/patient_rb.md'    },
        { id: 'cases/ps',            label: 'Pacjent P.S.',                file: 'wiki/cases/ps.md'            },
        { id: 'cases/sm',            label: 'Pacjentka S.M. (uszkodzenie ciała migdałowatego)', file: 'wiki/cases/sm.md' },
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'cognitive/test_stroopa',           label: 'Test Stroopa',                    file: 'wiki/cognitive/test_stroopa.md'           },
        { id: 'cognitive/przyklad_testu_stroopa', label: 'Przykład testu Stroopa',          file: 'wiki/cognitive/przyklad_testu_stroopa.md' },
        ...
        { id: 'cognitive/uklad_siatkowaty',       label: 'Układ siatkowaty (ARAS)',         file: 'wiki/cognitive/uklad_siatkowaty.md'       },
    ...
    
    {
      ...
      items: [
        { id: 'psychosomatics/wprowadzenie',               label: 'Psychosomatyka',    file: 'wiki/psychosomatics/wprowadzenie.md'               },
    ...
    
    {
      ...
      domainKey: 'nvc',
      items: [
        { id: 'nvc/wprowadzenie',              label: 'NVC',                    file: 'wiki/nvc/wprowadzenie.md'              },
    ...
    },
    {
      ...
      items: [
        { id: 'artetherapy/arteterapia_wprowadzenie', label: 'Arteterapia', file: 'wiki/artetherapy/arteterapia_wprowadzenie.md' },
    ...
    },
    {
      ...
      items: [
        { id: 'animaltherapy/animaloterapia_wprowadzenie', label: 'Animaloterapia', file: 'wiki/animaltherapy/animaloterapia_wprowadzenie.md' },
    ...
    },
    {
      ...
      items: [
        { id: 'school_psychology/wprowadzenie',                  label: 'Psych. szkolna',            file: 'wiki/school_psychology/wprowadzenie.md'                  },
    ...
    },
    {
      ...
      items: [
        { id: 'neurodiversity/wprowadzenie',               label: 'Neuroróżnorodność',    file: 'wiki/neurodiversity/wprowadzenie.md'               },
    ...
    },
    {
      ...
      items: [
        { id: 'psychotherapy/psychoterapia_wprowadzenie', label: 'Psychoterapia', file: 'wiki/psychotherapy/psychoterapia_wprowadzenie.md' },
        ...
        { id: 'psychotherapy/somatic_experiencing', label: 'Somatic Experiencing (SE)', file: 'wiki/psychotherapy/somatic_experiencing.md' },
        { id: 'psychotherapy/systemy_rodzinne', label: 'Systemy rodzinne', file: 'wiki/psychotherapy/systemy_rodzinne.md' },
    ...
    },
    {
      ...
      items: [
        { id: 'suicidology/suicydologia_wprowadzenie', label: 'Suicydologia', file: 'wiki/suicidology/suicydologia_wprowadzenie.md' },
    ...
    },
    {
      ...
      domainKey: 'sexology',
      items: [
        { id: 'sexology/seksuologia_wprowadzenie', label: 'Seksuologia', file: 'wiki/sexology/seksuologia_wprowadzenie.md' },
    ...
    },
    {
      ...
      items: [
        { id: 'forensic_psychology/wprowadzenie',            label: 'Biegły psycholog',       file: 'wiki/forensic_psychology/wprowadzenie.md'            },
    ...
    },
    {
      ...
      domainKey: 'e_therapy',
      items: [
        { id: 'e_therapy/wprowadzenie',                  label: 'E-terapia',              file: 'wiki/e_therapy/wprowadzenie.md'                  },
    ...
    },
    {
      ...
      items: [
        { id: 'ai_psychology/wprowadzenie',         label: 'Psychologia AI',             file: 'wiki/ai_psychology/wprowadzenie.md'           },
    ...
    },
    {
      ...
      items: [
        { id: 'affective_robotics/wprowadzenie',                   label: 'Robotyka afektywna',         file: 'wiki/affective_robotics/wprowadzenie.md'                    },
    ...
    },
    {
      ...
      domainKey: 'ppd',
      items: [
        { id: 'ppd/wprowadzenie',             label: 'Seminarium dyplomowe',    file: 'wiki/ppd/wprowadzenie.md'             },
    ...
    },
    {
      ...
      items: [
        { id: 'reacting_to_criticism/czym_jest_krytyka_i_informacja_zwrotna', label: 'Krytyka, a informacja zwrotna - rozróżnienie', file: 'wiki/reacting_to_criticism/czym_jest_krytyka_i_informacja_zwrotna.md' },
  ...
  plans: {
    ...
    neuro: [
      ...
      { file: 'wiki/neuro/zachowanie_i_dwie_polkule_mozgu.md', label: 'Zachowanie i dwie półkule mózgu', status: 'live' },
    ...
    cognitive: [
      ...
      { file: 'wiki/cognitive/test_stroopa.md',       label: 'Test Stroopa',               status: 'live' },
      { file: 'wiki/cognitive/przyklad_testu_stroopa.md', label: 'Przykład testu Stroopa', status: 'live' },
      ...
      { file: 'wiki/cognitive/uklad_siatkowaty.md',       label: 'Układ siatkowaty (ARAS)',      status: 'live' },
    ...
    individual_diffs: [
      { file: 'wiki/individual_diffs/roznice_wprowadzenie.md', label: 'Różnice ind.', status: 'live' },
    ...
    temperament: [
      ...
      { file: 'wiki/temperament/rozwoj.md',                   label: 'Temperament, a rozwój',               status: 'live' },
    ...
    emotions: [
      { file: 'wiki/emotions/emocje_wprowadzenie.md', label: 'Emocje',    status: 'live' },
    ...
    psychotherapy: [
      { file: 'wiki/psychotherapy/psychoterapia_wprowadzenie.md', label: 'Psychoterapia', status: 'live' },
      ...
      { file: 'wiki/psychotherapy/somatic_experiencing.md', label: 'Somatic Experiencing (SE)', status: 'live' },
      { file: 'wiki/psychotherapy/systemy_rodzinne.md', label: 'Systemy rodzinne', status: 'live' },
      ...
      { file: 'wiki/psychotherapy/heksafleks_act.md', label: 'Heksafleks ACT',             status: 'live' },
    ...
    psychopathology: [
      { file: 'wiki/psychopathology/psychopatologia_wprowadzenie.md', label: 'Psychopatologia', status: 'live' },
    ...
    suicidology: [
      { file: 'wiki/suicidology/suicydologia_wprowadzenie.md', label: 'Suicydologia', status: 'live' },
    ...
    sexology: [
      { file: 'wiki/sexology/seksuologia_wprowadzenie.md', label: 'Seksuologia', status: 'live' },
    ...
    artetherapy: [
      { file: 'wiki/artetherapy/arteterapia_wprowadzenie.md', label: 'Arteterapia', status: 'live' },
    ...
    animaltherapy: [
      { file: 'wiki/animaltherapy/animaloterapia_wprowadzenie.md', label: 'Animaloterapia', status: 'live' },
    ...
    health_psychology: [
      { file: 'wiki/health_psychology/zdrowie_wprowadzenie.md',    label: 'Psychologia zdrowia', status: 'live' },
    ...
    psychosomatics: [
      { file: 'wiki/psychosomatics/wprowadzenie.md',               label: 'Psychosomatyka',      status: 'live' },
    ...
    cases: [
      ...
      { file: 'wiki/cases/clive_wearing.md', label: 'Clive Wearing', status: 'live' },
      { file: 'wiki/cases/elliot.md',        label: 'Elliot', status: 'live' },
      { file: 'wiki/cases/df.md',            label: 'Pacjentka D.F.', status: 'live' },
      { file: 'wiki/cases/kc.md',            label: 'Pacjent K.C.', status: 'live' },
      { file: 'wiki/cases/na.md',            label: 'Pacjent N.A.', status: 'live' },
      { file: 'wiki/cases/patient_kn.md',    label: 'Pacjent K.N.', status: 'live' },
      { file: 'wiki/cases/patient_rb.md',    label: 'Pacjent R.B.', status: 'live' },
      { file: 'wiki/cases/ps.md',            label: 'Pacjent P.S.', status: 'live' },
      { file: 'wiki/cases/sm.md',            label: 'Pacjentka S.M. (uszkodzenie ciała migdałowatego)', status: 'live' },
    ],
    reference: [
    ...
    game_psychology: [
      { file: 'wiki/game_psychology/wprowadzenie.md',         label: 'Psychologia gier wideo', status: 'live' },
    ...
    resilience_mobbing: [
      { file: 'wiki/resilience_mobbing/odpornosc_wprowadzenie.md',  label: 'Odporność psychiczna',      status: 'live' },
    ...
    media_nature: [
      { file: 'wiki/media_nature/wprowadzenie.md',             label: 'Ekrany, książki i natura',                    status: 'live' },
    ...
    positive_psychology: [
      { file: 'wiki/positive_psychology/wprowadzenie.md',           label: 'Psychologia pozytywna',    status: 'live' },
    ...
    ai_psychology: [
      { file: 'wiki/ai_psychology/wprowadzenie.md',          label: 'Psychologia AI',             status: 'live' },
    ...
    affective_robotics: [
      { file: 'wiki/affective_robotics/wprowadzenie.md',                    label: 'Robotyka afektywna',         status: 'live' },
    ...
    school_psychology: [
      { file: 'wiki/school_psychology/wprowadzenie.md',                 label: 'Psychologia szkolna',                       status: 'live' },
    ...
    neurodiversity: [
      { file: 'wiki/neurodiversity/wprowadzenie.md',               label: 'Neuroróżnorodność',    status: 'live' },
    ...
    forensic_psychology: [
      { file: 'wiki/forensic_psychology/wprowadzenie.md',            label: 'Biegły psycholog',       status: 'live' },
    ...
    e_therapy: [
      { file: 'wiki/e_therapy/wprowadzenie.md',                   label: 'E-terapia',                              status: 'live' },
    ...
    philosophy: [
      { file: 'wiki/philosophy/wprowadzenie.md',        label: 'Filozofia',       status: 'live' },
    ...
    nvc: [
      { file: 'wiki/nvc/wprowadzenie.md',            label: 'NVC',                                   status: 'live' },
    ...
    ppd: [
      { file: 'wiki/ppd/wprowadzenie.md',           label: 'Seminarium dyplomowe',                  status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Zachowanie i dwie półkule mózgu', id: 'neuro/zachowanie_i_dwie_polkule_mozgu', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Clive Wearing', id: 'cases/clive_wearing', status: 'live' },
            { label: 'Elliot', id: 'cases/elliot', status: 'live' },
            { label: 'Pacjentka D.F.', id: 'cases/df', status: 'live' },
            { label: 'Pacjent K.C.', id: 'cases/kc', status: 'live' },
            { label: 'Pacjent N.A.', id: 'cases/na', status: 'live' },
            { label: 'Pacjent K.N.', id: 'cases/patient_kn', status: 'live' },
            { label: 'Pacjent R.B.', id: 'cases/patient_rb', status: 'live' },
            { label: 'Pacjent P.S.', id: 'cases/ps', status: 'live' },
            { label: 'Pacjentka S.M.', id: 'cases/sm', status: 'live' },
          ]
        },
        {
    ...
    kliniczna: {
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            { label: 'Psychoterapia', id: 'psychotherapy/psychoterapia_wprowadzenie', status: 'live' },
            ...
            { label: 'Somatic Experiencing (SE)', id: 'psychotherapy/somatic_experiencing', status: 'live' },
            { label: 'Systemy rodzinne', id: 'psychotherapy/systemy_rodzinne', status: 'live' },
            { label: 'Terapia akceptacji (ACT)', id: 'psychotherapy/act', status: 'live' },
            { label: 'Heksafleks ACT', id: 'psychotherapy/heksafleks_act', status: 'live' },
        ...
        },
        {
          title: 'Suicydologia',
          articles: [
            { label: 'Suicydologia', id: 'suicidology/suicydologia_wprowadzenie', status: 'live' },
        ...
        },
        {
          title: 'Psychometria',
          articles: [
            { label: 'Psychometria', id: 'psychometrics/psychometria_wprowadzenie', status: 'xlink' },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Test Stroopa', id: 'cognitive/test_stroopa', status: 'live' },
            { label: 'Przykład testu Stroopa', id: 'cognitive/przyklad_testu_stroopa', status: 'live' },
            ...
            { label: 'Układ siatkowaty (ARAS)', id: 'cognitive/uklad_siatkowaty', status: 'live' },
          ]
        },
        {
    ...
    kulturowa: {
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            { label: 'Emocje', id: 'emotions/emocje_wprowadzenie', status: 'live' },
    ...
    relacje: {
      ...
      sections: [
        ...
        },
        {
          title: 'Seksuologia',
          articles: [
            { label: 'Seksuologia', id: 'sexology/seksuologia_wprowadzenie', status: 'live' },
    ...
    diagnoza: {
      ...
      sections: [
        ...
        },
        {
          title: 'Psychometria',
          articles: [
            { label: 'Psychometria', id: 'psychometrics/psychometria_wprowadzenie', status: 'live' },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Rozwój temperamentu',                id: 'temperament/rozwoj',                   status: 'live' },
      ...
      sections: [
        {
          title: 'Arteterapia',
          articles: [
            { label: 'Arteterapia', id: 'artetherapy/arteterapia_wprowadzenie', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Animaloterapia', id: 'animaltherapy/animaloterapia_wprowadzenie', status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy',
          articles: [
            { label: 'Psychologia zdrowia', id: 'health_psychology/zdrowie_wprowadzenie',    status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Psychosomatyka',   id: 'psychosomatics/wprowadzenie',            status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy',
          articles: [
            { label: 'Psychologia niepełnosprawności', id: 'disability_psychology/wprowadzenie', status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Psychologia starości',   id: 'geropsychology/wprowadzenie',           status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy i wprowadzenie',
          articles: [
            { label: 'Psychologia gier wideo', id: 'game_psychology/wprowadzenie',         status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Odporność psychiczna',  id: 'resilience_mobbing/odpornosc_wprowadzenie', status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Ekrany, książki i natura',  id: 'media_nature/wprowadzenie',             status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Psychologia pozytywna', id: 'positive_psychology/wprowadzenie',        status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy i historia',
          articles: [
            { label: 'Psychologia AI',   id: 'ai_psychology/wprowadzenie',  status: 'live' },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Psycholog w IT',                                       id: 'students/psycholog_w_it', status: 'xlink' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          title: 'Podstawy i historia',
          articles: [
            { label: 'Robotyka afektywna',  id: 'affective_robotics/wprowadzenie',                 status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy i teorie',
          articles: [
            { label: 'Psychologia szkolna',  id: 'school_psychology/wprowadzenie',                status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Neuroróżnorodność',     id: 'neurodiversity/wprowadzenie',     status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Biegły psycholog',  id: 'forensic_psychology/wprowadzenie',   status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy i historia',
          articles: [
            { label: 'E-terapia',  id: 'e_therapy/wprowadzenie',      status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Filozofia',       id: 'philosophy/wprowadzenie',  status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy NVC',
          articles: [
            { label: 'NVC',         id: 'nvc/wprowadzenie',        status: 'live', desc: 'Geneza, filozofia i zastosowania Porozumiewania się bez przemocy.' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Seminarium dyplomowe',  id: 'ppd/wprowadzenie',         status: 'live', desc: 'Cel i struktura seminarium dyplomowego, typy prac magisterskich.' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Pomoc psychologiczna', id: 'podstawy_pomocy/wprowadzenie',                  status: 'live', desc: 'Rodzaje pomocy psychologicznej, zasady podstawowe i różnice między nimi.' },
