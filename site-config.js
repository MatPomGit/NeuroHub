...
window.SITE_CONFIG = {
  ...
  articleRedirects: {
    // Dawne strony katalogowe prowadzą bezpośrednio do artykułów nadrzędnych.
    'psychofarmakologia/spis_tresci': 'psychofarmakologia/podstawy_psychofarmakologii',
    'wiki-index/neuropsychologia': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'wiki-index/kliniczna': 'psychopatologia/psychopatologia_wprowadzenie',
    'wiki-index/poznawcza': 'psychologia_poznawcza/percepcja',
    'wiki-index/spoleczna': 'psychologia_spoleczna/ja_i_samoocena',
    'wiki-index/kulturowa': 'kulturowa/wprowadzenie',
    'wiki-index/rozwojowa': 'psychologia_rozwojowa/teorie_rozwoju',
    'wiki-index/uzaleznienia': 'uzaleznienia/mechanizmy_i_diagnoza_uzaleznien',
    'wiki-index/relacje': 'relacje/tworzenie_i_rozwoj_relacji_intymnej',
    'wiki-index/diagnoza': 'diagnoza/etapy_diagnozy',
    'wiki-index/biologia': 'biologia/biologiczne_podstawy',
    'wiki-index/roznice_ind': 'roznice_indywidualne/roznice_wprowadzenie',
    'wiki-index/terapie_artystyczne': 'arteterapia/arteterapia_wprowadzenie',
    'wiki-index/etyka': 'etyka/kodeksy_etyczne',
    'wiki-index/slownik': 'wstep_do_psychologii/definicja',
    'wiki-index/zdrowie': 'psychologia_zdrowia/zdrowie_wprowadzenie',
    'wiki-index/psychosomatics': 'psychosomatyka/wprowadzenie',
    'wiki-index/niepelnosprawnosc': 'psychologia_niepelnosprawnosci/wprowadzenie',
    'wiki-index/geropsychology': 'geropsychologia/wprowadzenie',
    'wiki-index/gry_wideo': 'psychologia_gier/wprowadzenie',
    'wiki-index/odpornosc_mobbing': 'rezyliencja_i_mobbing/odpornosc_wprowadzenie',
    'wiki-index/media_natura': 'ekrany_ksiazki_i_natura/ekrany_i_funkcjonowanie_psychiczne',
    'wiki-index/psych_pozytywna': 'psychologia_pozytywna/szczescie_dobrostan',
    'wiki-index/psych_ai': 'psychologia_ai/psychologia_interakcji_czlowiek_ai',
    'wiki-index/psychologia_technologii': 'psychologia_technologii/technostres',
    'wiki-index/robotyka_afektywna': 'psychologia_ai/psychologia_interakcji_czlowiek_ai',
    'wiki-index/psych_szkolna': 'psychologia_szkolna/teorie_uczenia_sie',
    'wiki-index/neurozroznorodnosc': 'neuroroznorodnosc/wprowadzenie',
    'wiki-index/psych_sadowa': 'psychologia_sadowa/wprowadzenie',
    'wiki-index/e_terapia': 'e_terapia/terapia_online',
    'wiki-index/filozofia': 'filozofia/wprowadzenie',
    'wiki-index/nvc': 'porozumiewanie_sie_bez_przemocy/wprowadzenie',
    'wiki-index/seminarium_dyplomowe': 'seminarium_dyplomowe/wprowadzenie',
    'wiki-index/podstawy_pomocy': 'podstawy_pomocy/wprowadzenie',
    'wiki-index/dodatkowe_strony': 'wstep_do_psychologii/definicja',
    'wiki-index/instrukcje_lab_pdf': 'eksperyment_psychologiczny/wprowadzenie',
    ...
    'eksperyment_psychologiczny/protokol_i_pilotaz': 'eksperyment_psychologiczny/wprowadzenie',
    'eksperyment_psychologiczny/etyka_i_zgoda': 'eksperyment_psychologiczny/prowadzenie_badania_i_jakosc_danych',
    'eksperyment_psychologiczny/obserwacja_psychologiczna': 'eksperyment_psychologiczny/prowadzenie_badania_i_jakosc_danych',
    'eksperyment_psychologiczny/jakosc_danych': 'eksperyment_psychologiczny/prowadzenie_badania_i_jakosc_danych',
    'eksperyment_psychologiczny/raportowanie_wynikow': 'eksperyment_psychologiczny/analiza_raportowanie_i_replikacja',
    'eksperyment_psychologiczny/replikacja_i_otwarta_nauka': 'eksperyment_psychologiczny/analiza_raportowanie_i_replikacja',
    ...
    'neuropsychologia/agregaty_neuronalne': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuropsychologia/anatomia': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuropsychologia/cykl_miesiaczkowy': 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu',
    'neuropsychologia/eye_tracking': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuropsychologia/kora_prefrontalna': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuropsychologia/lateralizacja': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuropsychologia/muse': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuropsychologia/myelinizacja': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuropsychologia/neuron': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuropsychologia/neuronauka_poznawcza': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuropsychologia/neuroobrazowanie': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuropsychologia/pien_mozgu': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuropsychologia/plastycznosc': 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu',
    'neuropsychologia/podstawy_neurologii': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuropsychologia/przesilenie_wiosenne': 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu',
    'neuropsychologia/systemy': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuropsychologia/uklad_limbiczny': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuropsychologia/rehabilitacja_neuropsychologiczna': 'neuropsychologia/diagnoza_i_rehabilitacja_neuropsychologiczna',
    'neuropsychologia/zachowanie_i_dwie_polkule_mozgu': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    ...
    'somatic_experiencing/dysocjacja_i_zawazenie_okna_tolerancji': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/granice_zgoda_i_tempo_pracy': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/integracja_z_innymi_terapiami_traumy': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/interocepcja_i_propriocepcja_w_somatic_experiencing': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/neurofizjologia_traumy_i_autonomiczny_uklad_nerwowy': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/orientacja_i_uziemienie_w_somatic_experiencing': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/przewlekly_bol_i_objawy_somatyczne': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/reakcja_obronna_i_dokonczenie_ruchu': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/stabilizacja_i_sekwencjonowanie': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/titracja_i_pendulacja': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/trauma_zlozona_i_relacja_terapeutyczna': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    'somatic_experiencing/zasoby_i_poczucie_bezpieczenstwa': 'doswiadczenie_somatyczne/wprowadzenie_do_doswiadczenia_somatycznego',
    ...
    'emocje/emocje_wprowadzenie': 'emocje/teorie_emocji',
    'emocje/neurobiologia': 'emocje/teorie_emocji',
    'emocje/stres_emocje': 'emocje/regulacja',
    'emocje/aleksytymia': 'emocje/regulacja',
    'emocje/inteligencja_emocjonalna': 'emocje/regulacja',
    'emocje/emocje_spoleczne': 'emocje/wspolczucie',
    'emocje/wstyd_wina': 'emocje/wspolczucie',
    'emocje/pozytywne_emocje': 'emocje/motywacja',
    'psychosomatyka/aleksytymia': 'emocje/regulacja',
    ...
    'suicydologia/teorie': 'suicydologia/suicydologia_wprowadzenie',
    'suicydologia/epidemiologia': 'suicydologia/suicydologia_wprowadzenie',
    'suicydologia/modele_suicydologiczne': 'suicydologia/suicydologia_wprowadzenie',
    'suicydologia/biologiczne_neurobiologiczne_podstawy': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/biologiczne_neurobiologiczne_podstawy_zachowan_suicydalnych': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/genetyczne_i_epigenetyczne_uwarunkowania': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/genetyczne_i_epigenetyczne_uwarunkowania_suicydalnosci': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/psychopatologia_a_ryzyko': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/psychopatologia_a_ryzyko_samobojstwa': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/trauma_ace_i_stres_chroniczny': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/trauma_ace_i_stres_chroniczny_a_ryzyko_samobojstwa': 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego',
    'suicydologia/ocena_ryzyka': 'suicydologia/ocena_i_interwencja_w_kryzysie_samobojczym',
    'suicydologia/interwencja': 'suicydologia/ocena_i_interwencja_w_kryzysie_samobojczym',
    'suicydologia/media': 'suicydologia/profilaktyka',
    'suicydologia/postvention': 'suicydologia/profilaktyka',
    ...
    'neuro/agregaty_neuronalne': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuro/anatomia': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuro/cykl_miesiaczkowy': 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu',
    'neuro/eye_tracking': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuro/kora_prefrontalna': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuro/lateralizacja': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuro/muse': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuro/myelinizacja': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuro/neuron': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuro/neuronauka_poznawcza': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuro/neuroobrazowanie': 'neuropsychologia/metody_neuronauki_poznawczej',
    'neuro/pien_mozgu': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuro/plastycznosc': 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu',
    'neuro/podstawy_neurologii': 'neuropsychologia/podstawy_ukladu_nerwowego',
    'neuro/przesilenie_wiosenne': 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu',
    'neuro/rehabilitacja_neuropsychologiczna': 'neuropsychologia/diagnoza_i_rehabilitacja_neuropsychologiczna',
    'neuro/systemy': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuro/uklad_limbiczny': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
    'neuro/zachowanie_i_dwie_polkule_mozgu': 'neuropsychologia/funkcjonalna_anatomia_mozgu',
  ...
  nav: [
    ...
    { /** Filozofia */
      ...
      domainKey: 'filozofia',
      items: [
        { id: 'filozofia/wprowadzenie', label: 'Wprowadzenie do filozofii', file: 'wiki/filozofia/wprowadzenie.md' },
        { id: 'filozofia/etyka', label: 'Etyka i filozofia moralna', file: 'wiki/filozofia/etyka.md' },
        { id: 'filozofia/filozofia_umyslu', label: 'Filozofia umysłu i tożsamości osobowej', file: 'wiki/filozofia/filozofia_umyslu.md' },
    ...
    { /* Eksperyment psychologiczny */
      ...
      items: [
        { id: 'eksperyment_psychologiczny/wprowadzenie', label: '1. Projektowanie eksperymentu psychologicznego', file: 'wiki/eksperyment_psychologiczny/wprowadzenie.md' },
        { id: 'eksperyment_psychologiczny/prowadzenie_badania_i_jakosc_danych', label: '2. Prowadzenie badania i jakość danych', file: 'wiki/eksperyment_psychologiczny/prowadzenie_badania_i_jakosc_danych.md' },
        { id: 'eksperyment_psychologiczny/analiza_raportowanie_i_replikacja', label: '3. Analiza, raportowanie i otwarta nauka', file: 'wiki/eksperyment_psychologiczny/analiza_raportowanie_i_replikacja.md' },
      ]
    },
    { /* Funkcje poznawcze */
    ...
    { /* Emocje i motywacje */
      ...
      domainKey: 'emocje',
      items: [
        { id: 'emocje/teorie_emocji',              label: 'Teorie i neurobiologia emocji',            file: 'wiki/emocje/teorie_emocji.md'              },
        { id: 'emocje/regulacja',           label: 'Regulacja emocji, stres i aleksytymia',    file: 'wiki/emocje/regulacja.md'           },
        { id: 'emocje/motywacja',           label: 'Motywacja i emocje pozytywne',                file: 'wiki/emocje/motywacja.md'           },
        { id: 'emocje/wspolczucie',         label: 'Emocje społeczne, empatia i współczucie',    file: 'wiki/emocje/wspolczucie.md'         },
      ]
    },
    { /* Temperament */
      section: 'Temperament',
    ...
    { /* Systemy rodzinne */
      ...
      items: [
        ...
        { id: 'systemy_rodzinne/terapie_systemowe_i_rodzinne', label: 'Terapie systemowe i rodzinne', file: 'wiki/systemy_rodzinne/terapie_systemowe_i_rodzinne.md' },
      ]
    },
    ...
    { /* Suicydologia */
      ...
      items: [
        { id: 'suicydologia/suicydologia_wprowadzenie', label: 'Podstawy, epidemiologia i modele', file: 'wiki/suicydologia/suicydologia_wprowadzenie.md' },
        { id: 'suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego', label: 'Uwarunkowania i czynniki ryzyka', file: 'wiki/suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego.md' },
        { id: 'suicydologia/ocena_i_interwencja_w_kryzysie_samobojczym', label: 'Ocena i interwencja w kryzysie', file: 'wiki/suicydologia/ocena_i_interwencja_w_kryzysie_samobojczym.md' },
        { id: 'suicydologia/profilaktyka', label: 'Profilaktyka, media i postwencja', file: 'wiki/suicydologia/profilaktyka.md' },
        { id: 'suicydologia/nssi', label: 'Samouszkodzenia bez intencji samobójczej (NSSI)', file: 'wiki/suicydologia/nssi.md' },
      ]
    },
    ...
    { /* Neurobiologia i neuropsychologia */
      ...
      domainKey: 'neuro',
      items: [
        { id: 'neuropsychologia/podstawy_ukladu_nerwowego', label: 'Podstawy układu nerwowego', file: 'wiki/neuropsychologia/podstawy_ukladu_nerwowego.md' },
        { id: 'neuropsychologia/funkcjonalna_anatomia_mozgu', label: 'Funkcjonalna anatomia mózgu', file: 'wiki/neuropsychologia/funkcjonalna_anatomia_mozgu.md' },
        { id: 'neuropsychologia/metody_neuronauki_poznawczej', label: 'Metody neuronauki poznawczej', file: 'wiki/neuropsychologia/metody_neuronauki_poznawczej.md' },
        { id: 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu', label: 'Rozwój, plastyczność i zmienność mózgu', file: 'wiki/neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu.md' },
        { id: 'neuropsychologia/diagnoza_i_rehabilitacja_neuropsychologiczna', label: 'Diagnoza i rehabilitacja neuropsychologiczna', file: 'wiki/neuropsychologia/diagnoza_i_rehabilitacja_neuropsychologiczna.md' },
      ]
    },
  ...
  plans: {
    ...
    neuro: [
      ...
      { file: 'wiki/neuropsychologia/metody_neuronauki_poznawczej.md', label: 'Metody neuronauki poznawczej', status: 'live' },
      { file: 'wiki/neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu.md', label: 'Rozwój, plastyczność i zmienność mózgu', status: 'live' },
      { file: 'wiki/neuropsychologia/diagnoza_i_rehabilitacja_neuropsychologiczna.md', label: 'Diagnoza i rehabilitacja neuropsychologiczna', status: 'live' },
    ],
    cognitive: [
    ...
    emotions: [
      { file: 'wiki/emocje/teorie_emocji.md',       label: 'Teorie i neurobiologia emocji',           status: 'live' },
      { file: 'wiki/emocje/regulacja.md',    label: 'Regulacja emocji, stres i aleksytymia',   status: 'live' },
      { file: 'wiki/emocje/motywacja.md',    label: 'Motywacja i emocje pozytywne',               status: 'live' },
      { file: 'wiki/emocje/wspolczucie.md',  label: 'Emocje społeczne, empatia i współczucie',   status: 'live' },
    ],
    biology: [
    ...
    suicidology: [
      { file: 'wiki/suicydologia/suicydologia_wprowadzenie.md', label: 'Podstawy, epidemiologia i modele', status: 'live' },
      { file: 'wiki/suicydologia/uwarunkowania_i_czynniki_ryzyka_samobojczego.md', label: 'Uwarunkowania i czynniki ryzyka', status: 'live' },
      { file: 'wiki/suicydologia/ocena_i_interwencja_w_kryzysie_samobojczym.md', label: 'Ocena i interwencja w kryzysie', status: 'live' },
      { file: 'wiki/suicydologia/profilaktyka.md', label: 'Profilaktyka, media i postwencja', status: 'live' },
      { file: 'wiki/suicydologia/nssi.md', label: 'Samouszkodzenia bez intencji samobójczej (NSSI)', status: 'live' },
    ],
    sexology: [
    ...
    philosophy: [
      { file: 'wiki/filozofia/wprowadzenie.md', label: 'Wprowadzenie do filozofii', status: 'live' },
      { file: 'wiki/filozofia/etyka.md', label: 'Etyka i filozofia moralna', status: 'live' },
      { file: 'wiki/filozofia/filozofia_umyslu.md', label: 'Filozofia umysłu i tożsamości osobowej', status: 'live' },
    ...
    eksperyment_psychologiczny: [
      ...
      { file: 'wiki/eksperyment_psychologiczny/prowadzenie_badania_i_jakosc_danych.md', label: '2. Prowadzenie badania i jakość danych', status: 'live' },
      { file: 'wiki/eksperyment_psychologiczny/analiza_raportowanie_i_replikacja.md', label: '3. Analiza, raportowanie i otwarta nauka', status: 'live' },
    ],
  },
  ...
  wikis: {
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Podstawy układu nerwowego', id: 'neuropsychologia/podstawy_ukladu_nerwowego', status: 'live', desc: 'Komórki, przewodzenie, synapsy, mielina i poziomy organizacji.' },
            { label: 'Funkcjonalna anatomia mózgu', id: 'neuropsychologia/funkcjonalna_anatomia_mozgu', status: 'live', desc: 'Struktury rozpatrywane w sieciach percepcji, pamięci, regulacji i działania.' },
            { label: 'Metody neuronauki poznawczej', id: 'neuropsychologia/metody_neuronauki_poznawczej', status: 'live', desc: 'EEG, fMRI, PET, MRI, eye tracking i urządzenia konsumenckie.' },
            { label: 'Rozwój, plastyczność i zmienność mózgu', id: 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu', status: 'live', desc: 'Rozwój, doświadczenie, uszkodzenie, cykl i sezonowość.' },
            { label: 'Diagnoza i rehabilitacja neuropsychologiczna', id: 'neuropsychologia/diagnoza_i_rehabilitacja_neuropsychologiczna', status: 'live', desc: 'Ocena, cele, restytucja, kompensacja i codzienne funkcjonowanie.' },
          ]
        },
        {
          title: 'Syndromologia',
    ...
    filozofia: {
      ...
      intro: 'Filozofia bada fundamentalne pytania o rzeczywistość, poznanie, wartości i naturę człowieka. Opracowania łączą klasyczne problemy filozoficzne z ich znaczeniem dla psychologii i nauk empirycznych.',
      sections: [
        {
          title: 'Opracowania kanoniczne',
          articles: [
            { label: 'Wprowadzenie do filozofii', id: 'filozofia/wprowadzenie', status: 'live' },
            { label: 'Etyka i filozofia moralna', id: 'filozofia/etyka', status: 'live' },
            { label: 'Filozofia umysłu i tożsamości osobowej', id: 'filozofia/filozofia_umyslu', status: 'live' },
      ...
      sections: [
        {
          ...
          entries: [
            ...
            { term: 'fMRI',            def: 'Funkcjonalny rezonans magnetyczny mierzy pośredni sygnał BOLD, zależny od utlenowania krwi i odpowiedzi naczyniowej.' },
            ...
            { term: 'Hipokamp',        def: 'Element sieci ważnych dla pamięci epizodycznej i reprezentacji przestrzeni; nie działa jako samodzielny „ośrodek pamięci”.', link: 'neuropsychologia/funkcjonalna_anatomia_mozgu' },
            ...
            { term: 'Lateralizacja',   def: 'Stopniowalna i zależna od zadania asymetria udziału półkul w przetwarzaniu; nie dzieli ludzi na typy „lewopółkulowe” i „prawopółkulowe”.', link: 'neuropsychologia/funkcjonalna_anatomia_mozgu' },
            { term: 'LTD',             def: 'Long-Term Depression - dlugotrwale oslabienie synapsy przy niskiej aktywnosci. Mechanizm zapominania.' },
            { term: 'LTP',             def: 'Długotrwałe wzmocnienie transmisji synaptycznej po określonych wzorcach aktywności, jeden z mechanizmów plastyczności badanych w związku z uczeniem.', link: 'neuropsychologia/podstawy_ukladu_nerwowego' },
            ...
            { term: 'Neuroplastycznosc', def: 'Zdolnosc mózgu do zmiany struktury i funkcji - od poziomu synaptycznego (LTP/LTD) po reorganizacje kortykalna.', link: 'neuropsychologia/rozwoj_plastycznosc_i_zmiennosc_mozgu' },
            ...
            { term: 'Pola Brodmanna',  def: 'Obszary kory wyznaczone historycznie na podstawie cytoarchitektury; nie stanowią gotowej mapy pojedynczych funkcji psychicznych.', link: 'neuropsychologia/funkcjonalna_anatomia_mozgu' },
            ...
            { term: 'Wzgórze',         def: 'Zespół jąder uczestniczących w selekcji i koordynacji wymiany informacji między korą a układami podkorowymi.', link: 'neuropsychologia/funkcjonalna_anatomia_mozgu' },
          ]
        }
      ]
    },
