...
window.SITE_CONFIG = {
  ...
  nav: [
    {
      ...
      items: [
        ...
        { id: 'wstep_do_psychologii/nurty_psychologii', label: 'G9Bwne nurty psychologii', file: 'wiki/wstep_do_psychologii/nurty_psychologii.md'  },
    ...
    {
      section: 'Dla studentBw',
      domainKey: 'dla_studentow',
      items: [
        { id: 'dla_studentow/wybor_specjalnosci', label: 'WybBr specjalno9:ci', file: 'wiki/dla_studentow/wybor_specjalnosci.md' },
        { id: 'dla_studentow/sciezki_kariery', label: '9acie9=ki kariery po psychologii', file: 'wiki/dla_studentow/sciezki_kariery.md' },
        { id: 'dla_studentow/wystapienia_publiczne_autoprezentacja', label: 'Wystďż˝&pienia publiczne i autoprezentacja', file: 'wiki/dla_studentow/wystapienia_publiczne_autoprezentacja.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'filozofia/odpowiedzialnosc_epistemiczna',label: 'Odpowiedzialno9:ďż˝! epistemiczna',              file: 'wiki/filozofia/odpowiedzialnosc_epistemiczna.md' },
        { id: 'filozofia/etyka',                        label: 'Etyka i filozofia moralna',                  file: 'wiki/filozofia/etyka.md'               },
        { id: 'filozofia/filozofia_umyslu',             label: 'Filozofia umys9u',                           file: 'wiki/filozofia/filozofia_umyslu.md'    },
        ...
        { id: 'filozofia/filozofia_jezyka',             label: 'Filozofia jďż˝"zyka',                           file: 'wiki/filozofia/filozofia_jezyka.md'    },
        { id: 'filozofia/filozofia_czlowieka',          label: 'Filozofia cz9owieka',                        file: 'wiki/filozofia/filozofia_czlowieka.md'         },
        { id: 'filozofia/cien_antropiczny',             label: 'Cie9 antropiczny',                           file: 'wiki/filozofia/cien_antropiczny.md'            },
        { id: 'filozofia/mozg_boltzmanna',              label: 'MBzg Boltzmanna',                            file: 'wiki/filozofia/mozg_boltzmanna.md'             },
        ...
        { id: 'filozofia/asymetria_dobra_i_bolu',       label: 'Asymetria dobra i bBlu',                     file: 'wiki/filozofia/asymetria_dobra_i_bolu.md'      },
        { id: 'filozofia/niemoralnosc_braku_zgody',     label: 'Niemoralno9:ďż˝! braku zgody na narodziny',      file: 'wiki/filozofia/niemoralnosc_braku_zgody.md'    },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'biology/mikrobiom',            label: 'O9: jelitaďż˝mBzg',                file: 'wiki/biologia/mikrobiom.md'             },
      ]
    },
    {
      ...
      domainKey: 'rozwojowa',
      items: [
        { id: 'rozwojowa/teorie_rozwoju',     label: 'G9Bwne teorie rozwoju',                   file: 'wiki/rozwojowa/teorie_rozwoju.md'     },
        { id: 'rozwojowa/metody_podluzne',    label: 'Metody bada9 pod9u9=nych',                  file: 'wiki/rozwojowa/metody_podluzne.md'    },
        { id: 'rozwojowa/niemowlectwo',       label: 'Niemowlďż˝"ctwo i wczesne dzieci9stwo',        file: 'wiki/rozwojowa/niemowlectwo.md'       },
        ...
        { id: 'rozwojowa/doroslosc',          label: 'Doros9o9:ďż˝! i starzenie siďż˝"',                file: 'wiki/rozwojowa/doroslosc.md'          },
        { id: 'rozwojowa/plastycznosc_mozgu', label: 'Plastyczno9:ďż˝! mBzgu, a okresy krytyczne',    file: 'wiki/rozwojowa/plastycznosc_mozgu.md' },
        { id: 'rozwojowa/przywiazanie',       label: 'Teoria przywiďż˝&zania',                      file: 'wiki/rozwojowa/przywiazanie.md'       },
        { id: 'rozwojowa/rozwoj_jezyka',      label: 'RozwBj jďż˝"zyka i komunikacji',              file: 'wiki/rozwojowa/rozwoj_jezyka.md'      },
        ...
        { id: 'rozwojowa/tozsamosc',          label: 'Kszta9towanie to9=samo9:ci',                 file: 'wiki/rozwojowa/tozsamosc.md'          },
      ]
    },
    {
      section: 'Psychologia Spo9eczna',
      domainKey: 'spoleczna',
      items: [
        { id: 'spoleczna/percepcja_spoleczna', label: 'Percepcja spo9eczna i atrybucje', file: 'wiki/spoleczna/percepcja_spoleczna.md' },
        { id: 'spoleczna/eksperyment_wiezienny', label: 'Stanfordzki Eksperyment Wiďż˝"zienny', file: 'wiki/spoleczna/eksperyment_wiezienny.md' },
        { id: 'spoleczna/manipulacja', label: 'Manipulacja - mechanizmy i metody wp9ywu', file: 'wiki/spoleczna/manipulacja.md' },
        { id: 'spoleczna/stereotypy', label: 'Stereotypy i uprzedzenia', file: 'wiki/spoleczna/stereotypy.md' },
        { id: 'spoleczna/manosfera_feminizm', label: 'Manosfera i feminizm - ujďż˝"cie psychologiczne', file: 'wiki/spoleczna/manosfera_feminizm.md' },
        ...
        { id: 'spoleczna/konformizm', label: 'Konformizm i pos9usze9stwo', file: 'wiki/spoleczna/konformizm.md' },
        ...
        { id: 'spoleczna/atrakcyjnosc', label: 'Atrakcyjno9:ďż˝! interpersonalna', file: 'wiki/spoleczna/atrakcyjnosc.md' },
        ...
        { id: 'spoleczna/zachowania_prospoleczne', label: 'Zachowania prospo9eczne', file: 'wiki/spoleczna/zachowania_prospoleczne.md' },
        { id: 'spoleczna/zdrowe_poczucie_wlasnej_wartosci', label: 'Zdrowe poczucie w9asnej warto9:ci', file: 'wiki/spoleczna/zdrowe_poczucie_wlasnej_wartosci.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'kulturowa/indywidualizm_kolektywizm', label: 'Wymiar indywidualizmďż˝kolektywizm', file: 'wiki/kulturowa/indywidualizm_kolektywizm.md' },
        ...
        { id: 'kulturowa/kultura_jezyk',     label: 'Kultura, a jďż˝"zyk (Sapir-Whorf)',        file: 'wiki/kulturowa/kultura_jezyk.md'     },
        { id: 'kulturowa/kultura_osobowosc', label: 'Kultura, a osobowo9:ďż˝!',                 file: 'wiki/kulturowa/kultura_osobowosc.md' },
    ...
    },
    {
      ...
      items: [
        { id: 'psychologia_religii/wprowadzenie',            label: 'Psychologia religii ďż˝ wprowadzenie',       file: 'wiki/psychologia_religii/wprowadzenie.md'            },
        { id: 'psychologia_religii/religijnosc_i_duchowosc', label: 'Religijno9:ďż˝! a duchowo9:ďż˝!',                   file: 'wiki/psychologia_religii/religijnosc_i_duchowosc.md' },
        { id: 'psychologia_religii/rozwoj_religijnosci',     label: 'RozwBj religijno9:ci w cyklu 9=ycia',        file: 'wiki/psychologia_religii/rozwoj_religijnosci.md'     },
        ...
        { id: 'psychologia_religii/obrazy_boga',             label: 'Obrazy Boga i style przywiďż˝&zania',         file: 'wiki/psychologia_religii/obrazy_boga.md'             },
        { id: 'psychologia_religii/wspolnota_i_tozsamosc',   label: 'WspBlnota religijna a to9=samo9:ďż˝!',          file: 'wiki/psychologia_religii/wspolnota_i_tozsamosc.md'   },
        { id: 'psychologia_religii/rytualy_i_zdrowie',       label: 'Rytua9y religijne a dobrostan psychiczny', file: 'wiki/psychologia_religii/rytualy_i_zdrowie.md'       },
        { id: 'psychologia_religii/skrupulatyzm',            label: 'Skrupulatyzm i objawy OCD',                file: 'wiki/psychologia_religii/skrupulatyzm.md'            },
        { id: 'psychologia_religii/religia_w_psychoterapii', label: 'Religia i duchowo9:ďż˝! w psychoterapii',      file: 'wiki/psychologia_religii/religia_w_psychoterapii.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'uzaleznienia/dialog_motywujacy', label: 'Dialog motywujďż˝&cy', file: 'wiki/uzaleznienia/dialog_motywujacy.md' },
        { id: 'uzaleznienia/zapobieganie_nawrotom', label: 'Zapobieganie nawrotom', file: 'wiki/uzaleznienia/zapobieganie_nawrotom.md' },
        { id: 'uzaleznienia/uzaleznienia_mlodziezy', label: 'Uzale9=nienia u m9odzie9=y', file: 'wiki/uzaleznienia/uzaleznienia_mlodziezy.md' },
        { id: 'uzaleznienia/wspoluzaleznienie', label: 'WspB9uzale9=nienie', file: 'wiki/uzaleznienia/wspoluzaleznienie.md' },
    ...
    {
      section: 'Relacje i zwiďż˝&zki',
      domainKey: 'relacje',
      items: [
        { id: 'relacje/przywiezanie_doroslych', label: 'Style przywiďż˝&zania u doros9ych', file: 'wiki/relacje/przywiezanie_doroslych.md' },
        { id: 'relacje/trojkatna_teoria_milosci', label: 'Triangularna teoria mi9o9:ci', file: 'wiki/relacje/trojkatna_teoria_milosci.md' },
        { id: 'relacje/dobor_partnera', label: 'DobBr partnera', file: 'wiki/relacje/dobor_partnera.md' },
        { id: 'relacje/komunikacja_para', label: 'Komunikacja w parze', file: 'wiki/relacje/komunikacja_para.md' },
        { id: 'relacje/glebia_relacji_a_traumy', label: 'G9ďż˝"bia relacji, a dzielenie siďż˝" traumďż˝&', file: 'wiki/relacje/glebia_relacji_a_traumy.md' },
        { id: 'relacje/konflikty', label: 'Konflikty i ich rozwiďż˝&zywanie', file: 'wiki/relacje/konflikty.md' },
        ...
        { id: 'relacje/przemoc_zwiazki',  label: 'Przemoc w zwiďż˝&zkach',             file: 'wiki/relacje/przemoc_zwiazki.md'  },
        { id: 'relacje/samotnosc',        label: 'Samotno9:ďż˝! i izolacja spo9eczna',  file: 'wiki/relacje/samotnosc.md'        },
        { id: 'relacje/przyjaznie',       label: 'Przyja9_9',                        file: 'wiki/relacje/przyjaznie.md'       },
        { id: 'relacje/rozstanie',        label: 'Rozpad zwiďż˝&zku i 9=a9oba',         file: 'wiki/relacje/rozstanie.md'        },
    ...
    },
    {
      ...
      domainKey: 'etyka',
      items: [
        { id: 'etyka/kodeksy_etyczne', label: 'Kodeksy etyczne - przeglďż˝&d', file: 'wiki/etyka/kodeksy_etyczne.md' },
        ...
        { id: 'etyka/superwizja_odpowiedzialnosc', label: 'Superwizja i odpowiedzialno9:ďż˝!', file: 'wiki/etyka/superwizja_odpowiedzialnosc.md' },
        ...
        { id: 'etyka/odpowiedzialnosc_zawodowa', label: 'Odpowiedzialno9:ďż˝! zawodowa',             file: 'wiki/etyka/odpowiedzialnosc_zawodowa.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'diagnoza/formulowanie_przypadku', label: 'Formu9owanie przypadku', file: 'wiki/diagnoza/formulowanie_przypadku.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'emocje/wspolczucie',         label: 'Empatia i wspB9czucie',    file: 'wiki/emocje/wspolczucie.md'         },
        ...
        { id: 'emocje/emocje_spoleczne',         label: 'Emocje spo9eczne i moralne',        file: 'wiki/emocje/emocje_spoleczne.md'         },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'podstawy_pomocy/aktywne_sluchanie',              label: 'Aktywne s9uchanie',                    file: 'wiki/podstawy_pomocy/aktywne_sluchanie.md'              },
        ...
        { id: 'podstawy_pomocy/komunikacja_wspierajaca',        label: 'Komunikacja wspierajďż˝&ca',              file: 'wiki/podstawy_pomocy/komunikacja_wspierajaca.md'        },
        { id: 'podstawy_pomocy/wsparcie_spoleczne',             label: 'Wsparcie spo9eczne',                   file: 'wiki/podstawy_pomocy/wsparcie_spoleczne.md'             },
        { id: 'podstawy_pomocy/empatia_kontra_sympatia_brene_brown', label: 'Empatia kontra sympatia (Brenďż˝ Brown)', file: 'wiki/podstawy_pomocy/empatia_kontra_sympatia_brene_brown.md' },
        { id: 'podstawy_pomocy/facylitacja',                    label: 'Facylitacja w pracy pomocowej',        file: 'wiki/podstawy_pomocy/facylitacja.md'                    },
        { id: 'podstawy_pomocy/samoopieka_pomagajacego',        label: 'Samoopieka pomagajďż˝&cego',              file: 'wiki/podstawy_pomocy/samoopieka_pomagajacego.md'        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'temperament/rozwoj',                  label: 'Temperament, a rozwBj',                file: 'wiki/temperament/rozwoj.md'                   },
        ...
        { id: 'temperament/biologia_temperamentu',   label: 'Biologiczne pod9o9=e temperamentu',    file: 'wiki/temperament/biologia_temperamentu.md'    },
        { id: 'temperament/temperament_a_kariera',   label: 'Temperament, a kariera i praca',       file: 'wiki/temperament/temperament_a_kariera.md'    },
      ]
    },
    {
      section: 'RB9=nice indywidualne',
      domainKey: 'roznice_indywidualne',
      items: [
        { id: 'roznice_indywidualne/roznice_wprowadzenie', label: 'RB9=nice ind.', file: 'wiki/roznice_indywidualne/roznice_wprowadzenie.md' },
        { id: 'roznice_indywidualne/inteligencja',         label: 'Inteligencja',                file: 'wiki/roznice_indywidualne/inteligencja.md'          },
        { id: 'roznice_indywidualne/osobowosc',            label: 'Osobowo9:ďż˝!',                   file: 'wiki/roznice_indywidualne/osobowosc.md'             },
        { id: 'roznice_indywidualne/kreatywnosc',          label: 'Kreatywno9:ďż˝!',                 file: 'wiki/roznice_indywidualne/kreatywnosc.md'           },
        ...
        { id: 'roznice_indywidualne/plec_psychologia',     label: 'Psychologia p9ci',            file: 'wiki/roznice_indywidualne/plec_psychologia.md'      },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'psychometria/rzetelnosc',   label: 'Rzetelno9:ďż˝! pomiaru',    file: 'wiki/psychometria/rzetelnosc.md'   },
        { id: 'psychometria/trafnosc',     label: 'Trafno9:ďż˝! pomiaru',      file: 'wiki/psychometria/trafnosc.md'     },
    ...
    },
    {
      ...
      domainKey: 'neuro',
      items: [
        { id: 'neuro/anatomia',                          label: 'Anatomia mBzgu',                          file: 'wiki/neuro/anatomia.md'              },
        { id: 'neuro/neuron',                            label: 'Neuron i synapsa',                        file: 'wiki/neuro/neuron.md'                },
        { id: 'neuro/systemy',                           label: 'Uk9ady i sieci',                          file: 'wiki/neuro/systemy.md'               },
        { id: 'neuro/myelinizacja',                      label: 'Mielinizacja i istota bia9a',             file: 'wiki/neuro/myelinizacja.md'          },
        { id: 'neuro/plastycznosc',                      label: 'Neuroplastyczno9:ďż˝!',                       file: 'wiki/neuro/plastycznosc.md'          },
        ...
        { id: 'neuro/zachowanie_i_dwie_polkule_mozgu',     label: 'Zachowanie i dwie pB9kule mBzgu',         file: 'wiki/neuro/zachowanie_i_dwie_polkule_mozgu.md' },
        { id: 'neuro/kora_prefrontalna',                 label: 'Kora przedczo9owa',                       file: 'wiki/neuro/kora_prefrontalna.md'     },
        { id: 'neuro/uklad_limbiczny',                   label: 'Uk9ad limbiczny',                         file: 'wiki/neuro/uklad_limbiczny.md'       },
        { id: 'neuro/przesilenie_wiosenne',              label: 'Neurobiologia przesilenia wiosennego',    file: 'wiki/neuro/przesilenie_wiosenne.md'  },
        { id: 'neuro/cykl_miesiaczkowy',                 label: 'Neuropsychologia cyklu miesiďż˝&czkowego', file: 'wiki/neuro/cykl_miesiaczkowy.md'                 },
        ...
        { id: 'neuro/pien_mozgu',                        label: 'Pie9 mBzgu i mB9=d9=ek',                   file: 'wiki/neuro/pien_mozgu.md'                        },
        { id: 'neuro/eye_tracking',                      label: 'Eye tracking - 9:ledzenie wzroku',        file: 'wiki/neuro/eye_tracking.md'                      },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'zaburzenia/otepienia', label: 'Otďż˝"pienia',             file: 'wiki/zaburzenia/otepienia.md' },
        { id: 'zaburzenia/tbi',       label: 'Urazy g9owy (TBI)',     file: 'wiki/zaburzenia/tbi.md'       },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'przypadki_kliniczne/tan',           label: 'ďż˝~Tan" - afazja',              file: 'wiki/przypadki_kliniczne/tan.md'           },
        { id: 'przypadki_kliniczne/split_brain',   label: 'Rozdzielony mBzg',            file: 'wiki/przypadki_kliniczne/split_brain.md'   },
        ...
        { id: 'przypadki_kliniczne/sm',            label: 'Pacjentka S.M. (uszkodzenie cia9a migda9owatego)', file: 'wiki/przypadki_kliniczne/sm.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'psychopatologia/objawy_ogolne',                label: 'Objawy ogBlne',                  file: 'wiki/psychopatologia/objawy_ogolne.md'                },
        { id: 'psychopatologia/zaburzenia_lekowe',            label: 'Zaburzenia lďż˝"kowe',              file: 'wiki/psychopatologia/zaburzenia_lekowe.md'            },
        ...
        { id: 'psychopatologia/wyuczona_bezradnosc',          label: 'Wyuczona bezradno9:ďż˝!',             file: 'wiki/psychopatologia/wyuczona_bezradnosc.md'           },
...

    {
      ...
      domainKey: 'tests',
      items: [
        { id: 'testy/testy_przeglad',    label: 'Testy - przeglďż˝&d',           file: 'wiki/testy/testy_przeglad.md'    },
        { id: 'testy/mmse_moca',         label: 'Testy przesiewowe',          file: 'wiki/testy/mmse_moca.md'         },
        { id: 'testy/testy_wykonawcze',  label: 'Testy wyk. - przeglďż˝&d',      file: 'wiki/testy/testy_wykonawcze.md'  },
        { id: 'testy/testy_pamieci',     label: 'Testy pamiďż˝"ci',              file: 'wiki/testy/testy_pamieci.md'     },
        { id: 'testy/testy_uwagi',       label: 'Testy uwagi',                file: 'wiki/testy/testy_uwagi.md'       },
        { id: 'testy/testy_jezyka',      label: 'Testy jďż˝"zykowe',             file: 'wiki/testy/testy_jezyka.md'      },
    ...
    },
    {
      ...
      domainKey: 'poznawcza',
      items: [
        { id: 'poznawcza/pamiec',                 label: 'Pamiďż˝"ďż˝!',                          file: 'wiki/poznawcza/pamiec.md'                 },
        { id: 'poznawcza/pamiec_dlugotrwala',     label: 'Pamiďż˝"ďż˝! d9ugotrwa9a',              file: 'wiki/poznawcza/pamiec_dlugotrwala.md'     },
        { id: 'poznawcza/uwaga',                  label: 'Uwaga',                           file: 'wiki/poznawcza/uwaga.md'                  },
        { id: 'poznawcza/uwaga_mimowolna',        label: 'Uwaga mimowolna',                 file: 'wiki/poznawcza/uwaga_mimowolna.md'        },
        { id: 'poznawcza/jezyk',                  label: 'Jďż˝"zyk',                           file: 'wiki/poznawcza/jezyk.md'                  },
        { id: 'poznawcza/funkcje_wykonawcze',     label: 'Funkcje wykonawcze',              file: 'wiki/poznawcza/funkcje_wykonawcze.md'     },
        { id: 'poznawcza/percepcja',              label: 'Percepcja i gnozja',              file: 'wiki/poznawcza/percepcja.md'              },
        { id: 'poznawcza/zmeczenie_poznawcze',    label: 'Zmďż˝"czenie poznawcze',             file: 'wiki/poznawcza/zmeczenie_poznawcze.md'    },
        { id: 'poznawcza/myslenie',               label: 'My9:lenie i rozumowanie',          file: 'wiki/poznawcza/myslenie.md'               },
        { id: 'poznawcza/uczenie',                label: 'Uczenie siďż˝"',                     file: 'wiki/poznawcza/uczenie.md'                },
        { id: 'poznawcza/wyobraznia',             label: 'Wyobra9_nia i reprezentacje',      file: 'wiki/poznawcza/wyobraznia.md'             },
        { id: 'poznawcza/swiadomosc',             label: '9awiadomo9:ďż˝! i metapoznanie',       file: 'wiki/poznawcza/swiadomosc.md'             },
        { id: 'poznawcza/podejmowanie_decyzji',   label: 'Podejmowanie decyzji',            file: 'wiki/poznawcza/podejmowanie_decyzji.md'   },
        { id: 'poznawcza/exploration_exploitation_dilemma', label: 'Dylemat eksploracjaďż˝eksploatacja', file: 'wiki/poznawcza/exploration_exploitation_dilemma.md' },
        { id: 'poznawcza/teoria_perspektywy',     label: 'Teoria perspektywy',              file: 'wiki/poznawcza/teoria_perspektywy.md'     },
        { id: 'poznawcza/efekt_ramowania',        label: 'Efekt ramowania',                 file: 'wiki/poznawcza/efekt_ramowania.md'        },
        { id: 'poznawcza/nasa_tlx',               label: 'NASA Task Load Index (TLX)',      file: 'wiki/poznawcza/nasa_tlx.md'               },
        { id: 'poznawcza/iluzje',                 label: 'Iluzje i b9ďż˝"dy poznawcze',        file: 'wiki/poznawcza/iluzje.md'                 },
        { id: 'poznawcza/test_stroopa',           label: 'Test Stroopa',                    file: 'wiki/poznawcza/test_stroopa.md'           },
        { id: 'poznawcza/przyklad_testu_stroopa', label: 'Przyk9ad testu Stroopa',          file: 'wiki/poznawcza/przyklad_testu_stroopa.md' },
        { id: 'poznawcza/eksperyment_posnera',    label: 'Eksperyment Posnera',             file: 'wiki/poznawcza/eksperyment_posnera.md'    },
        { id: 'poznawcza/maly_albert',            label: 'Eksperyment Ma9ego Alberta',      file: 'wiki/poznawcza/maly_albert.md'            },
        { id: 'poznawcza/uklad_siatkowaty',       label: 'Uk9ad siatkowaty (ARAS)',         file: 'wiki/poznawcza/uklad_siatkowaty.md'       },
        { id: 'poznawcza/nauki_kognitywne',       label: 'Nauki kognitywne',                file: 'wiki/poznawcza/nauki_kognitywne.md'       },
        { id: 'poznawcza/architektury_kognitywne',label: 'Architektury kognitywne',         file: 'wiki/poznawcza/architektury_kognitywne.md'},
        { id: 'poznawcza/hda',                    label: 'Human Decision Accuracy (HDA)',   file: 'wiki/poznawcza/hda.md'                    },
        { id: 'poznawcza/system1_system2',        label: 'System 1 i System 2 (Kahneman)',  file: 'wiki/poznawcza/system1_system2.md'        },
        { id: 'poznawcza/przetwarzanie_predyktywne', label: 'Predictive processing',        file: 'wiki/poznawcza/przetwarzanie_predyktywne.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'psychologia_zdrowia/model_biopsychospoleczny',label: 'Model biopsychospo9eczny',        file: 'wiki/psychologia_zdrowia/model_biopsychospoleczny.md'},
        ...
        { id: 'psychologia_zdrowia/aktywnosc_fizyczna',      label: 'Aktywno9:ďż˝! fizyczna, a zdrowie psychiczne',    file: 'wiki/psychologia_zdrowia/aktywnosc_fizyczna.md'      },
        { id: 'psychologia_zdrowia/dieta_zdrowie',           label: 'Dieta, a zdrowie psychiczne',      file: 'wiki/psychologia_zdrowia/dieta_zdrowie.md'           },
        { id: 'psychologia_zdrowia/bol',                     label: 'Psychologia bBlu',                file: 'wiki/psychologia_zdrowia/bol.md'                     },
        { id: 'psychologia_zdrowia/bol_chroniczny',          label: 'BBl przewlek9y - zarzďż˝&dzanie',    file: 'wiki/psychologia_zdrowia/bol_chroniczny.md'          },
        { id: 'psychologia_zdrowia/choroby_przewlekle',      label: 'Psychologia chorBb przewlek9ych', file: 'wiki/psychologia_zdrowia/choroby_przewlekle.md'      },
        { id: 'psychologia_zdrowia/psychoonkologia',         label: 'Psychoonkologia',                 file: 'wiki/psychologia_zdrowia/psychoonkologia.md'         },
        { id: 'psychologia_zdrowia/choroby_ukladu_krazenia', label: 'Choroby uk9adu krďż˝&9=enia',         file: 'wiki/psychologia_zdrowia/choroby_ukladu_krazenia.md' },
        { id: 'psychologia_zdrowia/cukrzyca',                label: 'Psychologia cukrzycy',            file: 'wiki/psychologia_zdrowia/cukrzyca.md'                },
        { id: 'psychologia_zdrowia/jakosc_zycia',            label: 'Jako9:ďż˝! 9=ycia, a choroba',          file: 'wiki/psychologia_zdrowia/jakosc_zycia.md'            },
        ...
        { id: 'psychologia_zdrowia/wsparcie_spoleczne',      label: 'Wsparcie spo9eczne, a zdrowie',    file: 'wiki/psychologia_zdrowia/wsparcie_spoleczne.md'      },
        { id: 'psychologia_zdrowia/adherencja',              label: 'Adherencja terapeutyczna',        file: 'wiki/psychologia_zdrowia/adherencja.md'              },
        { id: 'psychologia_zdrowia/komunikacja_medyczna',    label: 'Komunikacja lekarzďż˝pacjent',      file: 'wiki/psychologia_zdrowia/komunikacja_medyczna.md'    },
    ...
    
    {
      ...
      items: [
        ...
        { id: 'psychosomatyka/bol_psychosomatyczny',       label: 'BBl psychosomatyczny',              file: 'wiki/psychosomatyka/bol_psychosomatyczny.md'      },
        ...
        { id: 'psychosomatyka/uklad_oddechowy',            label: 'Psychosomatyka uk9adu oddechowego', file: 'wiki/psychosomatyka/uklad_oddechowy.md'           },
    ...
    {
      section: 'Porozumiewanie siďż˝" bez przemocy (NVC)',
      ...
      items: [
        ...
        { id: 'porozumiewanie_sie_bez_przemocy/prosba_i_zadanie',          label: 'Pro9:ba, a 9=ďż˝&danie',                      file: 'wiki/porozumiewanie_sie_bez_przemocy/prosba_i_zadanie.md'          },
        ...
        { id: 'porozumiewanie_sie_bez_przemocy/jezyk_szakala_i_zyrafy',    label: 'Jďż˝"zyk szakala i 9=yrafy',                file: 'wiki/porozumiewanie_sie_bez_przemocy/jezyk_szakala_i_zyrafy.md'    },
        { id: 'porozumiewanie_sie_bez_przemocy/autoempatia',               label: 'Autoempatia i samowspB9czucie',         file: 'wiki/porozumiewanie_sie_bez_przemocy/autoempatia.md'               },
        { id: 'porozumiewanie_sie_bez_przemocy/nvc_w_konfliktach',         label: 'NVC w rozwiďż˝&zywaniu konfliktBw',        file: 'wiki/porozumiewanie_sie_bez_przemocy/nvc_w_konfliktach.md'         },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'arteterapia/mechanizmy',    label: 'Mechanizmy dzia9ania',      file: 'wiki/arteterapia/mechanizmy.md'    },
    ...
    {
      section: 'Odporno9:ďż˝! psychiczna',
      domainKey: 'rezyliencja_i_mobbing',
      items: [
        { id: 'rezyliencja_i_mobbing/odpornosc_wprowadzenie',   label: 'Odporno9:ďż˝! psychiczna - wprow.',        file: 'wiki/rezyliencja_i_mobbing/odpornosc_wprowadzenie.md'   },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'psychologia_szkolna/teorie_uczenia_sie',            label: 'Teorie uczenia siďż˝"',                       file: 'wiki/psychologia_szkolna/teorie_uczenia_sie.md'            },
        ...
        { id: 'psychologia_szkolna/trudnosci_w_uczeniu_sie',       label: 'Trudno9:ci w uczeniu siďż˝"',                 file: 'wiki/psychologia_szkolna/trudnosci_w_uczeniu_sie.md'       },
        { id: 'psychologia_szkolna/adhd_w_szkole',                 label: 'ADHD w szkole',                            file: 'wiki/psychologia_szkolna/adhd_w_szkole.md'                 },
        { id: 'psychologia_szkolna/relacje_nauczyciel_uczen',      label: 'Relacje nauczycielďż˝ucze9',                file: 'wiki/psychologia_szkolna/relacje_nauczyciel_uczen.md'      },
        ...
        { id: 'psychologia_szkolna/stres_szkolny',                 label: 'Stres szkolny i lďż˝"k egzaminacyjny',       file: 'wiki/psychologia_szkolna/stres_szkolny.md'                 },
    ...
    {
      section: 'Psychologia osBb z niepe9nosprawno9:ciďż˝&',
      domainKey: 'psychologia_niepelnosprawnosci',
      items: [
        { id: 'psychologia_niepelnosprawnosci/wprowadzenie',                  label: 'Psychologia niepe9nosprawno9:ci - wprow.', file: 'wiki/psychologia_niepelnosprawnosci/wprowadzenie.md'                  },
        { id: 'psychologia_niepelnosprawnosci/modele_niepelnosprawnosci',     label: 'Modele niepe9nosprawno9:ci',              file: 'wiki/psychologia_niepelnosprawnosci/modele_niepelnosprawnosci.md'     },
        { id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_intelektualna', label: 'Niepe9nosprawno9:ďż˝! intelektualna',      file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_intelektualna.md' },
        { id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_ruchowa',     label: 'Niepe9nosprawno9:ďż˝! ruchowa',              file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_ruchowa.md'     },
        { id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_wzrokowa',    label: 'Niepe9nosprawno9:ďż˝! wzrokowa',             file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_wzrokowa.md'    },
        { id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_sluchowa',    label: 'Niepe9nosprawno9:ďż˝! s9uchowa',             file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_sluchowa.md'    },
        { id: 'psychologia_niepelnosprawnosci/autyzm_niepelnosprawnosc',      label: 'Spektrum autyzmu i niepe9nosprawno9:ďż˝!',   file: 'wiki/psychologia_niepelnosprawnosci/autyzm_niepelnosprawnosc.md'      },
        { id: 'psychologia_niepelnosprawnosci/jakosc_zycia',                  label: 'Jako9:ďż˝! 9=ycia osBb z niepe9nosprawno9:ciďż˝&',file: 'wiki/psychologia_niepelnosprawnosci/jakosc_zycia.md'                  },
        ...
        { id: 'psychologia_niepelnosprawnosci/inkluzja_spoleczna',            label: 'Inkluzja spo9eczna i prawa',             file: 'wiki/psychologia_niepelnosprawnosci/inkluzja_spoleczna.md'            },
      ]
    },
    {
      section: 'Psychologia osBb w podesz9ym wieku',
      ...
      items: [
        ...
        { id: 'geropsychologia/starzenie_poznawcze',        label: 'Starzenie siďż˝" poznawcze',             file: 'wiki/geropsychologia/starzenie_poznawcze.md'        },
        { id: 'geropsychologia/demencja',                   label: 'Demencja i ch. neurodegeneracyjne',   file: 'wiki/geropsychologia/demencja.md'                   },
        { id: 'geropsychologia/depresja_starszych',         label: 'Depresja u osBb starszych',           file: 'wiki/geropsychologia/depresja_starszych.md'         },
        { id: 'geropsychologia/samotnosc',                  label: 'Samotno9:ďż˝! i izolacja spo9eczna',      file: 'wiki/geropsychologia/samotnosc.md'                  },
        { id: 'geropsychologia/jakosc_zycia_starszych',     label: 'Jako9:ďż˝! 9=ycia w staro9:ci',             file: 'wiki/geropsychologia/jakosc_zycia_starszych.md'     },
        { id: 'geropsychologia/aktywnosc_poznawcza',        label: 'Aktywno9:ďż˝! poznawcza i trening umys9u',file: 'wiki/geropsychologia/aktywnosc_poznawcza.md'        },
        { id: 'geropsychologia/umieranie_smierc',           label: 'Psychologia umierania i 9:mierci',     file: 'wiki/geropsychologia/umieranie_smierc.md'           },
        { id: 'geropsychologia/relacje_spoleczne_starszych',label: 'Relacje spo9eczne i wsparcie rodziny',file: 'wiki/geropsychologia/relacje_spoleczne_starszych.md'},
        ...
        { id: 'geropsychologia/opieka_nad_opiekunami',      label: 'Wypalenie i wsparcie opiekunBw',      file: 'wiki/geropsychologia/opieka_nad_opiekunami.md'      },
      ]
    },
    {
      section: 'NeurorB9=norodno9:ďż˝!',
      domainKey: 'neuroroznorodnosc',
      items: [
        { id: 'neuroroznorodnosc/wprowadzenie',               label: 'NeurorB9=norodno9:ďż˝!',    file: 'wiki/neuroroznorodnosc/wprowadzenie.md'               },
        { id: 'neuroroznorodnosc/adhd',                       label: 'ADHD jako wariant neurorB9=norodno9:ci', file: 'wiki/neuroroznorodnosc/adhd.md'                       },
        ...
        { id: 'neuroroznorodnosc/tourette',                   label: 'ZespB9 Tourette\'a i tiki',            file: 'wiki/neuroroznorodnosc/tourette.md'                   },
        { id: 'neuroroznorodnosc/hiperleksja',                label: 'Hiperleksja i wyjďż˝&tkowe zdolno9:ci',    file: 'wiki/neuroroznorodnosc/hiperleksja.md'                },
        ...
        { id: 'neuroroznorodnosc/neurozroznorodnosc_w_pracy', label: 'NeurorB9=norodno9:ďż˝! w miejscu pracy',   file: 'wiki/neuroroznorodnosc/neurozroznorodnosc_w_pracy.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'psychoterapia/skutecznosc',label: 'Skuteczno9:ďż˝! psychoterapii',    file: 'wiki/psychoterapia/skutecznosc.md'},
        ...
        { id: 'psychoterapia/trening_umiejetnosci_spolecznych', label: 'Trening Umiejďż˝"tno9:ci Spo9ecznych (SST)', file: 'wiki/psychoterapia/trening_umiejetnosci_spolecznych.md' },
        { id: 'psychoterapia/gestalt',    label: 'P9odna pustka (Gestalt)',       file: 'wiki/psychoterapia/gestalt.md'    },
        ...
        { id: 'psychoterapia/psychologia_zimbardo',    label: 'Psychologia spo9eczna (Zimbardo)',    file: 'wiki/psychoterapia/psychologia_zimbardo.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'psychologia_pozytywna/szczescie_dobrostan',   label: 'Szczďż˝"9:cie i dobrostan',            file: 'wiki/psychologia_pozytywna/szczescie_dobrostan.md'   },
        ...
        { id: 'psychologia_pozytywna/przeplyw_flow',         label: 'Przep9yw (flow)',                  file: 'wiki/psychologia_pozytywna/przeplyw_flow.md'         },
        { id: 'psychologia_pozytywna/sily_charakteru',       label: 'Si9y charakteru (VIA)',            file: 'wiki/psychologia_pozytywna/sily_charakteru.md'       },
        { id: 'psychologia_pozytywna/wdziecznosc',           label: 'Wdziďż˝"czno9:ďż˝!',                      file: 'wiki/psychologia_pozytywna/wdziecznosc.md'           },
        { id: 'psychologia_pozytywna/mindfulness',           label: 'Mindfulness i uwa9=no9:ďż˝!',           file: 'wiki/psychologia_pozytywna/mindfulness.md'           },
        { id: 'psychologia_pozytywna/wspolczucie_dla_siebie',label: 'WspB9czucie dla siebie',           file: 'wiki/psychologia_pozytywna/wspolczucie_dla_siebie.md'},
        { id: 'psychologia_pozytywna/sens_i_cel',            label: 'Sens 9=ycia i poczucie celu',       file: 'wiki/psychologia_pozytywna/sens_i_cel.md'            },
        { id: 'psychologia_pozytywna/relacje_pozytywne',     label: 'Pozytywne relacje i mi9o9:ďż˝!',       file: 'wiki/psychologia_pozytywna/relacje_pozytywne.md'     },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'suicydologia/psychopatologia_a_ryzyko',  label: 'Psychopatologia, a ryzyko samobBjstwa', file: 'wiki/suicydologia/psychopatologia_a_ryzyko_samobojstwa.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'seksuologia/wstyd_ciala_a_pozycje',      label: 'Wstyd cia9a, a pozycje seksualne', file: 'wiki/seksuologia/wstyd_ciala_a_pozycje.md'      },
        { id: 'seksuologia/orientacja',               label: 'Orientacja seksualna',        file: 'wiki/seksuologia/orientacja.md'               },
        { id: 'seksuologia/tozsamosc_plciowa',        label: 'To9=samo9:ďż˝! p9ciowa',           file: 'wiki/seksuologia/tozsamosc_plciowa.md'        },
        { id: 'seksuologia/dysfunkcje',               label: 'Dysfunkcje seksualne',        file: 'wiki/seksuologia/dysfunkcje.md'               },
        { id: 'seksuologia/hiperseksualnosc_mechanizm', label: 'Hiperseksualno9:ďż˝! jako mechanizm', file: 'wiki/seksuologia/hiperseksualnosc_mechanizm.md' },
        ...
        { id: 'seksuologia/przemoc_w_dziecinstwie_a_seksualnosc', label: 'Przemoc w dzieci9stwie, a seksualno9:ďż˝! doros9ych', file: 'wiki/seksuologia/przemoc_w_dziecinstwie_a_seksualnosc.md' },
        { id: 'seksuologia/dda_a_seksualnosc',         label: 'DDA, a seksualno9:ďż˝! doros9ych', file: 'wiki/seksuologia/dda_a_seksualnosc.md'         },
        { id: 'seksuologia/rozw_seksualny',           label: 'RozwBj seksualny',            file: 'wiki/seksuologia/rozw_seksualny.md'           },
        { id: 'seksuologia/modele_odpowiedzi',        label: 'Modele odpowiedzi seksualnej',file: 'wiki/seksuologia/modele_odpowiedzi.md'        },
      ]
    },
    {
      section: 'Psychologia sďż˝&dowa i opiniowanie',
      domainKey: 'psychologia_sadowa',
      items: [
        { id: 'psychologia_sadowa/wprowadzenie',            label: 'Bieg9y psycholog',       file: 'wiki/psychologia_sadowa/wprowadzenie.md'            },
        { id: 'psychologia_sadowa/rola_bieglego',           label: 'Rola i status bieg9ego',                file: 'wiki/psychologia_sadowa/rola_bieglego.md'           },
        { id: 'psychologia_sadowa/podstawy_prawne',         label: 'Podstawy prawne opiniowania',           file: 'wiki/psychologia_sadowa/podstawy_prawne.md'         },
        { id: 'psychologia_sadowa/metodologia_opinii',      label: 'Metodologia sporzďż˝&dzania opinii',       file: 'wiki/psychologia_sadowa/metodologia_opinii.md'      },
        ...
        { id: 'psychologia_sadowa/narzedzia_diagnostyczne', label: 'Narzďż˝"dzia diagnostyczne (sďż˝&dowe)',      file: 'wiki/psychologia_sadowa/narzedzia_diagnostyczne.md' },
        { id: 'psychologia_sadowa/etyka_opiniowania',       label: 'Etyka opiniowania sďż˝&dowego',            file: 'wiki/psychologia_sadowa/etyka_opiniowania.md'       },
        ...
        { id: 'psychologia_sadowa/biegly_a_sad',            label: 'Bieg9y, a sďż˝&d - komunikacja',            file: 'wiki/psychologia_sadowa/biegly_a_sad.md'            },
      ]
    },
    {
      section: 'Ekrany, ksiďż˝&9=ki,, a natura',
      domainKey: 'ekrany_ksiazki_i_natura',
      items: [
        { id: 'ekrany_ksiazki_i_natura/wprowadzenie',             label: 'Ekrany, ksiďż˝&9=ki i natura - wprow.',   file: 'wiki/ekrany_ksiazki_i_natura/wprowadzenie.md'              },
        ...
        { id: 'ekrany_ksiazki_i_natura/tablety_dzieci',           label: 'Tablety, a rozwBj poznawczy dzieci',   file: 'wiki/ekrany_ksiazki_i_natura/tablety_dzieci.md'            },
        ...
        { id: 'ekrany_ksiazki_i_natura/czytanie_ksiazek',         label: 'Czytanie ksiďż˝&9=ek, a funkcje psych.',   file: 'wiki/ekrany_ksiazki_i_natura/czytanie_ksiazek.md'          },
        { id: 'ekrany_ksiazki_i_natura/gleboke_czytanie',         label: 'G9ďż˝"bokie czytanie',                   file: 'wiki/ekrany_ksiazki_i_natura/gleboke_czytanie.md'          },
        ...
        { id: 'ekrany_ksiazki_i_natura/las_shinrin_yoku',         label: 'Kďż˝&piel le9:na (shinrin-yoku)',         file: 'wiki/ekrany_ksiazki_i_natura/las_shinrin_yoku.md'          },
        { id: 'ekrany_ksiazki_i_natura/gory_psychologia',         label: 'GBry i wďż˝"drBwki gBrskie',             file: 'wiki/ekrany_ksiazki_i_natura/gory_psychologia.md'          },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'psychologia_gier/flow_i_immersja',      label: 'Przep9yw (flow) i immersja',      file: 'wiki/psychologia_gier/flow_i_immersja.md'       },
        ...
        { id: 'psychologia_gier/gender_w_grach',       label: 'P9eďż˝! i to9=samo9:ďż˝! w grach',        file: 'wiki/psychologia_gier/gender_w_grach.md'        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'e_terapia/platformy_e_terapii',           label: 'Platformy i narzďż˝"dzia e-terapii',       file: 'wiki/e_terapia/platformy_e_terapii.md'           },
        { id: 'e_terapia/skutecznosc_e_terapii',         label: 'Skuteczno9:ďż˝! e-terapii',                 file: 'wiki/e_terapia/skutecznosc_e_terapii.md'         },
        ...
        { id: 'e_terapia/vr_terapia',                    label: 'Wirtualna rzeczywisto9:ďż˝! (VR) w terapii',file: 'wiki/e_terapia/vr_terapia.md'                    },
        { id: 'e_terapia/e_terapia_dzieci',              label: 'E-terapia dzieci i m9odzie9=y',          file: 'wiki/e_terapia/e_terapia_dzieci.md'              },
        { id: 'e_terapia/dostepnosc_cyfrowa',            label: 'Dostďż˝"pno9:ďż˝! i wykluczenie cyfrowe',      file: 'wiki/e_terapia/dostepnosc_cyfrowa.md'            },
        { id: 'e_terapia/przyszlosc_e_terapii',          label: 'Przysz9o9:ďż˝! e-terapii',                  file: 'wiki/e_terapia/przyszlosc_e_terapii.md'          },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'psychologia_ai/czlowiek_a_ai',        label: 'Interakcja cz9owiek-AI',                    file: 'wiki/psychologia_ai/czlowiek_a_ai.md'          },
        { id: 'psychologia_ai/zaufanie_do_ai',       label: 'Zaufanie do sztucznej inteligencji',        file: 'wiki/psychologia_ai/zaufanie_do_ai.md'         },
        { id: 'psychologia_ai/uprzedzenia_ai',       label: 'Uprzedzenia i b9ďż˝"dy poznawcze w AI',        file: 'wiki/psychologia_ai/uprzedzenia_ai.md'         },
        ...
        { id: 'psychologia_ai/ai_poznawcze',         label: 'Poznawcze aspekty dzia9ania AI',            file: 'wiki/psychologia_ai/ai_poznawcze.md'           },
        { id: 'psychologia_ai/antropomorfizacja_ai', label: 'Antropomorfizacja AI',                      file: 'wiki/psychologia_ai/antropomorfizacja_ai.md'   },
        { id: 'psychologia_ai/przyszlosc_ai',        label: 'Przysz9o9:ďż˝! relacji cz9owiek-AI',            file: 'wiki/psychologia_ai/przyszlosc_ai.md'          },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'psychologia_technologii/zmeczenie_cyfrowe', label: 'Zmďż˝"czenie cyfrowe i przeciďż˝&9=enie informacyjne', file: 'wiki/psychologia_technologii/zmeczenie_cyfrowe.md' },
        ...
        { id: 'psychologia_technologii/higiena_cyfrowa', label: 'Higiena cyfrowa i profilaktyka przeciďż˝&9=enia', file: 'wiki/psychologia_technologii/higiena_cyfrowa.md' },
        ...
        { id: 'psychologia_technologii/psychoedukacja_rodzinna', label: 'Psychoedukacja rodzinna w erze ekranBw', file: 'wiki/psychologia_technologii/psychoedukacja_rodzinna.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'robotyka_afektywna/roboty_spoleczne',               label: 'Roboty spo9eczne i HRI',                    file: 'wiki/robotyka_afektywna/roboty_spoleczne.md'                },
        ...
        { id: 'robotyka_afektywna/percepcja_robotow',              label: 'Percepcja i ocena robotBw przez ludzi',     file: 'wiki/robotyka_afektywna/percepcja_robotow.md'               },
        { id: 'robotyka_afektywna/roboty_w_opiece',                label: 'Roboty w opiece i terapii',                 file: 'wiki/robotyka_afektywna/roboty_w_opiece.md'                 },
        { id: 'robotyka_afektywna/swiadomosc_maszyn',              label: '9awiadomo9:ďż˝! i podmiotowo9:ďż˝! maszyn',          file: 'wiki/robotyka_afektywna/swiadomosc_maszyn.md'               },
        { id: 'robotyka_afektywna/wspolpraca_czlowiek_robot',      label: 'WspB9praca cz9owiekďż˝robot (HRC)',            file: 'wiki/robotyka_afektywna/wspolpraca_czlowiek_robot.md'       },
        { id: 'robotyka_afektywna/interfejsy_mozg_maszyna',        label: 'Interfejsy mBzgďż˝maszyna (BCI)',              file: 'wiki/robotyka_afektywna/interfejsy_mozg_maszyna.md'         },
        { id: 'robotyka_afektywna/przyszlosc_robotyki_afektywnej', label: 'Przysz9o9:ďż˝! robotyki afektywnej',            file: 'wiki/robotyka_afektywna/przyszlosc_robotyki_afektywnej.md'  },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'seminarium_dyplomowe/przeglad_literatury',      label: 'Przeglďż˝&d literatury naukowej',           file: 'wiki/seminarium_dyplomowe/przeglad_literatury.md'      },
        ...
        { id: 'seminarium_dyplomowe/pomiary_psychologiczne',   label: 'Zasady prowadzenia pomiarBw',            file: 'wiki/seminarium_dyplomowe/pomiary_psychologiczne.md'   },
        { id: 'seminarium_dyplomowe/narzedzia_badawcze',       label: 'Narzďż˝"dzia badawcze i kwestionariusze',  file: 'wiki/seminarium_dyplomowe/narzedzia_badawcze.md'       },
        ...
        { id: 'seminarium_dyplomowe/bledy_badawcze',           label: 'B9ďż˝"dy badawcze - czego unikaďż˝!',         file: 'wiki/seminarium_dyplomowe/bledy_badawcze.md'           },
        { id: 'seminarium_dyplomowe/opis_wynikow',             label: 'Pisanie i interpretacja wynikBw',       file: 'wiki/seminarium_dyplomowe/opis_wynikow.md'             },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'eksperyment_psychologiczny/proby_i_rekrutacja',        label: 'DobBr prBby i rekrutacja',                   file: 'wiki/eksperyment_psychologiczny/proby_i_rekrutacja.md'        },
        ...
        { id: 'eksperyment_psychologiczny/protokol_i_pilotaz',        label: 'ProtokB9 badania i pilota9=',                 file: 'wiki/eksperyment_psychologiczny/protokol_i_pilotaz.md'        },
        ...
        { id: 'eksperyment_psychologiczny/jakosc_danych',             label: 'Kontrola jako9:ci i zarzďż˝&dzanie danymi',      file: 'wiki/eksperyment_psychologiczny/jakosc_danych.md'             },
        ...
        { id: 'eksperyment_psychologiczny/raportowanie_wynikow',      label: 'Raportowanie wynikBw i ogranicze9',          file: 'wiki/eksperyment_psychologiczny/raportowanie_wynikow.md'      },
      ]
    },
    {
      section: 'Wstďż˝"p do psychologii klinicznej dziecka',
      ...
      items: [
        ...
        { id: 'psychologia_kliniczna_dziecka/wywiad_kliniczny_z_dzieckiem_i_rodzina', label: 'Wywiad kliniczny z dzieckiem i rodzinďż˝&', file: 'wiki/psychologia_kliniczna_dziecka/wywiad_kliniczny_z_dzieckiem_i_rodzina.md' },
        ...
        { id: 'psychologia_kliniczna_dziecka/przywiazanie_i_relacje_opiekuncze', label: 'Przywiďż˝&zanie i relacje opieku9cze', file: 'wiki/psychologia_kliniczna_dziecka/przywiazanie_i_relacje_opiekuncze.md' },
        { id: 'psychologia_kliniczna_dziecka/diagnoza_roznicowa_neurorozwojowa', label: 'Diagnoza rB9=nicowa: emocje vs neurorozwBj', file: 'wiki/psychologia_kliniczna_dziecka/diagnoza_roznicowa_neurorozwojowa.md' },
        { id: 'psychologia_kliniczna_dziecka/formulowanie_przypadku_4p', label: 'Formu9owanie przypadku (4P)', file: 'wiki/psychologia_kliniczna_dziecka/formulowanie_przypadku_4p.md' },
        ...
        { id: 'psychologia_kliniczna_dziecka/cbt_dzieci_i_mlodziez', label: 'CBT dla dzieci i m9odzie9=y', file: 'wiki/psychologia_kliniczna_dziecka/cbt_dzieci_i_mlodziez.md' },
        { id: 'psychologia_kliniczna_dziecka/wspolpraca_rodzina_szkola_system', label: 'WspB9praca rodzinaďż˝szko9aďż˝system', file: 'wiki/psychologia_kliniczna_dziecka/wspolpraca_rodzina_szkola_system.md' },
        { id: 'psychologia_kliniczna_dziecka/bledy_diagnostyczne_i_iatrogenia', label: 'B9ďż˝"dy diagnostyczne i jatrogenia', file: 'wiki/psychologia_kliniczna_dziecka/bledy_diagnostyczne_i_iatrogenia.md' },
      ]
    },
    {
      section: 'Reagowanie na krytykďż˝"',
      domainKey: 'reagowanie_na_krytyke',
      items: [
        { id: 'reagowanie_na_krytyke/czym_jest_krytyka_i_informacja_zwrotna', label: 'Krytyka, a informacja zwrotna - rozrB9=nienie', file: 'wiki/reagowanie_na_krytyke/czym_jest_krytyka_i_informacja_zwrotna.md' },
        { id: 'reagowanie_na_krytyke/style_reagowania_na_krytyke', label: 'Style reagowania na krytykďż˝"', file: 'wiki/reagowanie_na_krytyke/style_reagowania_na_krytyke.md' },
        ...
        { id: 'reagowanie_na_krytyke/schematy_poznawcze_i_znieksztalcenia', label: 'Schematy poznawcze i zniekszta9cenia', file: 'wiki/reagowanie_na_krytyke/schematy_poznawcze_i_znieksztalcenia.md' },
        ...
        { id: 'reagowanie_na_krytyke/granice_i_asertywnosc', label: 'Granice i asertywno9:ďż˝!', file: 'wiki/reagowanie_na_krytyke/granice_i_asertywnosc.md' },
        ...
        { id: 'reagowanie_na_krytyke/samowspolczucie_i_act', label: 'SamowspB9czucie i ACT', file: 'wiki/reagowanie_na_krytyke/samowspolczucie_i_act.md' },
        ...
        { id: 'reagowanie_na_krytyke/najczestsze_bledy_po_krytyce', label: 'Najczďż˝"stsze b9ďż˝"dy po krytyce', file: 'wiki/reagowanie_na_krytyke/najczestsze_bledy_po_krytyce.md' },
        ...
        { id: 'reagowanie_na_krytyke/jak_nie_brac_do_siebie_opinii_innych', label: 'Jak nie braďż˝! do siebie opinii innych', file: 'wiki/reagowanie_na_krytyke/jak_nie_brac_do_siebie_opinii_innych.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'psychologia_nadmiernego_jedzenia/neurobiologia_nagrody_i_glodu', label: 'Neurobiologia nagrody i g9odu', file: 'wiki/psychologia_nadmiernego_jedzenia/neurobiologia_nagrody_i_glodu.md' },
        ...
        { id: 'psychologia_nadmiernego_jedzenia/obraz_ciala_i_samokrytycyzm', label: 'Obraz cia9a i samokrytycyzm', file: 'wiki/psychologia_nadmiernego_jedzenia/obraz_ciala_i_samokrytycyzm.md' },
        ...
        { id: 'psychologia_nadmiernego_jedzenia/diagnoza_roznicowa_bed_bulimia', label: 'Diagnoza rB9=nicowa: BED i bulimia', file: 'wiki/psychologia_nadmiernego_jedzenia/diagnoza_roznicowa_bed_bulimia.md' },
        ...
        { id: 'psychologia_nadmiernego_jedzenia/profilaktyka_nawrotow', label: 'Profilaktyka nawrotBw', file: 'wiki/psychologia_nadmiernego_jedzenia/profilaktyka_nawrotow.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'instytucje_wsparcia_dziecka_i_rodziny/piecza_zastepcza_i_asysta_rodziny', label: 'Piecza zastďż˝"pcza i asysta rodziny', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/piecza_zastepcza_i_asysta_rodziny.md' },
        { id: 'instytucje_wsparcia_dziecka_i_rodziny/interwencja_kryzysowa_i_niebieska_karta', label: 'Interwencja kryzysowa i ďż˝~Niebieska Kartaďż˝e', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/interwencja_kryzysowa_i_niebieska_karta.md' },
        { id: 'instytucje_wsparcia_dziecka_i_rodziny/sad_rodzinny_i_kurator', label: 'Sďż˝&d rodzinny i kurator', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/sad_rodzinny_i_kurator.md' },
        ...
        { id: 'instytucje_wsparcia_dziecka_i_rodziny/szkola_jako_instytucja_wsparcia', label: 'Szko9a jako instytucja wsparcia', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/szkola_jako_instytucja_wsparcia.md' },
        ...
        { id: 'instytucje_wsparcia_dziecka_i_rodziny/koordynacja_miedzyinstytucjonalna', label: 'Koordynacja miďż˝"dzyinstytucjonalna', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/koordynacja_miedzyinstytucjonalna.md' },
        ...
        { id: 'instytucje_wsparcia_dziecka_i_rodziny/bledy_systemowe_i_dobre_praktyki', label: 'B9ďż˝"dy systemowe i dobre praktyki', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/bledy_systemowe_i_dobre_praktyki.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'resocjalizacja/trening_umiejetnosci_spolecznych_i_samokontroli', label: 'Trening umiejďż˝"tno9:ci spo9ecznych i samokontroli', file: 'wiki/resocjalizacja/trening_umiejetnosci_spolecznych_i_samokontroli.md' },
        { id: 'resocjalizacja/sprawiedliwosc_naprawcza_mediacje', label: 'Sprawiedliwo9:ďż˝! naprawcza i mediacje', file: 'wiki/resocjalizacja/sprawiedliwosc_naprawcza_mediacje.md' },
        ...
        { id: 'resocjalizacja/etyka_i_prawa_czlowieka', label: 'Etyka i prawa cz9owieka', file: 'wiki/resocjalizacja/etyka_i_prawa_czlowieka.md' },
        { id: 'resocjalizacja/ewaluacja_skutecznosci_programow', label: 'Ewaluacja skuteczno9:ci programBw', file: 'wiki/resocjalizacja/ewaluacja_skutecznosci_programow.md' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'somatic_experiencing/neurofizjologia_traumy_i_autonomiczny_uklad_nerwowy', label: 'Neurofizjologia traumy i autonomiczny uk9ad nerwowy', file: 'wiki/doswiadczenie_somatyczne/neurofizjologia_traumy_i_autonomiczny_uklad_nerwowy.md' },
        ...
        { id: 'somatic_experiencing/zasoby_i_poczucie_bezpieczenstwa', label: 'Zasoby i poczucie bezpiecze9stwa', file: 'wiki/doswiadczenie_somatyczne/zasoby_i_poczucie_bezpieczenstwa.md' },
        ...
        { id: 'somatic_experiencing/dysocjacja_i_zawazenie_okna_tolerancji', label: 'Dysocjacja i zawďż˝"9=enie okna tolerancji', file: 'wiki/doswiadczenie_somatyczne/dysocjacja_i_zawazenie_okna_tolerancji.md' },
        { id: 'somatic_experiencing/reakcja_obronna_i_dokonczenie_ruchu', label: 'Reakcja obronna i doko9czenie ruchu', file: 'wiki/doswiadczenie_somatyczne/reakcja_obronna_i_dokonczenie_ruchu.md' },
        { id: 'somatic_experiencing/trauma_zlozona_i_relacja_terapeutyczna', label: 'Trauma z9o9=ona i relacja terapeutyczna', file: 'wiki/doswiadczenie_somatyczne/trauma_zlozona_i_relacja_terapeutyczna.md' },
        ...
        { id: 'somatic_experiencing/przewlekly_bol_i_objawy_somatyczne', label: 'Przewlek9y bBl i objawy somatyczne', file: 'wiki/doswiadczenie_somatyczne/przewlekly_bol_i_objawy_somatyczne.md' },
    ...
    
    {
      ...
      items: [
        ...
        { id: 'wiki-index/spoleczna',            label: 'WIKI - Psych. spo9eczna',                   wiki: 'spoleczna'            },
        ...
        { id: 'wiki-index/relacje',              label: 'WIKI - Relacje i zwiďż˝&zki',                  wiki: 'relacje'              },
        ...
        { id: 'wiki-index/roznice_ind',          label: 'WIKI - RB9=nice indywidualne',               wiki: 'roznice_ind'          },
        ...
        { id: 'wiki-index/slownik',              label: 'WIKI - S9ownik terminBw',                   wiki: 'slownik'              },
        ...
        { id: 'wiki-index/niepelnosprawnosc',    label: 'WIKI - Psych. niepe9nosprawno9:ci',          wiki: 'niepelnosprawnosc'    },
        { id: 'wiki-index/geropsychology',       label: 'WIKI - Psych. osBb starszych',              wiki: 'geropsychologia'       },
        { id: 'wiki-index/gry_wideo',            label: 'WIKI - Psych. gier wideo',                  wiki: 'gry_wideo'            },
        { id: 'wiki-index/odpornosc_mobbing',    label: 'WIKI - Odporno9:ďż˝!, mobbing, wypalenie',      wiki: 'odpornosc_mobbing'    },
        { id: 'wiki-index/media_natura',         label: 'WIKI - Ekrany, ksiďż˝&9=ki i natura',           wiki: 'media_natura'         },
        ...
        { id: 'wiki-index/neurozroznorodnosc',   label: 'WIKI - NeurorB9=norodno9:ďż˝!',                  wiki: 'neurozroznorodnosc'   },
        { id: 'wiki-index/psych_sadowa',         label: 'WIKI - Psychologia sďż˝&dowa',                 wiki: 'psych_sadowa'         },
        { id: 'wiki-index/e_terapia',            label: 'WIKI - E-terapia',                          wiki: 'e_terapia'            },
        { id: 'wiki-index/filozofia',            label: 'WIKI - Filozofia',                          wiki: 'filozofia'            },
        { id: 'wiki-index/nvc',                  label: 'WIKI - Porozumiewanie siďż˝" bez przemocy',    wiki: 'porozumiewanie_sie_bez_przemocy'                  },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'reference/mapa_powiazan_nowe_artykuly', label: 'Mapa powiďż˝&za9 nowych artyku9Bw', file: 'wiki/reference/mapa_powiazan_nowe_artykuly.md' },
      ]
    },
  ],
  ...
  plans: {
    ...
    students: [
      { id: 'dla_studentow/wybor_specjalnosci', label: 'WybBr specjalno9:ci', file: 'wiki/dla_studentow/wybor_specjalnosci.md', status: 'live' },
      ...
      { id: 'dla_studentow/wystapienia_publiczne_autoprezentacja', label: 'Wystďż˝&pienia publiczne i autoprezentacja', file: 'wiki/dla_studentow/wystapienia_publiczne_autoprezentacja.md', status: 'live' },
    ...
    psychologia_religii: [
      { id: 'psychologia_religii/wprowadzenie', label: 'Psychologia religii ďż˝ wprowadzenie', file: 'wiki/psychologia_religii/wprowadzenie.md', status: 'live' },
      { id: 'psychologia_religii/religijnosc_i_duchowosc', label: 'Religijno9:ďż˝! a duchowo9:ďż˝!', file: 'wiki/psychologia_religii/religijnosc_i_duchowosc.md', status: 'live' },
      { id: 'psychologia_religii/rozwoj_religijnosci', label: 'RozwBj religijno9:ci w cyklu 9=ycia', file: 'wiki/psychologia_religii/rozwoj_religijnosci.md', status: 'live' },
      ...
      { id: 'psychologia_religii/obrazy_boga', label: 'Obrazy Boga i style przywiďż˝&zania', file: 'wiki/psychologia_religii/obrazy_boga.md', status: 'live' },
      { id: 'psychologia_religii/wspolnota_i_tozsamosc', label: 'WspBlnota religijna a to9=samo9:ďż˝!', file: 'wiki/psychologia_religii/wspolnota_i_tozsamosc.md', status: 'live' },
      { id: 'psychologia_religii/rytualy_i_zdrowie', label: 'Rytua9y religijne a dobrostan psychiczny', file: 'wiki/psychologia_religii/rytualy_i_zdrowie.md', status: 'live' },
      ...
      { id: 'psychologia_religii/religia_w_psychoterapii', label: 'Religia i duchowo9:ďż˝! w psychoterapii', file: 'wiki/psychologia_religii/religia_w_psychoterapii.md', status: 'live' },
    ...
    child_clinical_intro: [
      ...
      { id: 'psychologia_kliniczna_dziecka/wywiad_kliniczny_z_dzieckiem_i_rodzina', label: 'Wywiad kliniczny z dzieckiem i rodzinďż˝&', file: 'wiki/psychologia_kliniczna_dziecka/wywiad_kliniczny_z_dzieckiem_i_rodzina.md', status: 'live' },
      ...
      { id: 'psychologia_kliniczna_dziecka/przywiazanie_i_relacje_opiekuncze', label: 'Przywiďż˝&zanie i relacje opieku9cze', file: 'wiki/psychologia_kliniczna_dziecka/przywiazanie_i_relacje_opiekuncze.md', status: 'live' },
      { id: 'psychologia_kliniczna_dziecka/diagnoza_roznicowa_neurorozwojowa', label: 'Diagnoza rB9=nicowa: emocje vs neurorozwBj', file: 'wiki/psychologia_kliniczna_dziecka/diagnoza_roznicowa_neurorozwojowa.md', status: 'live' },
      { id: 'psychologia_kliniczna_dziecka/formulowanie_przypadku_4p', label: 'Formu9owanie przypadku (4P)', file: 'wiki/psychologia_kliniczna_dziecka/formulowanie_przypadku_4p.md', status: 'live' },
      ...
      { id: 'psychologia_kliniczna_dziecka/cbt_dzieci_i_mlodziez', label: 'CBT dla dzieci i m9odzie9=y', file: 'wiki/psychologia_kliniczna_dziecka/cbt_dzieci_i_mlodziez.md', status: 'live' },
      { id: 'psychologia_kliniczna_dziecka/wspolpraca_rodzina_szkola_system', label: 'WspB9praca rodzinaďż˝szko9aďż˝system', file: 'wiki/psychologia_kliniczna_dziecka/wspolpraca_rodzina_szkola_system.md', status: 'live' },
      { id: 'psychologia_kliniczna_dziecka/bledy_diagnostyczne_i_iatrogenia', label: 'B9ďż˝"dy diagnostyczne i jatrogenia', file: 'wiki/psychologia_kliniczna_dziecka/bledy_diagnostyczne_i_iatrogenia.md', status: 'live' },
    ],
    reacting_to_criticism: [
      { id: 'reagowanie_na_krytyke/czym_jest_krytyka_i_informacja_zwrotna', label: 'Krytyka, a informacja zwrotna - rozrB9=nienie', file: 'wiki/reagowanie_na_krytyke/czym_jest_krytyka_i_informacja_zwrotna.md', status: 'live' },
      { id: 'reagowanie_na_krytyke/style_reagowania_na_krytyke', label: 'Style reagowania na krytykďż˝"', file: 'wiki/reagowanie_na_krytyke/style_reagowania_na_krytyke.md', status: 'live' },
      ...
      { id: 'reagowanie_na_krytyke/schematy_poznawcze_i_znieksztalcenia', label: 'Schematy poznawcze i zniekszta9cenia', file: 'wiki/reagowanie_na_krytyke/schematy_poznawcze_i_znieksztalcenia.md', status: 'live' },
      ...
      { id: 'reagowanie_na_krytyke/granice_i_asertywnosc', label: 'Granice i asertywno9:ďż˝!', file: 'wiki/reagowanie_na_krytyke/granice_i_asertywnosc.md', status: 'live' },
      ...
      { id: 'reagowanie_na_krytyke/samowspolczucie_i_act', label: 'SamowspB9czucie i ACT', file: 'wiki/reagowanie_na_krytyke/samowspolczucie_i_act.md', status: 'live' },
      ...
      { id: 'reagowanie_na_krytyke/najczestsze_bledy_po_krytyce', label: 'Najczďż˝"stsze b9ďż˝"dy po krytyce', file: 'wiki/reagowanie_na_krytyke/najczestsze_bledy_po_krytyce.md', status: 'live' },
      ...
      { id: 'reagowanie_na_krytyke/jak_nie_brac_do_siebie_opinii_innych', label: 'Jak nie braďż˝! do siebie opinii innych', file: 'wiki/reagowanie_na_krytyke/jak_nie_brac_do_siebie_opinii_innych.md', status: 'live' },
    ],
    overeating_psychology: [
      ...
      { id: 'psychologia_nadmiernego_jedzenia/neurobiologia_nagrody_i_glodu', label: 'Neurobiologia nagrody i g9odu', file: 'wiki/psychologia_nadmiernego_jedzenia/neurobiologia_nagrody_i_glodu.md', status: 'live' },
      ...
      { id: 'psychologia_nadmiernego_jedzenia/obraz_ciala_i_samokrytycyzm', label: 'Obraz cia9a i samokrytycyzm', file: 'wiki/psychologia_nadmiernego_jedzenia/obraz_ciala_i_samokrytycyzm.md', status: 'live' },
      ...
      { id: 'psychologia_nadmiernego_jedzenia/diagnoza_roznicowa_bed_bulimia', label: 'Diagnoza rB9=nicowa: BED i bulimia', file: 'wiki/psychologia_nadmiernego_jedzenia/diagnoza_roznicowa_bed_bulimia.md', status: 'live' },
      ...
      { id: 'psychologia_nadmiernego_jedzenia/profilaktyka_nawrotow', label: 'Profilaktyka nawrotBw', file: 'wiki/psychologia_nadmiernego_jedzenia/profilaktyka_nawrotow.md', status: 'live' },
    ],
    child_family_support_institutions: [
      ...
      { id: 'instytucje_wsparcia_dziecka_i_rodziny/piecza_zastepcza_i_asysta_rodziny', label: 'Piecza zastďż˝"pcza i asysta rodziny', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/piecza_zastepcza_i_asysta_rodziny.md', status: 'live' },
      { id: 'instytucje_wsparcia_dziecka_i_rodziny/interwencja_kryzysowa_i_niebieska_karta', label: 'Interwencja kryzysowa i ďż˝~Niebieska Kartaďż˝e', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/interwencja_kryzysowa_i_niebieska_karta.md', status: 'live' },
      { id: 'instytucje_wsparcia_dziecka_i_rodziny/sad_rodzinny_i_kurator', label: 'Sďż˝&d rodzinny i kurator', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/sad_rodzinny_i_kurator.md', status: 'live' },
      ...
      { id: 'instytucje_wsparcia_dziecka_i_rodziny/szkola_jako_instytucja_wsparcia', label: 'Szko9a jako instytucja wsparcia', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/szkola_jako_instytucja_wsparcia.md', status: 'live' },
      ...
      { id: 'instytucje_wsparcia_dziecka_i_rodziny/koordynacja_miedzyinstytucjonalna', label: 'Koordynacja miďż˝"dzyinstytucjonalna', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/koordynacja_miedzyinstytucjonalna.md', status: 'live' },
      ...
      { id: 'instytucje_wsparcia_dziecka_i_rodziny/bledy_systemowe_i_dobre_praktyki', label: 'B9ďż˝"dy systemowe i dobre praktyki', file: 'wiki/instytucje_wsparcia_dziecka_i_rodziny/bledy_systemowe_i_dobre_praktyki.md', status: 'live' },
    ],
    resocialization: [
      ...
      { id: 'resocjalizacja/trening_umiejetnosci_spolecznych_i_samokontroli', label: 'Trening umiejďż˝"tno9:ci spo9ecznych i samokontroli', file: 'wiki/resocjalizacja/trening_umiejetnosci_spolecznych_i_samokontroli.md', status: 'live' },
      { id: 'resocjalizacja/sprawiedliwosc_naprawcza_mediacje', label: 'Sprawiedliwo9:ďż˝! naprawcza i mediacje', file: 'wiki/resocjalizacja/sprawiedliwosc_naprawcza_mediacje.md', status: 'live' },
      ...
      { id: 'resocjalizacja/etyka_i_prawa_czlowieka', label: 'Etyka i prawa cz9owieka', file: 'wiki/resocjalizacja/etyka_i_prawa_czlowieka.md', status: 'live' },
      { id: 'resocjalizacja/ewaluacja_skutecznosci_programow', label: 'Ewaluacja skuteczno9:ci programBw', file: 'wiki/resocjalizacja/ewaluacja_skutecznosci_programow.md', status: 'live' },
    ],
    'wiki-index': [],
    neuro: [
      { file: 'wiki/neuro/anatomia.md',    label: 'Anatomia mBzgu',             status: 'live' },
      { file: 'wiki/neuro/neuron.md',      label: 'Neuron i synapsa',           status: 'live' },
      { file: 'wiki/neuro/systemy.md',     label: 'Uk9ady i sieci mBzgowe',     status: 'live' },
      { file: 'wiki/neuro/myelinizacja.md',label: 'Mielinizacja i istota bia9a',status: 'live' },
      { file: 'wiki/neuro/plastycznosc.md',label: 'Neuroplastyczno9:ďż˝!',          status: 'live' },
      ...
      { file: 'wiki/neuro/zachowanie_i_dwie_polkule_mozgu.md', label: 'Zachowanie i dwie pB9kule mBzgu', status: 'live' },
      { file: 'wiki/neuro/kora_prefrontalna.md', label: 'Kora przedczo9owa',   status: 'live' },
      { file: 'wiki/neuro/uklad_limbiczny.md', label: 'Uk9ad limbiczny',       status: 'live' },
      { file: 'wiki/neuro/przesilenie_wiosenne.md', label: 'Neurobiologia przesilenia wiosennego', status: 'live' },
      { file: 'wiki/neuro/cykl_miesiaczkowy.md', label: 'Neuropsychologia cyklu miesiďż˝&czkowego', status: 'live' },
      { file: 'wiki/neuro/eye_tracking.md',        label: 'Eye tracking - 9:ledzenie wzroku',         status: 'live' },
      ...
      { file: 'wiki/neuro/pien_mozgu.md',          label: 'Pie9 mBzgu i mB9=d9=ek',               status: 'live' },
    ],
    cognitive: [
      { file: 'wiki/poznawcza/pamiec.md',              label: 'Pamiďż˝"ďż˝!',               status: 'live' },
      { file: 'wiki/poznawcza/pamiec_dlugotrwala.md',  label: 'Pamiďż˝"ďż˝! d9ugotrwa9a',   status: 'live' },
      { file: 'wiki/poznawcza/uwaga.md',               label: 'Uwaga',                status: 'live' },
      { file: 'wiki/poznawcza/jezyk.md',               label: 'Jďż˝"zyk',                status: 'live' },
      { file: 'wiki/poznawcza/funkcje_wykonawcze.md',  label: 'Funkcje wykonawcze',   status: 'live' },
      { file: 'wiki/poznawcza/percepcja.md',           label: 'Percepcja i gnozja',   status: 'live' },
      { file: 'wiki/poznawcza/zmeczenie_poznawcze.md', label: 'Zmďż˝"czenie poznawcze',  status: 'live' },
      { file: 'wiki/poznawcza/myslenie.md',            label: 'My9:lenie i rozumowanie', status: 'live' },
      { file: 'wiki/poznawcza/uczenie.md',             label: 'Uczenie siďż˝"',          status: 'live' },
      { file: 'wiki/poznawcza/wyobraznia.md',          label: 'Wyobra9_nia i reprezentacje', status: 'live' },
      { file: 'wiki/poznawcza/swiadomosc.md',          label: '9awiadomo9:ďż˝! i metapoznanie', status: 'live' },
      { file: 'wiki/poznawcza/podejmowanie_decyzji.md',label: 'Podejmowanie decyzji', status: 'live' },
      { file: 'wiki/poznawcza/exploration_exploitation_dilemma.md', label: 'Dylemat eksploracjaďż˝eksploatacja', status: 'live' },
      { file: 'wiki/poznawcza/teoria_perspektywy.md', label: 'Teoria perspektywy',    status: 'live' },
      { file: 'wiki/poznawcza/efekt_ramowania.md',    label: 'Efekt ramowania',       status: 'live' },
      { file: 'wiki/poznawcza/nasa_tlx.md',           label: 'NASA Task Load Index (TLX)', status: 'live' },
      { file: 'wiki/poznawcza/iluzje.md',             label: 'Iluzje i b9ďż˝"dy poznawcze',   status: 'live' },
      { file: 'wiki/poznawcza/test_stroopa.md',       label: 'Test Stroopa',               status: 'live' },
      { file: 'wiki/poznawcza/przyklad_testu_stroopa.md', label: 'Przyk9ad testu Stroopa', status: 'live' },
      { file: 'wiki/poznawcza/eksperyment_posnera.md',    label: 'Eksperyment Posnera',          status: 'live' },
      { file: 'wiki/poznawcza/maly_albert.md',            label: 'Eksperyment Ma9ego Alberta',   status: 'live' },
      { file: 'wiki/poznawcza/uklad_siatkowaty.md',       label: 'Uk9ad siatkowaty (ARAS)',      status: 'live' },
      { file: 'wiki/poznawcza/uwaga_mimowolna.md',         label: 'Uwaga mimowolna',              status: 'live' },
      { file: 'wiki/poznawcza/nauki_kognitywne.md',        label: 'Nauki kognitywne',             status: 'live' },
      { file: 'wiki/poznawcza/architektury_kognitywne.md', label: 'Architektury kognitywne',      status: 'live' },
      { file: 'wiki/poznawcza/hda.md',                     label: 'Human Decision Accuracy (HDA)',status: 'live' },
      { file: 'wiki/poznawcza/system1_system2.md',        label: 'System 1 i System 2 (Kahneman)', status: 'live' },
      { file: 'wiki/poznawcza/przetwarzanie_predyktywne.md',  label: 'Predictive processing',        status: 'live' },
      { file: 'wiki/poznawcza/ucielesnienie.md',              label: 'Uciele9:nione poznanie',        status: 'live' },
    ],
    spoleczna: [
      { file: 'wiki/spoleczna/percepcja_spoleczna.md',   label: 'Percepcja spo9eczna i atrybucje', status: 'live' },
      { file: 'wiki/spoleczna/eksperyment_wiezienny.md', label: 'Stanfordzki Eksperyment Wiďż˝"zienny', status: 'live' },
      { file: 'wiki/spoleczna/manipulacja.md', label: 'Manipulacja - mechanizmy i metody wp9ywu', status: 'live' },
      { file: 'wiki/spoleczna/stereotypy.md', label: 'Stereotypy i uprzedzenia', status: 'live' },
      { file: 'wiki/spoleczna/manosfera_feminizm.md', label: 'Manosfera i feminizm - ujďż˝"cie psychologiczne', status: 'live' },
      ...
      { file: 'wiki/spoleczna/konformizm.md', label: 'Konformizm i pos9usze9stwo', status: 'live' },
      ...
      { file: 'wiki/spoleczna/atrakcyjnosc.md', label: 'Atrakcyjno9:ďż˝! interpersonalna', status: 'live' },
      ...
      { file: 'wiki/spoleczna/zachowania_prospoleczne.md', label: 'Zachowania prospo9eczne', status: 'live' },
    ],
    disorders: [
      { file: 'wiki/zaburzenia/afazje.md',    label: 'Afazje',                 status: 'live' },
      { file: 'wiki/zaburzenia/amnezje.md',   label: 'Amnezje',                status: 'live' },
      { file: 'wiki/zaburzenia/otepienia.md', label: 'Otďż˝"pienia',              status: 'live' },
      { file: 'wiki/zaburzenia/tbi.md',       label: 'Urazy g9owy (TBI)',      status: 'live' },
    ...
    tests: [
      { file: 'wiki/testy/testy_przeglad.md',   label: 'Testy - przeglďż˝&d',      status: 'live' },
      ...
      { file: 'wiki/testy/testy_pamieci.md',    label: 'Testy pamiďż˝"ci',         status: 'live' },
      { file: 'wiki/testy/testy_uwagi.md',      label: 'Testy uwagi',           status: 'live' },
      { file: 'wiki/testy/testy_jezyka.md',     label: 'Testy jďż˝"zykowe',        status: 'live' },
    ...
    psychometrics: [
      ...
      { file: 'wiki/psychometria/rzetelnosc.md',   label: 'Rzetelno9:ďż˝! pomiaru',      status: 'live' },
      { file: 'wiki/psychometria/trafnosc.md',     label: 'Trafno9:ďż˝! pomiaru',        status: 'live' },
      ...
      { file: 'wiki/psychometria/narzedzia_kliniczne.md', label: 'Narzďż˝"dzia kliniczne (PHQ-9, GAD-7, PCL-5)', status: 'live' },
    ],
    pharmacology: [
    ...
    individual_diffs: [
      { file: 'wiki/roznice_indywidualne/roznice_wprowadzenie.md', label: 'RB9=nice ind.', status: 'live' },
      { file: 'wiki/roznice_indywidualne/inteligencja.md',  label: 'Inteligencja',              status: 'live' },
      { file: 'wiki/roznice_indywidualne/osobowosc.md',     label: 'Osobowo9:ďż˝! (Wielka Piďż˝&tka)', status: 'live' },
      { file: 'wiki/roznice_indywidualne/kreatywnosc.md',   label: 'Kreatywno9:ďż˝!',              status: 'live' },
      ...
      { file: 'wiki/roznice_indywidualne/plec_psychologia.md', label: 'Psychologia p9ci',       status: 'live' },
    ...
    podstawy_pomocy: [
      ...
      { file: 'wiki/podstawy_pomocy/aktywne_sluchanie.md',             label: 'Aktywne s9uchanie',                   status: 'live' },
      ...
      { file: 'wiki/podstawy_pomocy/komunikacja_wspierajaca.md',       label: 'Komunikacja wspierajďż˝&ca',             status: 'live' },
      { file: 'wiki/podstawy_pomocy/wsparcie_spoleczne.md',            label: 'Wsparcie spo9eczne',                  status: 'live' },
      { file: 'wiki/podstawy_pomocy/samoopieka_pomagajacego.md',       label: 'Samoopieka pomagajďż˝&cego',             status: 'live' },
    ...
    temperament: [
      ...
      { file: 'wiki/temperament/rozwoj.md',                   label: 'Temperament, a rozwBj',               status: 'live' },
      ...
      { file: 'wiki/temperament/biologia_temperamentu.md',    label: 'Biologiczne pod9o9=e temperamentu',    status: 'live' },
    ...
    emotions: [
      ...
      { file: 'wiki/emocje/wspolczucie.md',  label: 'Empatia i wspB9czucie',   status: 'live' },
      ...
      { file: 'wiki/emocje/emocje_spoleczne.md',         label: 'Emocje spo9eczne i moralne',       status: 'live' },
    ],
    biology: [
      ...
      { file: 'wiki/biologia/mikrobiom.md',        label: 'O9: jelitaďż˝mBzg',            status: 'live' },
    ],
    psychotherapy: [
      ...
      { file: 'wiki/psychoterapia/skutecznosc.md', label: 'Skuteczno9:ďż˝! psychoterapii',    status: 'live' },
      ...
      { file: 'wiki/psychoterapia/trening_umiejetnosci_spolecznych.md', label: 'Trening Umiejďż˝"tno9:ci Spo9ecznych (SST)', status: 'live' },
      { file: 'wiki/psychoterapia/gestalt.md',     label: 'P9odna pustka (fertile void) - Gestalt', status: 'live' },
      ...
      { file: 'wiki/psychoterapia/psychologia_zimbardo.md', label: 'Psychologia spo9eczna (Zimbardo)',      status: 'live' },
    ...
    psychopathology: [
      ...
      { file: 'wiki/psychopatologia/objawy_ogolne.md',             label: 'Objawy ogBlne (MSE)',         status: 'live' },
      { file: 'wiki/psychopatologia/zaburzenia_lekowe.md',         label: 'Zaburzenia lďż˝"kowe',           status: 'live' },
      ...
      { file: 'wiki/psychopatologia/wyuczona_bezradnosc.md',        label: 'Wyuczona bezradno9:ďż˝!',         status: 'live' },
      ...
      { file: 'wiki/psychopatologia/formulowanie_przypadku.md',     label: 'Formu9owanie przypadku',        status: 'live' },
    ],
    suicidology: [
    ...
    sexology: [
      ...
      { file: 'wiki/seksuologia/wstyd_ciala_a_pozycje.md',   label: 'Wstyd cia9a,, a pozycje seksualne', status: 'live' },
      { file: 'wiki/seksuologia/orientacja.md',         label: 'Orientacja seksualna',      status: 'live' },
      { file: 'wiki/seksuologia/tozsamosc_plciowa.md',  label: 'To9=samo9:ďż˝! p9ciowa',         status: 'live' },
      { file: 'wiki/seksuologia/dysfunkcje.md',         label: 'Dysfunkcje seksualne',      status: 'live' },
      { file: 'wiki/seksuologia/hiperseksualnosc_mechanizm.md', label: 'Hiperseksualno9:ďż˝! jako mechanizm', status: 'live' },
      ...
      { file: 'wiki/seksuologia/przemoc_w_dziecinstwie_a_seksualnosc.md', label: 'Przemoc w dzieci9stwie, a seksualno9:ďż˝! doros9ych', status: 'live' },
      { file: 'wiki/seksuologia/dda_a_seksualnosc.md',    label: 'DDA,, a seksualno9:ďż˝! doros9ych', status: 'live' },
      { file: 'wiki/seksuologia/rozw_seksualny.md',     label: 'RozwBj seksualny',          status: 'live' },
    ...
    artetherapy: [
      ...
      { file: 'wiki/arteterapia/mechanizmy.md',    label: 'Mechanizmy dzia9ania',   status: 'live' },
    ...
    health_psychology: [
      ...
      { file: 'wiki/psychologia_zdrowia/model_biopsychospoleczny.md',label: 'Model biopsychospo9eczny',           status: 'live' },
      ...
      { file: 'wiki/psychologia_zdrowia/aktywnosc_fizyczna.md',      label: 'Aktywno9:ďż˝! fizyczna, a zdrowie psychiczne',       status: 'live' },
      { file: 'wiki/psychologia_zdrowia/dieta_zdrowie.md',           label: 'Dieta, a zdrowie psychiczne',         status: 'live' },
      { file: 'wiki/psychologia_zdrowia/bol.md',                     label: 'Psychologia bBlu',                   status: 'live' },
      { file: 'wiki/psychologia_zdrowia/bol_chroniczny.md',          label: 'BBl przewlek9y - zarzďż˝&dzanie',       status: 'live' },
      { file: 'wiki/psychologia_zdrowia/choroby_przewlekle.md',      label: 'Psychologia chorBb przewlek9ych',    status: 'live' },
      { file: 'wiki/psychologia_zdrowia/psychoonkologia.md',         label: 'Psychoonkologia',                    status: 'live' },
      { file: 'wiki/psychologia_zdrowia/choroby_ukladu_krazenia.md', label: 'Choroby uk9adu krďż˝&9=enia',            status: 'live' },
      { file: 'wiki/psychologia_zdrowia/cukrzyca.md',                label: 'Psychologia cukrzycy',               status: 'live' },
      { file: 'wiki/psychologia_zdrowia/jakosc_zycia.md',            label: 'Jako9:ďż˝! 9=ycia, a choroba',             status: 'live' },
      ...
      { file: 'wiki/psychologia_zdrowia/wsparcie_spoleczne.md',      label: 'Wsparcie spo9eczne, a zdrowie',       status: 'live' },
      { file: 'wiki/psychologia_zdrowia/adherencja.md',              label: 'Adherencja terapeutyczna',           status: 'live' },
      { file: 'wiki/psychologia_zdrowia/komunikacja_medyczna.md',    label: 'Komunikacja lekarzďż˝pacjent',         status: 'live' },
    ...
    psychosomatics: [
      ...
      { file: 'wiki/psychosomatyka/bol_psychosomatyczny.md',       label: 'BBl psychosomatyczny',               status: 'live' },
      ...
      { file: 'wiki/psychosomatyka/uklad_oddechowy.md',            label: 'Psychosomatyka uk9adu oddechowego',  status: 'live' },
    ...
    disability_psychology: [
      { file: 'wiki/psychologia_niepelnosprawnosci/wprowadzenie.md',                  label: 'Psychologia niepe9nosprawno9:ci - wprow.',       status: 'live' },
      { file: 'wiki/psychologia_niepelnosprawnosci/modele_niepelnosprawnosci.md',     label: 'Modele niepe9nosprawno9:ci',                     status: 'live' },
      { file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_intelektualna.md', label: 'Niepe9nosprawno9:ďż˝! intelektualna',             status: 'live' },
      { file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_ruchowa.md',     label: 'Niepe9nosprawno9:ďż˝! ruchowa',                     status: 'live' },
      { file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_wzrokowa.md',    label: 'Niepe9nosprawno9:ďż˝! wzrokowa',                    status: 'live' },
      { file: 'wiki/psychologia_niepelnosprawnosci/niepelnosprawnosc_sluchowa.md',    label: 'Niepe9nosprawno9:ďż˝! s9uchowa',                    status: 'live' },
      { file: 'wiki/psychologia_niepelnosprawnosci/autyzm_niepelnosprawnosc.md',      label: 'Spektrum autyzmu i niepe9nosprawno9:ďż˝!',          status: 'live' },
      { file: 'wiki/psychologia_niepelnosprawnosci/jakosc_zycia.md',                  label: 'Jako9:ďż˝! 9=ycia osBb z niepe9nosprawno9:ciďż˝&',       status: 'live' },
      ...
      { file: 'wiki/psychologia_niepelnosprawnosci/inkluzja_spoleczna.md',            label: 'Inkluzja spo9eczna i prawa',                   status: 'live' },
    ],
    intro: [
      ...
      { file: 'wiki/wstep_do_psychologii/nurty_psychologii.md',  label: 'G9Bwne nurty psychologii', status: 'live' },
    ...
    cases: [
      ...
      { file: 'wiki/przypadki_kliniczne/tan.md',           label: 'ďż˝~Tan" - afazja', status: 'live' },
      { file: 'wiki/przypadki_kliniczne/split_brain.md',   label: 'Rozdzielony mBzg', status: 'live' },
      ...
      { file: 'wiki/przypadki_kliniczne/sm.md',            label: 'Pacjentka S.M. (uszkodzenie cia9a migda9owatego)', status: 'live' },
    ],
    reference: [
      ...
      { file: 'wiki/reference/mapa_powiazan_nowe_artykuly.md', label: 'Mapa powiďż˝&za9 nowych artyku9Bw', status: 'live' },
    ],
    geropsychology: [
      { file: 'wiki/geropsychologia/wprowadzenie.md',               label: 'Psychologia staro9:ci',  status: 'live' },
      { file: 'wiki/geropsychologia/starzenie_poznawcze.md',        label: 'Starzenie siďż˝" poznawcze',              status: 'live' },
      { file: 'wiki/geropsychologia/demencja.md',                   label: 'Demencja i choroby neurodegeneracyjne',status: 'live' },
      { file: 'wiki/geropsychologia/depresja_starszych.md',         label: 'Depresja u osBb starszych',            status: 'live' },
      { file: 'wiki/geropsychologia/samotnosc.md',                  label: 'Samotno9:ďż˝! i izolacja spo9eczna',       status: 'live' },
      { file: 'wiki/geropsychologia/jakosc_zycia_starszych.md',     label: 'Jako9:ďż˝! 9=ycia w staro9:ci',              status: 'live' },
      { file: 'wiki/geropsychologia/aktywnosc_poznawcza.md',        label: 'Aktywno9:ďż˝! poznawcza i trening umys9u', status: 'live' },
      { file: 'wiki/geropsychologia/umieranie_smierc.md',           label: 'Psychologia umierania i 9:mierci',      status: 'live' },
      { file: 'wiki/geropsychologia/relacje_spoleczne_starszych.md',label: 'Relacje spo9eczne i wsparcie rodziny', status: 'live' },
      ...
      { file: 'wiki/geropsychologia/opieka_nad_opiekunami.md',      label: 'Wypalenie i wsparcie opiekunBw',       status: 'live' },
    ],
    game_psychology: [
      ...
      { file: 'wiki/psychologia_gier/flow_i_immersja.md',      label: 'Przep9yw (flow) i immersja',            status: 'live' },
      { file: 'wiki/psychologia_gier/gry_spolecznosciowe.md',  label: 'Gry wieloosobowe i aspekty spo9eczne',  status: 'live' },
      ...
      { file: 'wiki/psychologia_gier/gender_w_grach.md',       label: 'P9eďż˝! i to9=samo9:ďż˝! w grach',              status: 'live' },
    ...
    resilience_mobbing: [
      { file: 'wiki/rezyliencja_i_mobbing/odpornosc_wprowadzenie.md',  label: 'Odporno9:ďż˝! psychiczna',      status: 'live' },
    ...
    media_nature: [
      { file: 'wiki/ekrany_ksiazki_i_natura/wprowadzenie.md',             label: 'Ekrany, ksiďż˝&9=ki i natura',                    status: 'live' },
      ...
      { file: 'wiki/ekrany_ksiazki_i_natura/tablety_dzieci.md',           label: 'Tablety, a rozwBj poznawczy dzieci',          status: 'live' },
      ...
      { file: 'wiki/ekrany_ksiazki_i_natura/czytanie_ksiazek.md',         label: 'Czytanie ksiďż˝&9=ek, a funkcje psychiczne',      status: 'live' },
      { file: 'wiki/ekrany_ksiazki_i_natura/gleboke_czytanie.md',         label: 'G9ďż˝"bokie czytanie',                           status: 'live' },
      ...
      { file: 'wiki/ekrany_ksiazki_i_natura/las_shinrin_yoku.md',         label: 'Kďż˝&piel le9:na - shinrin-yoku',                 status: 'live' },
      { file: 'wiki/ekrany_ksiazki_i_natura/gory_psychologia.md',         label: 'GBry i wďż˝"drBwki gBrskie, a psychologia',      status: 'live' },
    ],
    ...
    positive_psychology: [
      ...
      { file: 'wiki/psychologia_pozytywna/szczescie_dobrostan.md',    label: 'Szczďż˝"9:cie i dobrostan psychiczny',       status: 'live' },
      ...
      { file: 'wiki/psychologia_pozytywna/przeplyw_flow.md',          label: 'Przep9yw (flow)',                        status: 'live' },
      { file: 'wiki/psychologia_pozytywna/sily_charakteru.md',        label: 'Si9y charakteru (VIA)',                  status: 'live' },
      { file: 'wiki/psychologia_pozytywna/wdziecznosc.md',            label: 'Wdziďż˝"czno9:ďż˝!',                            status: 'live' },
      { file: 'wiki/psychologia_pozytywna/mindfulness.md',            label: 'Mindfulness i uwa9=no9:ďż˝!',                 status: 'live' },
      { file: 'wiki/psychologia_pozytywna/wspolczucie_dla_siebie.md', label: 'WspB9czucie dla siebie',                 status: 'live' },
      { file: 'wiki/psychologia_pozytywna/sens_i_cel.md',             label: 'Sens 9=ycia i poczucie celu',             status: 'live' },
      { file: 'wiki/psychologia_pozytywna/relacje_pozytywne.md',      label: 'Pozytywne relacje i mi9o9:ďż˝!',             status: 'live' },
    ...
    ai_psychology: [
      ...
      { file: 'wiki/psychologia_ai/czlowiek_a_ai.md',         label: 'Interakcja cz9owiek-AI',                    status: 'live' },
      { file: 'wiki/psychologia_ai/zaufanie_do_ai.md',        label: 'Zaufanie do sztucznej inteligencji',        status: 'live' },
      { file: 'wiki/psychologia_ai/uprzedzenia_ai.md',        label: 'Uprzedzenia i b9ďż˝"dy poznawcze w AI',        status: 'live' },
      ...
      { file: 'wiki/psychologia_ai/ai_poznawcze.md',          label: 'Poznawcze aspekty dzia9ania AI',            status: 'live' },
      { file: 'wiki/psychologia_ai/antropomorfizacja_ai.md',  label: 'Antropomorfizacja AI',                      status: 'live' },
      { file: 'wiki/psychologia_ai/przyszlosc_ai.md',         label: 'Przysz9o9:ďż˝! relacji cz9owiek-AI',            status: 'live' },
    ],
    technology_psychology: [
      { file: 'wiki/psychologia_technologii/technostres.md',            label: 'Technostres - artyku9 naukowy',                      status: 'live' },
      { file: 'wiki/psychologia_technologii/zmeczenie_cyfrowe.md',      label: 'Zmďż˝"czenie cyfrowe i przeciďż˝&9=enie informacyjne',      status: 'live' },
      ...
      { file: 'wiki/psychologia_technologii/higiena_cyfrowa.md',        label: 'Higiena cyfrowa i profilaktyka przeciďż˝&9=enia',        status: 'live' },
      ...
      { file: 'wiki/psychologia_technologii/psychoedukacja_rodzinna.md',label: 'Psychoedukacja rodzinna w erze ekranBw',             status: 'live' },
    ],
    affective_robotics: [
      ...
      { file: 'wiki/robotyka_afektywna/roboty_spoleczne.md',                label: 'Roboty spo9eczne i HRI',                    status: 'live' },
      { file: 'wiki/robotyka_afektywna/kognitywistyka_obliczeniowa.md',     label: 'Kognitywistyka obliczeniowa',               status: 'live' },
      { file: 'wiki/robotyka_afektywna/percepcja_robotow.md',               label: 'Percepcja i ocena robotBw przez ludzi',     status: 'live' },
      { file: 'wiki/robotyka_afektywna/roboty_w_opiece.md',                 label: 'Roboty w opiece i terapii',                 status: 'live' },
      { file: 'wiki/robotyka_afektywna/swiadomosc_maszyn.md',               label: '9awiadomo9:ďż˝! i podmiotowo9:ďż˝! maszyn',          status: 'live' },
      { file: 'wiki/robotyka_afektywna/wspolpraca_czlowiek_robot.md',       label: 'WspB9praca cz9owiekďż˝robot (HRC)',           status: 'live' },
      { file: 'wiki/robotyka_afektywna/interfejsy_mozg_maszyna.md',         label: 'Interfejsy mBzgďż˝maszyna (BCI)',             status: 'live' },
      { file: 'wiki/robotyka_afektywna/przyszlosc_robotyki_afektywnej.md',  label: 'Przysz9o9:ďż˝! robotyki afektywnej',            status: 'live' },
    ],
    school_psychology: [
      { file: 'wiki/psychologia_szkolna/wprowadzenie.md',                 label: 'Psychologia szkolna',                       status: 'live' },
      { file: 'wiki/psychologia_szkolna/teorie_uczenia_sie.md',           label: 'Teorie uczenia siďż˝"',                        status: 'live' },
      ...
      { file: 'wiki/psychologia_szkolna/trudnosci_w_uczeniu_sie.md',      label: 'Trudno9:ci w uczeniu siďż˝"',                   status: 'live' },
      { file: 'wiki/psychologia_szkolna/adhd_w_szkole.md',                label: 'ADHD w 9:rodowisku szkolnym',                status: 'live' },
      { file: 'wiki/psychologia_szkolna/relacje_nauczyciel_uczen.md',     label: 'Relacje nauczycielďż˝ucze9',                  status: 'live' },
      ...
      { file: 'wiki/psychologia_szkolna/stres_szkolny.md',                label: 'Stres szkolny i lďż˝"k egzaminacyjny',         status: 'live' },
      { file: 'wiki/psychologia_szkolna/interwencje_szkolne.md',          label: 'Interwencje psychologiczne w szkole',       status: 'live' },
    ],
    neurodiversity: [
      { file: 'wiki/neuroroznorodnosc/wprowadzenie.md',               label: 'NeurorB9=norodno9:ďż˝!',    status: 'live' },
      { file: 'wiki/neuroroznorodnosc/adhd.md',                       label: 'ADHD jako wariant neurorB9=norodno9:ci', status: 'live' },
      ...
      { file: 'wiki/neuroroznorodnosc/hiperleksja.md',                label: 'Hiperleksja i wyjďż˝&tkowe zdolno9:ci',    status: 'live' },
      ...
      { file: 'wiki/neuroroznorodnosc/neurozroznorodnosc_w_pracy.md', label: 'NeurorB9=norodno9:ďż˝! w miejscu pracy',    status: 'live' },
      { file: 'wiki/neuroroznorodnosc/identyfikacja_i_diagnoza.md',   label: 'Identyfikacja i diagnoza',             status: 'live' },
    ],
    forensic_psychology: [
      { file: 'wiki/psychologia_sadowa/wprowadzenie.md',            label: 'Bieg9y psycholog',       status: 'live' },
      { file: 'wiki/psychologia_sadowa/rola_bieglego.md',           label: 'Rola i status bieg9ego',                status: 'live' },
      { file: 'wiki/psychologia_sadowa/podstawy_prawne.md',         label: 'Podstawy prawne opiniowania',           status: 'live' },
      { file: 'wiki/psychologia_sadowa/metodologia_opinii.md',      label: 'Metodologia sporzďż˝&dzania opinii',       status: 'live' },
      ...
      { file: 'wiki/psychologia_sadowa/narzedzia_diagnostyczne.md', label: 'Narzďż˝"dzia diagnostyczne (sďż˝&dowe)',      status: 'live' },
      { file: 'wiki/psychologia_sadowa/etyka_opiniowania.md',       label: 'Etyka opiniowania sďż˝&dowego',            status: 'live' },
      { file: 'wiki/psychologia_sadowa/opiniowanie_nieletnich.md',  label: 'Opiniowanie nieletnich i dzieci',       status: 'live' },
      { file: 'wiki/psychologia_sadowa/biegly_a_sad.md',            label: 'Bieg9y, a sďż˝&d - komunikacja',           status: 'live' },
    ],
    e_therapy: [
      ...
      { file: 'wiki/e_terapia/platformy_e_terapii.md',            label: 'Platformy i narzďż˝"dzia e-terapii',        status: 'live' },
      { file: 'wiki/e_terapia/skutecznosc_e_terapii.md',          label: 'Skuteczno9:ďż˝! e-terapii',                  status: 'live' },
      ...
      { file: 'wiki/e_terapia/vr_terapia.md',                     label: 'Wirtualna rzeczywisto9:ďż˝! w terapii',      status: 'live' },
      { file: 'wiki/e_terapia/e_terapia_dzieci.md',               label: 'E-terapia dzieci i m9odzie9=y',           status: 'live' },
      { file: 'wiki/e_terapia/dostepnosc_cyfrowa.md',             label: 'Dostďż˝"pno9:ďż˝! i wykluczenie cyfrowe',       status: 'live' },
      { file: 'wiki/e_terapia/przyszlosc_e_terapii.md',           label: 'Przysz9o9:ďż˝! e-terapii',                   status: 'live' },
    ],
    philosophy: [
      ...
      { file: 'wiki/filozofia/filozofia_umyslu.md',    label: 'Filozofia umys9u',                status: 'live' },
      ...
      { file: 'wiki/filozofia/filozofia_jezyka.md',    label: 'Filozofia jďż˝"zyka',                status: 'live' },
      { file: 'wiki/filozofia/filozofia_czlowieka.md',       label: 'Filozofia cz9owieka',                        status: 'live' },
      { file: 'wiki/filozofia/cien_antropiczny.md',          label: 'Cie9 antropiczny',                           status: 'live' },
      { file: 'wiki/filozofia/mozg_boltzmanna.md',           label: 'MBzg Boltzmanna',                            status: 'live' },
      ...
      { file: 'wiki/filozofia/asymetria_dobra_i_bolu.md',    label: 'Asymetria dobra i bBlu',                     status: 'live' },
      { file: 'wiki/filozofia/niemoralnosc_braku_zgody.md',  label: 'Niemoralno9:ďż˝! braku zgody na narodziny',      status: 'live' },
    ...
    nvc: [
      ...
      { file: 'wiki/porozumiewanie_sie_bez_przemocy/prosba_i_zadanie.md',        label: 'Pro9:ba, a 9=ďż˝&danie',                     status: 'live' },
      { file: 'wiki/porozumiewanie_sie_bez_przemocy/empatia_nvc.md',             label: 'Empatia w NVC',                         status: 'live' },
      { file: 'wiki/porozumiewanie_sie_bez_przemocy/jezyk_szakala_i_zyrafy.md',  label: 'Jďż˝"zyk szakala i 9=yrafy',                status: 'live' },
      { file: 'wiki/porozumiewanie_sie_bez_przemocy/autoempatia.md',             label: 'Autoempatia i samowspB9czucie',         status: 'live' },
      { file: 'wiki/porozumiewanie_sie_bez_przemocy/nvc_w_konfliktach.md',       label: 'NVC w rozwiďż˝&zywaniu konfliktBw',        status: 'live' },
    ...
    ppd: [
      ...
      { file: 'wiki/seminarium_dyplomowe/przeglad_literatury.md',    label: 'Przeglďż˝&d literatury naukowej',          status: 'live' },
      { file: 'wiki/seminarium_dyplomowe/metodologia_badan.md',      label: 'Metodologia bada9 psychologicznych',    status: 'live' },
      { file: 'wiki/seminarium_dyplomowe/pomiary_psychologiczne.md', label: 'Zasady prowadzenia pomiarBw',           status: 'live' },
      { file: 'wiki/seminarium_dyplomowe/narzedzia_badawcze.md',     label: 'Narzďż˝"dzia badawcze i kwestionariusze',  status: 'live' },
      ...
      { file: 'wiki/seminarium_dyplomowe/bledy_badawcze.md',         label: 'B9ďż˝"dy badawcze - czego unikaďż˝!',        status: 'live' },
      { file: 'wiki/seminarium_dyplomowe/opis_wynikow.md',           label: 'Pisanie i interpretacja wynikBw',      status: 'live' },
    ...
    kulturowa: [
      ...
      { file: 'wiki/kulturowa/indywidualizm_kolektywizm.md',     label: 'Wymiar indywidualizmďż˝kolektywizm',     status: 'live' },
      ...
      { file: 'wiki/kulturowa/kultura_jezyk.md',        label: 'Kultura, a jďż˝"zyk (Sapir-Whorf)',      status: 'live' },
      { file: 'wiki/kulturowa/kultura_osobowosc.md',    label: 'Kultura, a osobowo9:ďż˝!',                status: 'live' },
    ...
    uzaleznienia: [
      ...
      { file: 'wiki/uzaleznienia/dialog_motywujacy.md',          label: 'Dialog motywujďż˝&cy',                  status: 'live' },
      { file: 'wiki/uzaleznienia/zapobieganie_nawrotom.md',      label: 'Zapobieganie nawrotom',              status: 'live' },
      { file: 'wiki/uzaleznienia/uzaleznienia_mlodziezy.md',     label: 'Uzale9=nienia u m9odzie9=y',           status: 'live' },
      { file: 'wiki/uzaleznienia/wspoluzaleznienie.md',          label: 'WspB9uzale9=nienie',                  status: 'live' },
    ...
    relacje: [
      { file: 'wiki/relacje/przywiezanie_doroslych.md',          label: 'Style przywiďż˝&zania u doros9ych',     status: 'live' },
      { file: 'wiki/relacje/trojkatna_teoria_milosci.md',        label: 'Triangularna teoria mi9o9:ci',        status: 'live' },
      { file: 'wiki/relacje/dobor_partnera.md',                  label: 'DobBr partnera',                     status: 'live' },
      { file: 'wiki/relacje/komunikacja_para.md',                label: 'Komunikacja w parze',                status: 'live' },
      { file: 'wiki/relacje/konflikty.md',                       label: 'Konflikty i ich rozwiďż˝&zywanie',      status: 'live' },
      ...
      { file: 'wiki/relacje/przemoc_zwiazki.md',                 label: 'Przemoc w zwiďż˝&zkach',                status: 'live' },
      { file: 'wiki/relacje/samotnosc.md',                       label: 'Samotno9:ďż˝! i izolacja spo9eczna',     status: 'live' },
      { file: 'wiki/relacje/przyjaznie.md',                      label: 'Przyja9_9',                           status: 'live' },
      { file: 'wiki/relacje/rozstanie.md',                       label: 'Rozpad zwiďż˝&zku i 9=a9oba relacyjna',  status: 'live' },
      { file: 'wiki/relacje/relacje_rodzinne.md',                label: 'Relacje rodzinne - dynamika',        status: 'live' },
    ],
    etyka: [
      { file: 'wiki/etyka/kodeksy_etyczne.md',                   label: 'Kodeksy etyczne - przeglďż˝&d',         status: 'live' },
      ...
      { file: 'wiki/etyka/superwizja_odpowiedzialnosc.md',       label: 'Superwizja i odpowiedzialno9:ďż˝!',      status: 'live' },
      ...
      { file: 'wiki/etyka/odpowiedzialnosc_zawodowa.md', label: 'Odpowiedzialno9:ďż˝! zawodowa',            status: 'live' },
    ],
    diagnoza: [
      ...
      { file: 'wiki/diagnoza/formulowanie_przypadku.md',         label: 'Formu9owanie przypadku',             status: 'live' },
    ...
    rozwojowa: [
      { file: 'wiki/rozwojowa/teorie_rozwoju.md',                label: 'G9Bwne teorie rozwoju',                   status: 'live' },
      { file: 'wiki/rozwojowa/metody_podluzne.md',               label: 'Metody bada9 pod9u9=nych',                 status: 'live' },
      { file: 'wiki/rozwojowa/niemowlectwo.md',                  label: 'Niemowlďż˝"ctwo i wczesne dzieci9stwo',      status: 'live' },
      ...
      { file: 'wiki/rozwojowa/doroslosc.md',                     label: 'Doros9o9:ďż˝! i starzenie siďż˝"',               status: 'live' },
      { file: 'wiki/rozwojowa/plastycznosc_mozgu.md',            label: 'Plastyczno9:ďż˝! mBzgu, a okresy krytyczne',  status: 'live' },
      { file: 'wiki/rozwojowa/przywiazanie.md',                  label: 'Teoria przywiďż˝&zania',                     status: 'live' },
      { file: 'wiki/rozwojowa/rozwoj_jezyka.md',                 label: 'RozwBj jďż˝"zyka i komunikacji',             status: 'live' },
      ...
      { file: 'wiki/rozwojowa/tozsamosc.md',                     label: 'Kszta9towanie to9=samo9:ci',                status: 'live' },
    ],
    eksperyment_psychologiczny: [
      ...
      { file: 'wiki/eksperyment_psychologiczny/proby_i_rekrutacja.md',         label: 'DobBr prBby i rekrutacja',                 status: 'live' },
      ...
      { file: 'wiki/eksperyment_psychologiczny/protokol_i_pilotaz.md',         label: 'ProtokB9 badania i pilota9=',               status: 'live' },
      { file: 'wiki/eksperyment_psychologiczny/prowadzenie_eksperymentu.md',   label: 'Prowadzenie sesji eksperymentalnej',       status: 'live' },
      { file: 'wiki/eksperyment_psychologiczny/jakosc_danych.md',              label: 'Kontrola jako9:ci i zarzďż˝&dzanie danymi',    status: 'live' },
      ...
      { file: 'wiki/eksperyment_psychologiczny/raportowanie_wynikow.md',       label: 'Raportowanie wynikBw i ogranicze9',        status: 'live' },
    ],
  },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'P9aty kory mBzgowej', id: 'neuro/anatomia', status: 'live' },
            { label: 'Uk9ad limbiczny', id: 'neuro/uklad_limbiczny', status: 'live', desc: 'Hipokamp, cia9o migda9owate, zakrďż˝"t obrďż˝"czy.' },
            { label: 'Neuron i synapsa', id: 'neuro/neuron', status: 'live', desc: 'Budowa neuronu, potencja9 czynno9:ciowy, LTP/LTD.' },
            { label: 'Uk9ady i sieci mBzgowe', id: 'neuro/systemy', status: 'live' },
            { label: 'Mielinizacja i istota bia9a', id: 'neuro/myelinizacja', status: 'live', desc: 'Pďż˝"czek 9ukowaty, cia9o modzelowate, szlaki piramidowe.' },
            { label: 'Neuroplastyczno9:ďż˝!', id: 'neuro/plastycznosc', status: 'live' },
            ...
            { label: 'Zachowanie i dwie pB9kule mBzgu', id: 'neuro/zachowanie_i_dwie_polkule_mozgu', status: 'live' },
            { label: 'Kora przedczo9owa', id: 'neuro/kora_prefrontalna', status: 'live' },
            { label: 'Neurobiologia przesilenia wiosennego', id: 'neuro/przesilenie_wiosenne', status: 'live' },
            { label: 'Neuropsychologia cyklu miesiďż˝&czkowego', id: 'neuro/cykl_miesiaczkowy', status: 'live', desc: 'Wp9yw estradiolu i progesteronu na poznanie, nastrBj i mBzg.' },
            ...
            { label: 'Pie9 mBzgu i mB9=d9=ek', id: 'neuro/pien_mozgu', status: 'live', desc: 'Struktury podkorowe i ich funkcje kliniczne.' },
          ]
        },
        {
          title: 'Syndromologia',
          articles: [
            ...
            { label: 'Amnezje - typy i pod9o9=e', id: 'zaburzenia/amnezje', status: 'live' },
            ...
            { label: 'Urazy g9owy (TBI)', id: 'zaburzenia/tbi', status: 'live' },
            { label: 'Otďż˝"pienia', id: 'zaburzenia/otepienia', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Testy pamiďż˝"ci', id: 'testy/testy_pamieci', status: 'live' },
            { label: 'Testy uwagi', id: 'testy/testy_uwagi', status: 'live' },
            { label: 'Testy jďż˝"zykowe', id: 'testy/testy_jezyka', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'ďż˝~Tan" - afazja Broki', id: 'przypadki_kliniczne/tan', status: 'live' },
            { label: 'Rozdzielony mBzg', id: 'przypadki_kliniczne/split_brain', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'G9Bwne nurty psychologii', id: 'wstep_do_psychologii/nurty_psychologii', status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Psychopatologia ogBlna', id: 'psychopatologia/psychopatologia_wprowadzenie', status: 'live' },
            ...
            { label: 'Formu9owanie przypadku', id: 'psychopatologia/formulowanie_przypadku', status: 'live' },
          ]
        },
        {
          title: 'Zaburzenia kliniczne',
          articles: [
            { label: 'Zaburzenia lďż˝"kowe', id: 'psychopatologia/zaburzenia_lekowe', status: 'live' },
            ...
            { label: 'Wyuczona bezradno9:ďż˝!', id: 'psychopatologia/wyuczona_bezradnosc', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Skuteczno9:ďż˝! psychoterapii', id: 'psychoterapia/skutecznosc', status: 'live' },
            { label: 'Sojusz terapeutyczny', id: 'psychoterapia/sojusz', status: 'live' },
            { label: 'Trening Umiejďż˝"tno9:ci Spo9ecznych (SST)', id: 'psychoterapia/trening_umiejetnosci_spolecznych', status: 'live' },
            { label: 'P9odna pustka (fertile void) - Gestalt', id: 'psychoterapia/gestalt', status: 'live' },
            ...
            { label: 'Psychologia spo9eczna (Zimbardo)', id: 'psychoterapia/psychologia_zimbardo', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Narzďż˝"dzia kliniczne (PHQ-9, GAD-7, PCL-5)', id: 'psychometria/narzedzia_kliniczne', status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Pamiďż˝"ďż˝!', id: 'poznawcza/pamiec', status: 'live' },
            { label: 'Pamiďż˝"ďż˝! d9ugotrwa9a', id: 'poznawcza/pamiec_dlugotrwala', status: 'live' },
            { label: 'Uwaga', id: 'poznawcza/uwaga', status: 'live' },
            { label: 'Percepcja i gnozja', id: 'poznawcza/percepcja', status: 'live' },
            { label: 'Jďż˝"zyk', id: 'poznawcza/jezyk', status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Dylemat eksploracjaďż˝eksploatacja', id: 'poznawcza/exploration_exploitation_dilemma', status: 'live' },
            ...
            { label: '9awiadomo9:ďż˝! i metapoznanie', id: 'poznawcza/swiadomosc', status: 'live' },
            { label: 'Uczenie siďż˝"', id: 'poznawcza/uczenie', status: 'live' },
            { label: 'Wyobra9_nia i reprezentacje', id: 'poznawcza/wyobraznia', status: 'live' },
            { label: 'Zmďż˝"czenie poznawcze', id: 'poznawcza/zmeczenie_poznawcze', status: 'live' },
            { label: 'Iluzje i b9ďż˝"dy poznawcze', id: 'poznawcza/iluzje', status: 'live' },
            { label: 'Test Stroopa', id: 'poznawcza/test_stroopa', status: 'live' },
            { label: 'Przyk9ad testu Stroopa', id: 'poznawcza/przyklad_testu_stroopa', status: 'live' },
            { label: 'Eksperyment Posnera', id: 'poznawcza/eksperyment_posnera', status: 'live' },
            { label: 'Eksperyment Ma9ego Alberta', id: 'poznawcza/maly_albert', status: 'live' },
            { label: 'Uk9ad siatkowaty (ARAS)', id: 'poznawcza/uklad_siatkowaty', status: 'live' },
          ]
        },
        {
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Percepcja spo9eczna i atrybucje', id: 'spoleczna/percepcja_spoleczna', status: 'live' },
            { label: 'Stereotypy i uprzedzenia', id: 'spoleczna/stereotypy', status: 'live' },
            { label: 'Manosfera i feminizm - ujďż˝"cie psychologiczne', id: 'spoleczna/manosfera_feminizm', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Stanfordzki Eksperyment Wiďż˝"zienny', id: 'spoleczna/eksperyment_wiezienny', status: 'live' },
            { label: 'Manipulacja - mechanizmy i metody wp9ywu', id: 'spoleczna/manipulacja', status: 'live' },
            { label: 'Konformizm i pos9usze9stwo', id: 'spoleczna/konformizm', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Atrakcyjno9:ďż˝! interpersonalna', id: 'spoleczna/atrakcyjnosc', status: 'live' },
            { label: 'Agresja', id: 'spoleczna/agresja', status: 'live' },
            { label: 'Hejt w sieci', id: 'spoleczna/hejt_w_sieci', status: 'live' },
            { label: 'Zachowania prospo9eczne', id: 'spoleczna/zachowania_prospoleczne', status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Wymiar indywidualizmďż˝kolektywizm', id: 'kulturowa/indywidualizm_kolektywizm', status: 'live' },
          ]
        },
        {
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Kultura, a jďż˝"zyk (Sapir-Whorf)',     id: 'kulturowa/kultura_jezyk',       status: 'live' },
            { label: 'Kultura, a osobowo9:ďż˝!',               id: 'kulturowa/kultura_osobowosc',   status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Empatia i wspB9czucie', id: 'emocje/wspolczucie', status: 'live' },
            ...
            { label: 'Emocje spo9eczne i moralne', id: 'emocje/emocje_spoleczne', status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          title: 'Fundamenty',
          articles: [
            { label: 'G9Bwne teorie rozwoju', id: 'rozwojowa/teorie_rozwoju', status: 'live' },
            { label: 'Metody bada9 pod9u9=nych', id: 'rozwojowa/metody_podluzne', status: 'live' },
          ]
        },
        {
          title: 'Etapy 9=ycia',
          articles: [
            { label: 'Niemowlďż˝"ctwo i wczesne dzieci9stwo', id: 'rozwojowa/niemowlectwo', status: 'live' },
            { label: 'Wiek szkolny', id: 'rozwojowa/wiek_szkolny', status: 'live' },
            { label: 'Adolescencja', id: 'rozwojowa/adolescencja', status: 'live' },
            { label: 'Doros9o9:ďż˝! i starzenie siďż˝"', id: 'rozwojowa/doroslosc', status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Plastyczno9:ďż˝! mBzgu, a okresy krytyczne', id: 'rozwojowa/plastycznosc_mozgu', status: 'live' },
          ]
        },
        {
          title: 'Relacje i 9:rodowisko',
          articles: [
            { label: 'Teoria przywiďż˝&zania', id: 'rozwojowa/przywiazanie', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'RozwBj jďż˝"zyka i komunikacji', id: 'rozwojowa/rozwoj_jezyka', status: 'live' },
            { label: 'Kszta9towanie to9=samo9:ci', id: 'rozwojowa/tozsamosc', status: 'live' },
          ]
        },
      ]
    },
    ...
    uzaleznienia: {
      ...
      sections: [
        ...
        },
        {
          title: 'Terapia',
          articles: [
            { label: 'Dialog motywujďż˝&cy', id: 'uzaleznienia/dialog_motywujacy', status: 'live' },
        ...
        },
        {
          title: 'Konteksty',
          articles: [
            { label: 'Uzale9=nienia u m9odzie9=y', id: 'uzaleznienia/uzaleznienia_mlodziezy', status: 'live' },
            { label: 'WspB9uzale9=nienie', id: 'uzaleznienia/wspoluzaleznienie', status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy',
          articles: [
            { label: 'Style przywiďż˝&zania u doros9ych', id: 'relacje/przywiezanie_doroslych', status: 'live' },
            { label: 'Triangularna teoria mi9o9:ci', id: 'relacje/trojkatna_teoria_milosci', status: 'live' },
            { label: 'DobBr partnera', id: 'relacje/dobor_partnera', status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Konflikty i ich rozwiďż˝&zywanie', id: 'relacje/konflikty', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Przemoc w zwiďż˝&zkach', id: 'relacje/przemoc_zwiazki', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Wstyd cia9a, a pozycje seksualne', id: 'seksuologia/wstyd_ciala_a_pozycje', status: 'live' },
            { label: 'Orientacja seksualna', id: 'seksuologia/orientacja', status: 'live' },
            { label: 'To9=samo9:ďż˝! p9ciowa', id: 'seksuologia/tozsamosc_plciowa', status: 'live' },
            { label: 'Dysfunkcje seksualne', id: 'seksuologia/dysfunkcje', status: 'live' },
            { label: 'Hiperseksualno9:ďż˝! jako mechanizm', id: 'seksuologia/hiperseksualnosc_mechanizm', status: 'live' },
            ...
            { label: 'Przemoc w dzieci9stwie, a seksualno9:ďż˝! doros9ych', id: 'seksuologia/przemoc_w_dziecinstwie_a_seksualnosc', status: 'live' },
            { label: 'DDA, a seksualno9:ďż˝! doros9ych', id: 'seksuologia/dda_a_seksualnosc', status: 'live' },
            { label: 'RozwBj seksualny', id: 'seksuologia/rozw_seksualny', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Samotno9:ďż˝! i izolacja spo9eczna',    id: 'relacje/samotnosc',        status: 'live' },
            { label: 'Przyja9_9',                          id: 'relacje/przyjaznie',        status: 'live' },
            { label: 'Rozpad zwiďż˝&zku i 9=a9oba relacyjna', id: 'relacje/rozstanie',         status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Formu9owanie przypadku', id: 'diagnoza/formulowanie_przypadku', status: 'live' },
          ]
        },
        {
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Rzetelno9:ďż˝! pomiaru', id: 'psychometria/rzetelnosc', status: 'live' },
            { label: 'Trafno9:ďż˝! pomiaru', id: 'psychometria/trafnosc', status: 'live' },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Mikrobiom, a mBzg', id: 'biology/mikrobiom', status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Wprowadzenie - rB9=nice indywidualne', id: 'roznice_indywidualne/roznice_wprowadzenie', status: 'live' },
            { label: 'Inteligencja', id: 'roznice_indywidualne/inteligencja', status: 'live' },
            { label: 'Osobowo9:ďż˝! - modele', id: 'roznice_indywidualne/osobowosc', status: 'live' },
            { label: 'Kreatywno9:ďż˝!', id: 'roznice_indywidualne/kreatywnosc', status: 'live' },
            ...
            { label: 'Psychologia p9ci', id: 'roznice_indywidualne/plec_psychologia', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'RozwBj temperamentu',                id: 'temperament/rozwoj',                   status: 'live' },
            ...
            { label: 'Biologiczne pod9o9=e temperamentu',   id: 'temperament/biologia_temperamentu',    status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Kodeksy etyczne - przeglďż˝&d', id: 'etyka/kodeksy_etyczne', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Superwizja i odpowiedzialno9:ďż˝!', id: 'etyka/superwizja_odpowiedzialnosc', status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Odpowiedzialno9:ďż˝! zawodowa',          id: 'etyka/odpowiedzialnosc_zawodowa', status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Model biopsychospo9eczny',            id: 'psychologia_zdrowia/model_biopsychospoleczny', status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Wsparcie spo9eczne, a zdrowie', id: 'psychologia_zdrowia/wsparcie_spoleczne',  status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Aktywno9:ďż˝! fizyczna,, a zdrowie psychiczne',   id: 'psychologia_zdrowia/aktywnosc_fizyczna',   status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Psychologia bBlu',                 id: 'psychologia_zdrowia/bol',                    status: 'live' },
            { label: 'Radzenie sobie z przewlek9ym bBlem',     id: 'psychologia_zdrowia/bol_chroniczny',         status: 'live' },
            { label: 'Psychologia chorBb przewlek9ych',  id: 'psychologia_zdrowia/choroby_przewlekle',     status: 'live' },
            { label: 'Psychoonkologia',                  id: 'psychologia_zdrowia/psychoonkologia',        status: 'live' },
            { label: 'Choroby uk9adu krďż˝&9=enia',          id: 'psychologia_zdrowia/choroby_ukladu_krazenia', status: 'live' },
            { label: 'Psychologia cukrzycy',             id: 'psychologia_zdrowia/cukrzyca',               status: 'live' },
            { label: 'Jako9:ďż˝! 9=ycia, a choroba',           id: 'psychologia_zdrowia/jakosc_zycia',           status: 'live' },
          ]
        },
        {
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Komunikacja lekarzďż˝pacjent',    id: 'psychologia_zdrowia/komunikacja_medyczna',  status: 'live' },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'BBl psychosomatyczny',            id: 'psychosomatyka/bol_psychosomatyczny',    status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Psychosomatyka uk9adu oddechowego', id: 'psychosomatyka/uklad_oddechowy',       status: 'live' },
      ...
      sections: [
        {
          title: 'Podstawy',
          articles: [
            { label: 'Psychologia niepe9nosprawno9:ci', id: 'psychologia_niepelnosprawnosci/wprowadzenie', status: 'live' },
            { label: 'Modele niepe9nosprawno9:ci',                     id: 'psychologia_niepelnosprawnosci/modele_niepelnosprawnosci', status: 'live' },
          ]
        },
        {
          title: 'Rodzaje niepe9nosprawno9:ci',
          articles: [
            { label: 'Niepe9nosprawno9:ďż˝! intelektualna',  id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_intelektualna', status: 'live' },
            { label: 'Niepe9nosprawno9:ďż˝! ruchowa',        id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_ruchowa', status: 'live' },
            { label: 'Niepe9nosprawno9:ďż˝! wzrokowa',       id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_wzrokowa', status: 'live' },
            { label: 'Niepe9nosprawno9:ďż˝! s9uchowa',       id: 'psychologia_niepelnosprawnosci/niepelnosprawnosc_sluchowa', status: 'live' },
            { label: 'Spektrum autyzmu i niepe9nosprawno9:ďż˝!', id: 'psychologia_niepelnosprawnosci/autyzm_niepelnosprawnosc', status: 'live' },
          ]
        },
        {
          title: 'Funkcjonowanie psychiczne',
          articles: [
            { label: 'Jako9:ďż˝! 9=ycia osBb z niepe9nosprawno9:ciďż˝&', id: 'psychologia_niepelnosprawnosci/jakosc_zycia', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Inkluzja spo9eczna i prawa',         id: 'psychologia_niepelnosprawnosci/inkluzja_spoleczna', status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Starzenie siďż˝" poznawcze',               id: 'geropsychologia/starzenie_poznawcze',    status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Depresja u osBb starszych',             id: 'geropsychologia/depresja_starszych',     status: 'live' },
          ]
        },
        {
          title: 'Funkcjonowanie spo9eczne i jako9:ďż˝! 9=ycia',
          articles: [
            { label: 'Samotno9:ďż˝! i izolacja spo9eczna',        id: 'geropsychologia/samotnosc',              status: 'live' },
            { label: 'Jako9:ďż˝! 9=ycia w staro9:ci',               id: 'geropsychologia/jakosc_zycia_starszych', status: 'live' },
            { label: 'Relacje spo9eczne i wsparcie rodziny',  id: 'geropsychologia/relacje_spoleczne_starszych', status: 'live' },
          ]
        },
        {
          title: 'Aktywno9:ďż˝! i adaptacja',
          articles: [
            { label: 'Aktywno9:ďż˝! poznawcza i trening umys9u',  id: 'geropsychologia/aktywnosc_poznawcza',    status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Wypalenie i wsparcie opiekunBw',        id: 'geropsychologia/opieka_nad_opiekunami',  status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Przep9yw (flow) i immersja',      id: 'psychologia_gier/flow_i_immersja',     status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'P9eďż˝! i to9=samo9:ďż˝! w grach',            id: 'psychologia_gier/gender_w_grach',        status: 'live' },
          ]
        },
        {
          title: 'Kontekst spo9eczny i wiekowy',
          articles: [
            { label: 'Gry wieloosobowe i aspekty spo9eczne', id: 'psychologia_gier/gry_spolecznosciowe',  status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Odporno9:ďż˝! psychiczna',  id: 'rezyliencja_i_mobbing/odpornosc_wprowadzenie', status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Ekrany, ksiďż˝&9=ki i natura',  id: 'ekrany_ksiazki_i_natura/wprowadzenie',             status: 'live' },
            ...
            { label: 'Tablety, a rozwBj poznawczy dzieci',        id: 'ekrany_ksiazki_i_natura/tablety_dzieci',           status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Czytanie ksiďż˝&9=ek, a funkcje psychiczne',    id: 'ekrany_ksiazki_i_natura/czytanie_ksiazek',         status: 'live' },
            { label: 'G9ďż˝"bokie czytanie',                        id: 'ekrany_ksiazki_i_natura/gleboke_czytanie',         status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Kďż˝&piel le9:na - shinrin-yoku',              id: 'ekrany_ksiazki_i_natura/las_shinrin_yoku',         status: 'live' },
            { label: 'GBry i wďż˝"drBwki gBrskie, a psychologia',    id: 'ekrany_ksiazki_i_natura/gory_psychologia',         status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Szczďż˝"9:cie i dobrostan psychiczny',     id: 'psychologia_pozytywna/szczescie_dobrostan', status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Przep9yw (flow)',                id: 'psychologia_pozytywna/przeplyw_flow',          status: 'live' },
            { label: 'Si9y charakteru (VIA)',          id: 'psychologia_pozytywna/sily_charakteru',        status: 'live' },
            { label: 'Wdziďż˝"czno9:ďż˝!',                    id: 'psychologia_pozytywna/wdziecznosc',            status: 'live' },
          ]
        },
        {
          title: 'Uwa9=no9:ďż˝! i relacje',
          articles: [
            { label: 'Mindfulness i uwa9=no9:ďż˝!',        id: 'psychologia_pozytywna/mindfulness',             status: 'live' },
            { label: 'WspB9czucie dla siebie',         id: 'psychologia_pozytywna/wspolczucie_dla_siebie', status: 'live' },
            { label: 'Sens 9=ycia i poczucie celu',     id: 'psychologia_pozytywna/sens_i_cel',             status: 'live' },
            { label: 'Pozytywne relacje i mi9o9:ďż˝!',     id: 'psychologia_pozytywna/relacje_pozytywne',      status: 'live' },
          ]
        },
        {
          title: 'Interwencje',
    ...
    psych_ai: {
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            { label: 'Poznawcze aspekty dzia9ania AI',  id: 'psychologia_ai/ai_poznawcze',  status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Interakcja cz9owiek-AI',                  id: 'psychologia_ai/czlowiek_a_ai',        status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Uprzedzenia i b9ďż˝"dy poznawcze w AI',      id: 'psychologia_ai/uprzedzenia_ai', status: 'live' },
            ...
            { label: 'Przysz9o9:ďż˝! relacji cz9owiek-AI',          id: 'psychologia_ai/przyszlosc_ai',  status: 'live' },
          ]
        },
      ]
    },
    ...
    psychologia_technologii: {
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            { label: 'Zmďż˝"czenie cyfrowe i przeciďż˝&9=enie informacyjne',    id: 'psychologia_technologii/zmeczenie_cyfrowe',     status: 'live' },
            ...
            { label: 'Higiena cyfrowa i profilaktyka przeciďż˝&9=enia',       id: 'psychologia_technologii/higiena_cyfrowa',       status: 'live' },
            ...
            { label: 'Psychoedukacja rodzinna w erze ekranBw',            id: 'psychologia_technologii/psychoedukacja_rodzinna', status: 'live' },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Percepcja i ocena robotBw przez ludzi',  id: 'robotyka_afektywna/percepcja_robotow',        status: 'live' },
          ]
        },
        {
          title: 'Interakcja i zastosowania',
          articles: [
            { label: 'Roboty spo9eczne i HRI',           id: 'robotyka_afektywna/roboty_spoleczne',          status: 'live' },
            { label: 'Roboty w opiece i terapii',        id: 'robotyka_afektywna/roboty_w_opiece',           status: 'live' },
            { label: 'WspB9praca cz9owiekďż˝robot (HRC)',  id: 'robotyka_afektywna/wspolpraca_czlowiek_robot', status: 'live' },
          ]
        },
        {
          title: '9awiadomo9:ďż˝!, BCI i przysz9o9:ďż˝!',
          articles: [
            { label: '9awiadomo9:ďż˝! i podmiotowo9:ďż˝! maszyn',  id: 'robotyka_afektywna/swiadomosc_maszyn',              status: 'live' },
            { label: 'Interfejsy mBzgďż˝maszyna (BCI)',     id: 'robotyka_afektywna/interfejsy_mozg_maszyna',         status: 'live' },
            { label: 'Przysz9o9:ďż˝! robotyki afektywnej',    id: 'robotyka_afektywna/przyszlosc_robotyki_afektywnej',  status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Teorie uczenia siďż˝"',                  id: 'psychologia_szkolna/teorie_uczenia_sie',          status: 'live' },
        ...
        },
        {
          ...
          articles: [
            { label: 'Trudno9:ci w uczeniu siďż˝"',  id: 'psychologia_szkolna/trudnosci_w_uczeniu_sie', status: 'live' },
            { label: 'ADHD w 9:rodowisku szkolnym', id: 'psychologia_szkolna/adhd_w_szkole',          status: 'live' },
            { label: 'Stres szkolny i lďż˝"k egzaminacyjny', id: 'psychologia_szkolna/stres_szkolny',   status: 'live' },
          ]
        },
        {
          title: '9arodowisko szkolne i interwencje',
          articles: [
            { label: 'Relacje nauczycielďż˝ucze9',           id: 'psychologia_szkolna/relacje_nauczyciel_uczen', status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'NeurorB9=norodno9:ďż˝!',     id: 'neuroroznorodnosc/wprowadzenie',     status: 'live' },
            { label: 'ADHD jako wariant neurorB9=norodno9:ci', id: 'neuroroznorodnosc/adhd',             status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'ZespB9 Tourette\'a i tiki',         id: 'neuroroznorodnosc/tourette',    status: 'live' },
            { label: 'Hiperleksja i wyjďż˝&tkowe zdolno9:ci', id: 'neuroroznorodnosc/hiperleksja', status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'NeurorB9=norodno9:ďż˝! w miejscu pracy', id: 'neuroroznorodnosc/neurozroznorodnosc_w_pracy', status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            { label: 'Bieg9y psycholog',  id: 'psychologia_sadowa/wprowadzenie',   status: 'live' },
            { label: 'Rola i status bieg9ego',           id: 'psychologia_sadowa/rola_bieglego',  status: 'live' },
            { label: 'Podstawy prawne opiniowania',      id: 'psychologia_sadowa/podstawy_prawne', status: 'live' },
            { label: 'Metodologia sporzďż˝&dzania opinii',  id: 'psychologia_sadowa/metodologia_opinii', status: 'live' },
          ]
        },
        {
        ...
        },
        {
          ...
          articles: [
            { label: 'Narzďż˝"dzia diagnostyczne (sďż˝&dowe)', id: 'psychologia_sadowa/narzedzia_diagnostyczne', status: 'live' },
            { label: 'Etyka opiniowania sďż˝&dowego',       id: 'psychologia_sadowa/etyka_opiniowania',       status: 'live' },
            { label: 'Bieg9y, a sďż˝&d - komunikacja',       id: 'psychologia_sadowa/biegly_a_sad',            status: 'live' },
          ]
        },
      ]
    },
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Platformy i narzďż˝"dzia e-terapii',           id: 'e_terapia/platformy_e_terapii',            status: 'live' },
            ...
            { label: 'Wirtualna rzeczywisto9:ďż˝! (VR) w terapii',   id: 'e_terapia/vr_terapia',                     status: 'live' },
          ]
        },
        {
          title: 'Skuteczno9:ďż˝! i etyka',
          articles: [
            { label: 'Skuteczno9:ďż˝! e-terapii',              id: 'e_terapia/skutecznosc_e_terapii', status: 'live' },
            { label: 'Etyka e-terapii',                    id: 'e_terapia/etyka_e_terapii',       status: 'live' },
            { label: 'Dostďż˝"pno9:ďż˝! i wykluczenie cyfrowe',   id: 'e_terapia/dostepnosc_cyfrowa',    status: 'live' },
          ]
        },
        {
          title: 'Grupy szczegBlne i przysz9o9:ďż˝!',
          articles: [
            { label: 'E-terapia dzieci i m9odzie9=y', id: 'e_terapia/e_terapia_dzieci',     status: 'live' },
            { label: 'Przysz9o9:ďż˝! e-terapii',         id: 'e_terapia/przyszlosc_e_terapii', status: 'live' },
          ]
        },
      ]
    },
    ...
    filozofia: {
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            { label: 'Filozofia umys9u',  id: 'filozofia/filozofia_umyslu', status: 'live' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'Filozofia jďż˝"zyka',                id: 'filozofia/filozofia_jezyka',    status: 'live' },
            { label: 'Filozofia cz9owieka',             id: 'filozofia/filozofia_czlowieka',        status: 'live' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'MBzg Boltzmanna',                        id: 'filozofia/mozg_boltzmanna',           status: 'live' },
            ...
            { label: 'Asymetria dobra i bBlu',                 id: 'filozofia/asymetria_dobra_i_bolu',    status: 'live' },
            { label: 'Niemoralno9:ďż˝! braku zgody na narodziny',  id: 'filozofia/niemoralnosc_braku_zgody',  status: 'live' },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Jďż˝"zyk szakala i 9=yrafy',      id: 'porozumiewanie_sie_bez_przemocy/jezyk_szakala_i_zyrafy', status: 'live', desc: 'Dwa style komunikacji - oceniajďż˝&cy i empatyczny.' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Pro9:ba, a 9=ďż˝&danie',            id: 'porozumiewanie_sie_bez_przemocy/prosba_i_zadanie',    status: 'live', desc: 'Jak formu9owaďż˝! pro9:by i czym rB9=niďż˝& siďż˝" od 9=ďż˝&da9.' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Autoempatia i samowspB9czucie', id: 'porozumiewanie_sie_bez_przemocy/autoempatia',       status: 'live', desc: 'S9uchanie w9asnych uczuďż˝! i potrzeb z 9=yczliwo9:ciďż˝&.' },
          ]
        },
        {
          title: 'Zastosowania NVC',
          articles: [
            { label: 'NVC w rozwiďż˝&zywaniu konfliktBw', id: 'porozumiewanie_sie_bez_przemocy/nvc_w_konfliktach', status: 'live', desc: 'Mediacja NVC, trzy fazy rozwiďż˝&zywania konfliktu.' },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Przeglďż˝&d literatury naukowej',         id: 'seminarium_dyplomowe/przeglad_literatury',  status: 'live', desc: 'Bazy danych, strategie wyszukiwania, ocena 9_rBde9, cytowanie.' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Zasady prowadzenia pomiarBw',           id: 'seminarium_dyplomowe/pomiary_psychologiczne',  status: 'live', desc: 'Skale, rzetelno9:ďż˝!, trafno9:ďż˝!, standaryzacja, normy.' },
            { label: 'Narzďż˝"dzia badawcze i kwestionariusze', id: 'seminarium_dyplomowe/narzedzia_badawcze',      status: 'live', desc: 'WybBr narzďż˝"dzia, adaptacja, tworzenie w9asnych kwestionariuszy.' },
        ...
        },
        {
          ...
          articles: [
            ...
            { label: 'B9ďż˝"dy badawcze - czego unikaďż˝!',       id: 'seminarium_dyplomowe/bledy_badawcze',   status: 'live', desc: 'B9ďż˝"dy projektowania, pomiaru, analizy i interpretacji wynikBw.' },
          ]
        },
        {
          title: 'Pisanie i obrona',
          articles: [
            { label: 'Pisanie i interpretacja wynikBw',  id: 'seminarium_dyplomowe/opis_wynikow',    status: 'live', desc: 'Raportowanie statystyk, tabele, wykresy, dyskusja i ograniczenia.' },
      ...
      sections: [
        {
          ...
          articles: [
            ...
            { label: 'Raport neurorB9=norodno9:ci', href: 'pages/Raport_neuroroznorodnosci.html', status: 'xlink', desc: 'Dodatkowa strona HTML: Raport_neuroroznorodnosci.html.' },
      ...
      sections: [
        {
          ...
          files: [
            { id: 'labs/neuro_lab1', label: 'Neuropsychologia ďż˝ lab 1', href: 'labs/neuro_lab1.pdf' },
            { id: 'labs/neuro_lab2', label: 'Neuropsychologia ďż˝ lab 2', href: 'labs/neuro_lab2.pdf' },
            { id: 'labs/neuro_lab3', label: 'Neuropsychologia ďż˝ lab 3', href: 'labs/neuro_lab3.pdf' },
            { id: 'labs/neuro_lab4', label: 'Neuropsychologia ďż˝ lab 4', href: 'labs/neuro_lab4.pdf' },
            { id: 'labs/diagnoza_lab2', label: 'Diagnoza psychologiczna ďż˝ lab 2', href: 'labs/diagnoza_lab2.pdf' },
            { id: 'labs/diagnoza_lab3', label: 'Diagnoza psychologiczna ďż˝ lab 3', href: 'labs/diagnoza_lab3.pdf' },
            { id: 'labs/diagnoza_lab4', label: 'Diagnoza psychologiczna ďż˝ lab 4', href: 'labs/diagnoza_lab4.pdf' },
            { id: 'labs/diagnoza_lab5', label: 'Diagnoza psychologiczna ďż˝ lab 5', href: 'labs/diagnoza_lab5.pdf' },
            { id: 'labs/psych_pozn_lab1', label: 'Psychologia poznawcza ďż˝ lab 1', href: 'labs/psych_pozn_lab1.pdf' },
            { id: 'labs/psych_pozn_lab2', label: 'Psychologia poznawcza ďż˝ lab 2', href: 'labs/psych_pozn_lab2.pdf' },
            { id: 'labs/psych_pozn_lab3', label: 'Psychologia poznawcza ďż˝ lab 3', href: 'labs/psych_pozn_lab3.pdf' },
            { id: 'labs/psych_pozn_lab4', label: 'Psychologia poznawcza ďż˝ lab 4', href: 'labs/psych_pozn_lab4.pdf' },
            { id: 'labs/psych_pozn_lab5', label: 'Psychologia poznawcza ďż˝ lab 5', href: 'labs/psych_pozn_lab5.pdf' },
            { id: 'labs/psych_pozn_lab6', label: 'Psychologia poznawcza ďż˝ lab 6', href: 'labs/psych_pozn_lab6.pdf' }
          ]
        }
      ]
    },
    ...
    podstawy_pomocy: {
      ...
      sections: [
        ...
        },
        {
          ...
          articles: [
            { label: 'Aktywne s9uchanie',                   id: 'podstawy_pomocy/aktywne_sluchanie',             status: 'live', desc: 'Parafrazowanie, odzwierciedlanie emocji, klaryfikacja i bariery s9uchania.' },
            ...
            { label: 'Komunikacja wspierajďż˝&ca',             id: 'podstawy_pomocy/komunikacja_wspierajaca',       status: 'live', desc: 'Walidacja, normalizacja, pytania otwarte i nieskuteczne wzorce komunikacji.' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Wsparcie spo9eczne',                  id: 'podstawy_pomocy/wsparcie_spoleczne',            status: 'live', desc: 'Rodzaje wsparcia, modele efektu g9Bwnego i buforowego, grupy wsparcia.' },
          ]
        },
        {
          ...
          articles: [
            ...
            { label: 'Samoopieka pomagajďż˝&cego',             id: 'podstawy_pomocy/samoopieka_pomagajacego',       status: 'live', desc: 'Wypalenie zawodowe, wtBrna traumatyzacja i obszary samoopieki.' },
