...
- „Czy potrzebujesz zaufania / niezawodności / bliskości?"

Zamiast reagować na treść słów, reagujemy na **człowieka za słowami**.

## Cztery poziomy słuchania

Rosenberg opisywał cztery sposoby reagowania na trudny komunikat:

| Poziom | Opis | Przykład reakcji na „Jesteś beznadziejny!" |
|--------|------|--------------------------------------|
| 1. Atak na siebie | Branie do siebie | „Masz rację, jestem do niczego." |
| 2. Atak na innych | Kontratak | „Sam jesteś beznadziejny!" |
...
2. Zapytanie: „Co czuję?" → „Czuję złość, rozczarowanie, strach"
3. Zapytanie: „Czego potrzebuję?" → „Potrzebuję szacunku, bycia uwzględnianym"
4. Decyzja o dalszym działaniu z tego miejsca
...
Empatia nie jest nieograniczona. NVC uznaje, że mamy prawo i potrzebę:
- Powiedzieć, że potrzebujemy przerwy
- Wyrazić własne uczucia i potrzeby, gdy ich słuchanie staje się zbyt trudne
- Zadbać o siebie, zanim znowu damy empatię innym

Empatia musi płynąć z miejsca pełni, nie wyczerpania. Dlatego autoempatia jest jej fundamentem.

---

*Zob. też: Autoempatia, Język szakala i żyrafy, NVC w rozwiązywaniu konfliktów*

## Perspektywa nieoczywista

Nieoczywista perspektywa na temat "Empatia w NVC" polega na tym, że NVC nie jest techniką grzecznego mówienia, lecz sposobem porządkowania relacji między obserwacją, uczuciami, potrzebami i działaniem.

Dopiero wspólna analiza zagadnień takich jak czym jest empatia w rozumieniu nvc?, empatia wobec siebie (autoempatia) oraz empatia a granice pokazuje pełny zakres omawianego zjawiska.

Z tego powodu trafna interpretacja wymaga nie tylko nazwania zjawiska, ale także oceny jego funkcji, ograniczeń i długofalowych skutków dla osoby lub systemu, którego dotyczy.

## Podsumowanie

Temat "Empatia w NVC" pokazuje, że największą wartość ma traktowanie komunikacji jako praktyki rozpoznawania potrzeb i odpowiedzialnego wpływu, a nie tylko doboru słów.
