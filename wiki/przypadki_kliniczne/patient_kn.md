...
# Pacjentka K.N. (somatoparafrenia)

Przypadek zaburzenia świadomości ciała, w którym pacjentka zaprzecza przynależności własnej kończyny po uszkodzeniu prawej półkuli.
...
- **Schemat ciała:** dynamiczna reprezentacja położenia i stanu ciała wykorzystywana w działaniu.

## Część analityczna: mechanizmy i zależności

Somatoparafrenia zwykle współwystępuje z niedowładem połowiczym, zaburzeniami uwagi przestrzennej i deficytami integracji wielozmysłowej. Sugeruje to, że poczucie „to moje ciało” powstaje w rozproszonej sieci obejmującej ciemieniową i wyspową część prawej półkuli oraz połączenia czołowe.

Przypadki typu K.N. pokazują, że samo czucie obwodowe nie wystarcza do subiektywnego poczucia własności ciała. Kluczowa jest integracja sygnałów proprioceptywnych, wzrokowych i interoceptywnych z modelem Ja.

## Praktyczne przykłady

### Dobra praktyka

W rehabilitacji stosować interwencje wielomodalne: trening uwagi przestrzennej, techniki z lustrem, stymulację sensoryczną i pracę nad narracją pacjenta o ciele.
...
3. Moro, V., et al. (2016). Ownership and agency in post-stroke patients. *Cortex*, 74, 133–146.
