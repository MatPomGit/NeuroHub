...
# Pacjent P.S. (czysta aleksja)

Przypadek „czytania bez pisania”, który odegrał ważną rolę w rozumieniu sieci wzrokowo-językowych lewej półkuli.
...
- **Dysocjacja neuropsychologiczna:** nierównomierne zaburzenie funkcji poznawczych, wspierające ich częściową niezależność.

## Część analityczna: mechanizmy i zależności

W czystej aleksji często dochodzi do uszkodzenia lewej okolicy potyliczno-skroniowej i/lub połączeń przez spoidło tylne, co odcina system językowy od wejścia wzrokowego. Pacjent może pisać i rozumieć mowę, ale czytanie staje się powolne, często literujące.

Przypadki typu P.S. wsparły model, w którym język i percepcja wzrokowa pisma współpracują w sieci, a nie w pojedynczym „centrum czytania”. Klinicznie wyjaśnia to, dlaczego część kompetencji językowych może być zachowana mimo głębokiego deficytu czytania.

## Praktyczne przykłady

### Dobra praktyka

Projektować terapię z wykorzystaniem zachowanych kanałów: trening czytania literowego, strategie fonologiczne, wsparcie audio i adaptacje środowiskowe (duże czcionki, wysoki kontrast, krótkie komunikaty pisemne).
