...
- Gry edukacyjne (szkolenia, symulatory, e-learning)
- Gry terapeutyczne (zdrowie psychiczne i fizyczne)
- Gry rehabilitacyjne (neurologiczne, ortopedyczne)
...
**VR-terapia** (Virtual Reality Therapy) to jedna z najszybciej rozwijających się gałęzi psychoterapii. Umożliwia tworzenie kontrolowanych, wciągających środowisk do ekspozycji, treningu i rehabilitacji.
...
Protokół Prolonged Exposure (PE) z użyciem VR jest stosowany szczególnie u weteranów wojennych z PTSD:

- System **Bravemind** (University of Southern California) symuluje środowiska bojowe na Bliskim Wschodzie
- Terapeuta może kontrolować intensywność bodźców i poziom aktywacji
- Badania wykazują redukcję objawów PTSD porównywalną z tradycyjną PE

Wyzwania: koszty sprzętu, ryzyko cybersickness (nudności w VR), konieczność indywidualnej kalibracji środowiska.

> **Fakt:** Szpital wojskowy Walter Reed National Military Medical Center stosuje VR-terapię PTSD u weteranów z Iraku i Afganistanu od 2007 roku. Programy VR dla weteranów są finansowane przez Departament Obrony USA.
...
**Gamifikacja** (gamification) to stosowanie elementów mechaniki gier w kontekstach niezwiązanych z grami w celu zwiększenia motywacji i zaangażowania. W opiece zdrowotnej gamifikacja znalazła szerokie zastosowanie:
...
Meta-analizy wskazują na umiarkowaną, ale konsekwentną poprawę adherencji (przestrzegania zaleceń) w programach gamifikowanych vs. niegamifikowanych. Kluczowe są:

1. Wyraźne i osiągalne cele
2. Natychmiastowa informacja zwrotna
3. Elementy społeczne (porównanie z innymi, współpraca)
4. Dopasowanie wyzwania do poziomu pacjenta

## Rehabilitacja neuropsychologiczna z użyciem gier

Gry wideo znalazły zastosowanie w rehabilitacji pacjentów po udarze, TBI (traumatycznym uszkodzeniu mózgu) i z chorobami neurodegeneracyjnymi:

### Rehabilitacja ruchowa

**Nintendo Wii Sports** i **Xbox Kinect** zostały szeroko zaadoptowane do rehabilitacji ruchowej, szczególnie po udarze:

- Ćwiczenia równowagi w grach wirtualnych
- Trening zakresu ruchu ramion i kończyn
- Koordynacja wzrokowo-ruchowa w grach sportowych
- Systematyczne przeglądy wskazują na skuteczność porównywalną z tradycyjną fizjoterapią, przy wyższej motywacji pacjentów

### Rehabilitacja poznawcza

Platformy takie jak **Cogmed**, **BrainHQ** i **NeuroRacer** stosują zadania zbliżone do gier do treningu:

- Pamięci roboczej
- Uwagi selektywnej i podzielnej
- Szybkości przetwarzania informacji
- Funkcji wykonawczych

Badanie Alzheimera Stowarzyszenia (2014) wykazało, że trening z BrainHQ spowalnia pogorszenie funkcji poznawczych u osób starszych ze wczesnym MCI (mild cognitive impairment).

## Gry w terapii dzieci ze spektrum autyzmu

Dzieci ze spektrum autyzmu (ASD) często wykazują silne zainteresowanie grami wideo, co można wykorzystać terapeutycznie:
...
Pomimo obiecujących wyników, terapeutyczne zastosowania gier mają istotne ograniczenia:

- **Koszty**: sprzęt VR i licencje gier terapeutycznych są kosztowne
- **Cybersickness**: ok. 30–40% osób doświadcza nudności lub dyskomfortu w VR
- **Jakość badań**: wiele badań ma małe próby i krótki czas obserwacji
...
Nieoczywista perspektywa na temat "Gry w terapii i rehabilitacji" polega na tym, że gry oddziałują nie przez sam fakt istnienia medium, lecz przez strukturę reguł, motywacji, relacji i czasu zaangażowania.

Dopiero wspólna analiza zagadnień takich jak gry jako narzędzie terapeutyczne, rehabilitacja neuropsychologiczna z użyciem gier oraz ograniczenia i wyzwania pokazuje pełny zakres omawianego zjawiska.
