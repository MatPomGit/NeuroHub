...
Dane empiryczne dają nieoczekiwany obraz:

- Wiele osób z poważnymi niepełnosprawnościami ocenia jakość życia wyżej, niż zakładają to osoby zdrowe (tzw. **disability paradox**).
- Kluczowymi predyktorami dobrej jakości życia nie są obiektywe wskaźniki medyczne, lecz: wsparcie społeczne, poczucie kontroli, sens i akceptacja siebie.
- Adaptacja hedoniczna sprawia, że wiele osób „wraca" do wyjściowego poziomu dobrostanu po przyjęciu nowej sytuacji.

## Co obniża jakość życia?

Najsilniejsze negatywne predyktory:

- ból przewlekły i zmęczenie,
- izolacja społeczna i samotność,
- brak autonomii i nadmierny opiekuństwo,
- dyskryminacja i wykluczenie,
- bariery w dostępie do pracy, edukacji i usług,
- depresja i lęk (często towarzyszące, nie nieodłączne).

## Co podwyższa jakość życia?
...
Ocena jakości życia powinna być **centralnym wymiarem** planowania wsparcia, nie dodatkiem do diagnozy medycznej. Oznacza to:
...
Nieoczywista perspektywa na temat "Jakość życia osób z niepełnosprawnością" polega na tym, że najbardziej ograniczające bywają nie same deficyty, lecz bariery środowiskowe, organizacyjne i społeczne, które wzmacniają koszt codziennego funkcjonowania.

Dopiero wspólna analiza zagadnień takich jak komponenty jakości życia, co podwyższa jakość życia? oraz implikacje dla praktyki pokazuje pełny zakres omawianego zjawiska.
