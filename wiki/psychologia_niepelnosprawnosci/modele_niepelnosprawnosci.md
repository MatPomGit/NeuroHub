...
Niepełnosprawność jest traktowana jako **patologia zlokalizowana w ciele jednostki**, którą należy leczyć, korygować lub rehabilitować. Cel: przywrócenie sprawności „normalnej" lub zbliżonej do niej.

**Krytyka:** redukuje osobę do diagnozy, pomija bariery środowiskowe, może obniżać godność i autonomię.
...
**Krytyka:** może niedoceniać roli samego uszkodzenia i bólu.

## Model biopsychospołeczny (ICF)

Klasyfikacja WHO (ICF, 2001) łączy oba podejścia. Niepełnosprawność wynika z interakcji:

- **Czynniki zdrowotne** (choroba, uraz),
- **Funkcje i struktury ciała**,
- **Aktywność i uczestnictwo**,
- **Czynniki środowiskowe** (bariery i ułatwienia),
- **Czynniki osobiste** (wiek, płeć, motywacja, zasoby).

Jest to obecnie dominujące podejście w rehabilitacji i orzecznictwie.
...
- zasobów psychicznych (odporność, poczucie własnej skuteczności),
- wsparcia środowiskowego,
- subiektywnego znaczenia przypisanego niepełnosprawności.

## Znaczenie dla praktyki

| Model | Interwencja | Podmiot zmiany |
|---|---|---|
| Medyczny | leczenie, rehabilitacja medyczna | jednostka |
| Społeczny | zmiana środowiska, dostępność | społeczeństwo |
| Biopsychospołeczny (ICF) | wielosektorowa rehabilitacja | jednostka + środowisko |
...
Nieoczywista perspektywa na temat "Modele niepełnosprawności" polega na tym, że najbardziej ograniczające bywają nie same deficyty, lecz bariery środowiskowe, organizacyjne i społeczne, które wzmacniają koszt codziennego funkcjonowania.

Dopiero wspólna analiza zagadnień takich jak model medyczny, model kulturowo-tożsamościowy (disability identity) oraz znaczenie dla praktyki pokazuje pełny zakres omawianego zjawiska.
