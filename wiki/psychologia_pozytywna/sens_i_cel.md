...
- **wartości twórcze** (*creative values*): sens poprzez tworzenie i działanie
- **wartości doświadczeniowe** (*experiential values*): sens poprzez miłość, piękno i doświadczenie dobra
- **wartości postawy** (*attitudinal values*): sens poprzez godną postawę wobec nieuchronnego cierpienia
...
**Roy Baumeister** wraz ze współpracownikami zidentyfikował cztery główne potrzeby leżące u podstaw poczucia sensu:

- **cel** (*purpose*): poczucie, że działamy w kierunku wartościowej przyszłości
- **wartości** (*values*): przekonanie, że nasze działania są moralnie uzasadnione i słuszne
- **skuteczność** (*efficacy*): przekonanie, że możemy dokonywać zmian w otoczeniu
- **poczucie własnej wartości** (*self-worth*): przekonanie, że jesteśmy dobrymi i wartościowymi ludźmi

**Przykład:** Marek, 62-letni inżynier na emeryturze, zgłosił do lekarza rodzinnego poczucie pustki i braku motywacji. Przed emeryturą jego poczucie sensu opierało się głównie na pracy i roli zawodowej. Terapia skoncentrowana na sensie pomogła mu zidentyfikować alternatywne źródła: mentoringowe wsparcie młodych inżynierów wolontariacko, angażowanie się w lokalną wspólnotę i pisanie wspomnień. Po roku Marek raportował wyższy poziom dobrostanu niż w ostatnich latach pracy zawodowej.
...
Poczucie sensu i celu jest jednym z najsilniejszych predyktorów zdrowia fizycznego i długowieczności:

- niższe ryzyko chorób sercowo-naczyniowych
- lepsze funkcjonowanie immunologiczne
- mniejsze ryzyko demencji w późnym wieku
- szybsza rekonwalescencja po poważnych chorobach
...
Nieoczywista perspektywa na temat "Sens życia i poczucie celu" polega na tym, że dobrostan nie rośnie liniowo wraz z liczbą pozytywnych doświadczeń, lecz zależy od sposobu integrowania zasobów z codziennym funkcjonowaniem i relacjami.

Dopiero wspólna analiza zagadnień takich jak rozróżnienie między sensem a celem, źródła sensu według baumeistra oraz korzyści dla zdrowia i długowieczności pokazuje pełny zakres omawianego zjawiska.
