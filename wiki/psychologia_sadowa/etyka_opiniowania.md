...
Jedną z podstawowych zasad etyki forensycznej jest zakaz **podwójnych relacji** (*dual relationships*). Biegły nie może:
- Opiniować osoby, z którą wcześniej lub równolegle pozostaje w relacji terapeutycznej
- Podejmować terapii osoby, którą badał jako biegły
- Pełnić funkcji biegłego i adwokata tej samej osoby w tym samym postępowaniu
- Opiniować osoby bliskiej lub znajomej

Mieszanie ról zagraża bezstronności, naraża badanego na naruszenie granic i podważa wartość dowodową opinii. Gdy biegły stwierdzi po podjęciu zlecenia, że zachodzi ryzyko konfliktu ról, ma obowiązek natychmiastowego poinformowania organu procesowego i wnioskowania o wyłączenie.

## Poinformowanie osoby badanej
...
## Kompetencje a zakres opiniowania

Biegły może opiniować wyłącznie w obszarach, w których posiada udokumentowane kompetencje. Wydawanie opinii poza zakresem kompetencji (*practicing beyond competence*) jest jednym z najpoważniejszych naruszeń etycznych.

Psycholog specjalizujący się w terapii dorosłych nie powinien opiniować w sprawach dotyczących oceny wiarygodności dzieci, jeśli nie przeszedł specjalistycznego szkolenia z psychologii dziecięcej i technik przesłuchań dzieci. Podobnie, biegły bez certyfikacji w zakresie oceny ryzyka przemocy nie powinien stosować HCR-20 bez nadzoru.

## Język i komunikacja wyników

Etyka biegłego obejmuje także odpowiedzialność za sposób komunikowania wyników. Opinia powinna być pisana językiem zrozumiałym dla sędziego i prawników przy zachowaniu precyzji terminologicznej. Biegły ma obowiązek:
- Wyraźnie odróżniać fakty od interpretacji i wniosków
- Nie formułować wniosków o charakterze prawnym
...
Nieoczywista perspektywa na temat "Etyka opiniowania sądowego" polega na tym, że w psychologii sądowej najważniejsze jest nie tylko to, co badany przeżywa, ale również to, jak wiarygodnie można tę informację udokumentować i uzasadnić przed sądem.

Dopiero wspólna analiza zagadnień takich jak fundamenty etyczne roli biegłego, bezstronność i niezawisłość oraz tajemnica zawodowa a obowiązki procesowe pokazuje pełny zakres omawianego zjawiska.
