...
# Metodologia sporządzania opinii psychologicznej
...
Rzetelna opinia psychologiczna jest efektem wieloetapowego procesu:

**1. Analiza materiałów aktowych**
Przed badaniem biegły zapoznaje się z aktami sprawy, dokumentacją medyczną i psychiatryczną, wywiadami środowiskowymi oraz innymi materiałami dowodowymi. Pozwala to na sformułowanie wstępnych hipotez diagnostycznych i zaplanowanie procedury badania.

**2. Planowanie badania**
Biegły dobiera metody adekwatne do pytań sformułowanych przez organ procesowy oraz do specyfiki osoby badanej (wiek, wykształcenie, stan zdrowia, możliwa symulacja). Dobór metod powinien być uzasadniony i udokumentowany.
...
Pełna dokumentacja jest podstawowym wymogiem rzetelności. Biegły powinien zachować:
...
## Ocena symulacji i agrawacji

Jednym z najtrudniejszych zadań biegłego jest ocena, czy badana osoba przedstawia prawdziwy obraz swojego stanu psychicznego, czy też symuluje lub wyolbrzymia objawy. Do oceny symulacji stosuje się:

- **Testy kontrolne ważności wyników** (*Symptom Validity Tests*, SVT): TOMM, VSVT, SIMS, M-FAST
- **Wskaźniki wewnętrzne** skal testowych: np. skale L, F, K w MMPI, wskaźnik Rogers Discriminant Function
...
Nieoczywista perspektywa na temat "Metodologia sporządzania opinii psychologicznej" polega na tym, że w psychologii sądowej najważniejsze jest nie tylko to, co badany przeżywa, ale również to, jak wiarygodnie można tę informację udokumentować i uzasadnić przed sądem.

Dopiero wspólna analiza zagadnień takich jak ogólne zasady metodologiczne, specyfika wywiadu sądowego oraz ocena symulacji i agrawacji pokazuje pełny zakres omawianego zjawiska.
