...
> **Fakt:** Gardner celowo użył słowa „inteligencja" zamiast „zdolność" czy „talent" jako prowokację intelektualną, chcąc wymusić redefiniowanie pojęć stosowanych w psychologii i edukacji.
...
**Inteligencja przestrzenna** (*spatial intelligence*) to zdolność dokładnego postrzegania świata wizualnego, transformowania i modyfikowania wyobrażeń przestrzennych oraz odtwarzania aspektów doświadczenia wzrokowego. Charakteryzuje architektów, rzeźbiarzy, nawigatorów i chirurgów.

**Inteligencja muzyczna** (*musical intelligence*) przejawia się w wrażliwości na rytm, melodię, harmonię i brzmienie. Gardner traktuje ją jako równoważną inteligencji lingwistycznej pod względem struktury i znaczenia kulturowego.

**Inteligencja cielesno-kinestetyczna** (*bodily-kinesthetic intelligence*) obejmuje umiejętność używania własnego ciała jako narzędzia wyrazu lub wytwarzania, charakterystyczną dla tancerzy, sportowców, chirurgów i rzemieślników.

**Inteligencja interpersonalna** (*interpersonal intelligence*) to zdolność rozumienia intencji, motywacji i pragnień innych ludzi oraz efektywnego działania na tej podstawie. Wysoki jej poziom wyróżnia nauczycieli, polityków, terapeutów i przywódców.
...
Teoria MI spotkała się z poważną krytyką ze strony psychologów:

Główny zarzut dotyczy **braku twardych dowodów empirycznych** potwierdzających niezależność poszczególnych inteligencji. Badania psychometryczne konsekwentnie wykazują wysokie korelacje między różnymi zdolnościami poznawczymi (czynnik *g*), co podważa tezę o ich niezależności.

Krytycy wskazują też, że Gardner nie zapewnia rzetelnych narzędzi pomiaru poszczególnych inteligencji, co uniemożliwia falsyfikację teorii. Część badaczy uważa, że Gardner opisuje raczej **talenty** i **style poznawcze** niż odrębne rodzaje inteligencji.

## Porównanie z triadyczną teorią Sternberga
...
Nieoczywista perspektywa na temat "Teoria inteligencji wielorakich" polega na tym, że trudności szkolne rzadko wynikają z pojedynczej cechy ucznia; zwykle odzwierciedlają relację między wymaganiami szkoły, wsparciem, klimatem klasy i profilem rozwojowym dziecka.

Dopiero wspólna analiza zagadnień takich jak osiem inteligencji, krytyka teorii oraz porównanie z triadyczną teorią sternberga pokazuje pełny zakres omawianego zjawiska.
