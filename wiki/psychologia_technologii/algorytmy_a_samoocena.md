...
### 1. Mechanizm selekcji emocjonalnej

Systemy rekomendacyjne częściej promują treści wywołujące silną reakcję, ponieważ zwiększają prawdopodobieństwo interakcji. W praktyce użytkownik częściej widzi materiały, które wzmacniają porównania, niepokój normatywny i idealizowane standardy.

### 2. Mechanizm sprzężenia zwrotnego

Zachowania użytkownika stają się wejściem dla algorytmu, a następnie wracają do użytkownika jako „spersonalizowana rzeczywistość”. Jeżeli ktoś często reaguje na treści oceniające wygląd, sukces lub status, system będzie dostarczał ich więcej, pogłębiając tematykę samooceny.

### 3. Zróżnicowanie indywidualne

Wpływ personalizacji nie jest jednolity. Najwyższe ryzyko obserwuje się przy wysokiej neurotyczności, perfekcjonizmie, niskiej stabilności samooceny i silnej potrzebie aprobaty społecznej.

### 4. Skutki rozwojowe

U młodzieży, której tożsamość jest w fazie intensywnego formowania, algorytmiczne „lustro społeczne” może wzmacniać samoocenę warunkową: „jestem wartościowy tylko wtedy, gdy jestem widoczny i nagradzany”.

## Praktyczne przykłady

### Dobra praktyka

Użytkowniczka regularnie „higienizuje” feed: usuwa profile nasilające porównania, dodaje treści edukacyjne i ogranicza wskaźniki widoczności (np. liczby polubień), kiedy platforma daje taką opcję.
...
**Konsekwencje:** chwiejność samooceny, wyczerpanie emocjonalne, wzrost lęku przed utratą widoczności i ryzyko wypalenia.
