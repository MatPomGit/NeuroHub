...
### 1. Mechanizm poznawczy

Uwaga człowieka ma ograniczoną pojemność. Każde przerwanie (powiadomienie, e-mail, komunikator) aktywuje orientacyjną reakcję na nowość, a następnie wymaga rekonfiguracji celu działania. Jeśli cykl ten powtarza się przez wiele godzin, rosną błędy, wydłuża się czas wykonania i nasila poczucie chaosu.

### 2. Mechanizm emocjonalny

Niedomknięte zadania i presja „bycia na bieżąco” podnoszą napięcie i obniżają tolerancję frustracji. W konsekwencji użytkownik częściej reaguje impulsywnie, trudniej reguluje emocje i gorzej odpoczywa po zakończeniu pracy.

### 3. Mechanizm behawioralny

Przeciążenie informacyjne prowadzi paradoksalnie do strategii unikania: odkładania decyzji, chaotycznego przeglądania treści i kompulsywnego odświeżania kanałów. Krótkoterminowo zachowanie to obniża napięcie, długoterminowo je utrwala.

### 4. Zależności długofalowe

Badania nad pracą wiedzy wskazują, że chroniczna fragmentacja uwagi wiąże się ze spadkiem satysfakcji zawodowej, wyższym ryzykiem wypalenia i gorszą jakością snu. Nie jest to więc wyłącznie „problem produktywności”, ale element profilaktyki zdrowia psychicznego.

## Praktyczne przykłady

### Dobra praktyka

Zespół wdraża model „okien komunikacyjnych”: powiadomienia asynchroniczne są przeglądane o stałych porach, a 2 bloki dziennie pozostają wolne od komunikatorów. Dodatkowo obowiązuje zasada jednego głównego kanału zadań.
...
**Konsekwencje:** pozorna „aktywność” przy realnym spadku efektywności, wzrost liczby pomyłek, napięcie po pracy i trudność z regeneracją.
