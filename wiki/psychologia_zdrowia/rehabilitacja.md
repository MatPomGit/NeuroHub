...
## Wskazania do rehabilitacji psychologicznej

Rehabilitacja psychologiczna jest stosowana m.in. po:

- udarach mózgu i urazach czaszkowo-mózgowych,
- chorobach onkologicznych i ich leczeniu,
- zawałach serca i operacjach kardiochirurgicznych,
- amputacjach i innych zmianach ciała,
- długotrwałych hospitalizacjach psychiatrycznych,
- epizodach psychotycznych (rehabilitacja psychiatryczna),
- przewlekłym bólu i chorobach neurologicznych.

## Cele procesu rehabilitacyjnego

Rehabilitacja psychologiczna dąży do:

1. odbudowania poczucia własnej wartości i sprawczości,
2. adaptacji do nowej sytuacji życiowej i ewentualnych ograniczeń,
3. wypracowania strategii kompensacyjnych dla utraconych funkcji,
4. podtrzymania lub odbudowania relacji społecznych,
5. powrotu do aktywności zawodowej lub znalezienia nowego jej wymiaru,
6. redukcji zaburzeń towarzyszących (lęk, depresja, PTSD).
...
## Rola rodziny i systemu wsparcia

Rehabilitacja jest znacznie skuteczniejsza, gdy angażuje bliskich. Rodzina może:

- wzmacniać i nagradzać nowe umiejętności,
- zapobiegać nadmiernej wyręczaniu (utrata niezależności),
- uczyć się rozpoznawać przeciążenie pacjenta,
- zadbać o własne zasoby (zapobieganie wypaleniu opiekuna).
...
Nieoczywista perspektywa na temat "Rehabilitacja psychologiczna" polega na tym, że stan zdrowia i zachowania zdrowotne są wynikiem współdziałania biologii, interpretacji objawów, relacji z otoczeniem i jakości codziennych nawyków.

Dopiero wspólna analiza zagadnień takich jak wskazania do rehabilitacji psychologicznej, rola rodziny i systemu wsparcia oraz przykład pokazuje pełny zakres omawianego zjawiska.
