...
## Historia klasyfikacji w psychiatrii
...
ICD-11 jest kompleksowym systemem WHO obejmującym wszystkie choroby, nie tylko psychiczne. Rozdział 6 (*Mental, behavioural or neurodevelopmental disorders*) jest najważniejszy dla psychologów i psychiatrów.

### Główne bloki rozpoznawcze (Rozdział 6 ICD-11)

| Blok | Kategoria | Przykłady rozpoznań |
|------|-----------|---------------------|
...
| 6B4x | Specyficznie z traumą i stresem | PTSD, złożone PTSD (CPTSD), reakcja żałoby przedłużonej |
| 6B6x | Zaburzenia dysocjacyjne | Dysocjacyjna amnezja, DID, depersonalizacja |
| 6B8x | Zaburzenia odżywiania | Anoreksja, bulimia, BED, ARFID |
...
ICD-11 preferuje **diagnozę kliniczną** opartą na przesłankach holotypowych (prototypach klinicznych), a nie wyłącznie na spełnieniu progów liczbowych. Jest przeznaczony zarówno dla psychiatrii, jak i podstawowej opieki zdrowotnej (uproszczone wersje).

## Struktura DSM-5-TR

DSM-5-TR jest klasyfikacją APA przeznaczoną głównie dla psychiatrów i psychologów klinicznych, szczególnie popularną w USA, Kanadzie i Australii oraz w badaniach klinicznych na całym świecie.

### Organizacja DSM-5-TR: spektra i sekcje
...
| 2 | Spektrum schizofrenii i inne psychozy |
| 3 | Zaburzenia dwubiegunowe i pokrewne |
| 4 | Zaburzenia depresyjne |
| 5 | Zaburzenia lękowe |
| 6 | OCD i zaburzenia pokrewne |
| 7 | Zaburzenia związane z traumą i stresorami |
| 8 | Zaburzenia dysocjacyjne |
| 9 | Zaburzenia objawów somatycznych i pokrewne |
| 10 | Zaburzenia odżywiania |
| 11 | Zaburzenia wydalania |
| 12 | Zaburzenia snu i czuwania |
| 13 | Dysfunkcje seksualne |
| 14 | Dysforia płciowa |
| 15 | Zaburzenia destrukcyjne, impulsów, zachowania |
| 16 | Zaburzenia związane z substancjami i uzależnienia behawioralne |
| 17 | Zaburzenia neurokognitywne |
| 18 | Zaburzenia osobowości |
| 19 | Parafilne zaburzenia |
| 20 | Inne zaburzenia psychiczne |
| 21 | Zaburzenia ruchowe wywołane lekami |
| 22 | Inne stany będące przedmiotem klinicznej uwagi |

### Kryteria diagnostyczne DSM-5-TR: logika operacyjna
...
- Są systematycznie aktualizowane na podstawie badań

### Różnice kluczowe

| Wymiar | ICD-11 | DSM-5-TR |
|--------|--------|----------|
| **Wydawca** | WHO (globalny) | APA (USA) |
| **Zastosowanie** | Cały świat, system opieki zdrowotnej, billing | Badania naukowe, klinika w USA i globalnie |
| **Złożone PTSD** | Osobna kategoria (6B41) | Brak (specyfikatory PTSD) |
| **Zaburzenia osobowości** | Model wymiarowy (nasilenie + cechy) | Kategorialne typy (10) + alternatywny model w Sekcji III |
| **Katatonia** | Osobna kategoria (6A4x) | Specyfikator przy różnych diagnozach |
| **Dysforia płci** | Poza rozdziałem zaburzeń psychicznych | W sekcji „Gender Dysphoria" |
| **Uzależnienie od gier** | Oficjalna kategoria | Brak (tylko „Internet Gaming Disorder" w Sekcji III) |
| **Podejście do diagnozy** | Holotypy kliniczne | Operacyjne progi (listy kryteriów) |
| **Wymiary oceny** | Włączone do głównej klasyfikacji | Głównie Sekcja III |
...
## Ograniczenia i krytyka klasyfikacji
...
Diagnoza ma wymiar społeczny: może stygmatyzować, ale też dawać dostęp do wsparcia. Badania pokazują, że etykieta „zaburzenie" może wpływać na poczucie tożsamości, oczekiwania dotyczące rokowania i decyzje lecznicze.
...
### Diagnoza wieloosiowa (po DSM-IV-TR)

Choć DSM-5 zrezygnował z formalnej wieloosiowości (Oś I–V), w praktyce klinicznej wciąż rekomenduje się ocenę:
- Zaburzenia psychicznego (dawna Oś I)
...
### Znaczenie dla psychoterapii i planowania leczenia

Klasyfikacja diagnostyczna:
- Wyznacza wskazania do konkretnych metod terapeutycznych (np. CBT dla zaburzeń lękowych, DBT dla BPD)
- Determinuje dostęp do refundowanych świadczeń
...
Nieoczywista perspektywa na temat "Klasyfikacje ICD-11 i DSM-5-TR" polega na tym, że objawy nabierają znaczenia dopiero wtedy, gdy analizuje się je w przebiegu, kontekście funkcjonowania i relacji do mechanizmów podtrzymujących.

Dopiero wspólna analiza zagadnień takich jak historia klasyfikacji w psychiatrii, porównanie icd-11 i dsm-5-tr oraz zastosowanie w praktyce psychologicznej pokazuje pełny zakres omawianego zjawiska.

Z tego powodu trafna interpretacja wymaga nie tylko nazwania zjawiska, ale także oceny jego funkcji, ograniczeń i długofalowych skutków dla osoby lub systemu, którego dotyczy.

## Podsumowanie

Temat "Klasyfikacje ICD-11 i DSM-5-TR" pokazuje, że najbardziej użyteczna perspektywa łączy opis symptomów z rozumieniem procesu, różnicowaniem i planowaniem interwencji.


Dopiero wspólna analiza zagadnień takich jak historia klasyfikacji w psychiatrii, porównanie icd-11 i dsm-5-tr oraz zastosowanie w praktyce psychologicznej pokazuje pełny zakres omawianego zjawiska.## Bibliografia
