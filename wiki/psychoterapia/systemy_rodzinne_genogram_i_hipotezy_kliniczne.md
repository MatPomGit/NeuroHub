...
Genogram pozwala zobaczyć, czy bieżący problem (np. lęk separacyjny, kontrola, parentyfikacja) pojawia się w powtarzalnym kontekście relacyjnym. Dzięki temu interwencja może dotyczyć mechanizmu, a nie tylko pojedynczego zachowania.

### 2. Jak budować hipotezy bez nadinterpretacji
