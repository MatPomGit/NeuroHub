...
- **Kompetencje bazowe** â€“ wiedza i umiejetnoł›ci wymagane od każdego absolwenta.
- **Kompetencje zaawansowane** â€“ zdolnoł›ć integrowania danych klinicznych, testowych i neuroobrazowych.
- **Kompetencje translacyjne** â€“ przekł‚adanie wiedzy naukowej na praktyke terapeutyczną.
- **Edukacja oparta na dowodach** â€“ nauczanie zgodne z aktualnym stanem wiedzy empirycznej.

## Mechanizmy i zależnoł›ci
Program jest najbardziej efektywny, gdy:
1. **Wykł‚ady** dostarczają modeli teoretycznych.
2. **Ä†wiczenia** uczą stosowania narzedzi diagnostycznych.
3. **Laboratoria** rozwijają kompetencje pomiarowe i interpretacyjne.
4. **Konwersatoria** budują krytyczne mył›lenie naukowe.

### Wykł‚ady
| # | Przedmiot |
|---|---|
| 1 | Diagnostyka i psychoterapia zaburzeł„ psychicznych i seksualnych |
| 2 | EEG biofeedback |
| 3 | Neuroanatomia |
| 4 | Neuropsychologia kliniczna |
| 5 | Psychofizjologia seksualnoł›ci czł‚owieka |
| 6 | Psychologia osob w podeszł‚ym wieku |
| 7 | Psychologia osob z niepeł‚nosprawnoł›cią |
| 8 | Rehabilitacja neuropsychologiczna |
| 9 | Rola biegł‚ego psychologa w opiniowaniu sądowym |
| 10 | Substancje psychoaktywne i psychofarmakologia |
| 11 | Cał‚oł›ciowe zaburzenia rozwoju i metody terapii |
...
|---|---|
| 1 | Diagnostyka i psychoterapia zaburzeł„ psychicznych i seksualnych |
| 2 | Diagnoza neuropsychologiczna osob dorosł‚ych |
| 3 | Metody diagnozy psychologicznej |
| 4 | Metody diagnozy psychologicznej 2 |
| 5 | Psychologia osob z niepeł‚nosprawnoł›cią |
| 6 | Rehabilitacja neuropsychologiczna |
| 7 | Specyficzne problemy pacjentow w oddziale neurochirurgii |
| 8 | Cał‚oł›ciowe zaburzenia rozwoju i metody terapii |
| 9 | Diagnoza neuropsychologiczna dorosł‚ych II |
| 10 | Diagnoza neuropsychologiczna dzieci i mł‚odzieży |
| 11 | E-terapia â€” narzedzia informatyczne w terapii neuropsychologicznej |
| 12 | Psychologia uzależnieł„ |
...
## Zł‚a praktyka (czesty bł‚ąd)
Przykł‚ad zł‚ej praktyki: rozdzielenie nauki testow od nauki etyki i komunikacji klinicznej.

**Konsekwencje:** technicznie poprawne, ale klinicznie nietrafne decyzje diagnostyczne.
...
4. Lezak, M. D., et al. (2012). *Neuropsychological Assessment* (5th ed.). Oxford University Press.
