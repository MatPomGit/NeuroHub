---
title: Kompulsywne zachowania seksualne
aliases:
  - Zaburzenie kompulsywnych zachowań seksualnych
...
## Wysokie libido a utrata kontroli

Wysokie libido oznacza częste lub silne zainteresowanie seksem. Nie jest zaburzeniem, jeśli zachowania są dobrowolne, elastyczne, bezpieczne i możliwe do pogodzenia z obowiązkami oraz wartościami osoby. Częstotliwość masturbacji, seksu, fantazji czy korzystania z pornografii sama w sobie nie stanowi kryterium diagnostycznego.

W CSBD kluczowy jest powtarzający się wzorzec, w którym zachowanie staje się centralnym punktem życia, próby ograniczenia wielokrotnie zawodzą, zachowanie trwa mimo szkód lub zaniedbywania zdrowia i obowiązków, a czasem jest kontynuowane mimo niewielkiej satysfakcji. Ocenia się przebieg, kontrolę i konsekwencje, nie moralną aprobatę określonej praktyki.

ICD-11 zaznacza, że cierpienie wynikające wyłącznie z moralnej dezaprobaty własnych impulsów lub zachowań seksualnych nie wystarcza do rozpoznania. Konflikt moralny może być jednak realnym źródłem cierpienia i zasługuje na pomoc bez automatycznego przypisywania zaburzenia.

## Jak może utrwalać się wzorzec

Nie istnieje jeden mechanizm wyjaśniający wszystkie przypadki. U części osób zachowanie przynosi krótkotrwałą ulgę w samotności, napięciu, nudzie, złości lub wstydzie. Powtarzane po podobnych sygnałach środowiskowych może stać się nawykiem: wyzwalacz uruchamia oczekiwanie ulgi, zachowanie chwilowo zmniejsza napięcie, a późniejsze konsekwencje ponownie je zwiększają.
...
Ocena powinna uwzględnić depresję, lęk, ADHD, PTSD, używanie substancji oraz inne zachowania kompulsywne. Wzrost aktywności seksualnej może występować w epizodzie maniakalnym lub hipomaniakalnym, po substancjach albo w związku z chorobą neurologiczną czy lekiem; wtedy wymaga leczenia stanu podstawowego. Należy także odróżnić CSBD od obsesji seksualnych w OCD, parafilii i zachowań naruszających zgodę. Rozpoznanie nie usprawiedliwia przemocy ani nie znosi odpowiedzialności.

Ważne jest rozróżnienie szkody funkcjonalnej od samego konfliktu partnerskiego. Rozbieżne potrzeby seksualne, ukrywanie zachowania łamiącego ustalenia oraz utrata kontroli to trzy kwestie, które mogą współistnieć, ale wymagają osobnego opisu.
