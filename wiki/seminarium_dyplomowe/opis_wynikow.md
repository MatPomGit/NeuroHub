...
| Zawiera | Nie zawiera |
|---------|-------------|
| Statystyki opisowe (M, SD, n) | Interpretację ani wyjaśnienia |
| Wyniki testów inferensyjnych | Odniesień do literatury |
| Tabele i wykresy | Spekulacji o przyczynach |
| Odpowiedź na każdą hipotezę | Wniosków z dyskusji |
| Informację o naruszeniach założeń | Emocjonalnych sformułowań |

> **Zasada kciuka:** Wyniki mówią, co się wydarzyło. Dyskusja mówi, co to znaczy.
...
*Stwierdzono istotną, dodatnią korelację między poziomem samooceny a satysfakcją z życia, r(198) = .54, p < .001, 95% CI [.43, .63].*

### ANOVA

*ANOVA wykazała istotny efekt główny stylu przywiązania na poziom lęku, F(2, 297) = 18,34, p < .001, η² = .11. Analizy post-hoc (Tukey HSD) wskazały, że osoby o lękowym stylu przywiązania charakteryzowały się istotnie wyższym lękiem niż osoby unikowe (p = .003) i bezpieczne (p < .001).*

### Regresja liniowa

*Regresja wielokrotna wykazała, że neurotyczność (β = .44, t = 6,12, p < .001) i stres percypowany (β = .31, t = 4,28, p < .001) istotnie przewidywały poziom wypalenia zawodowego, R² = .38, F(2, 247) = 74,2, p < .001.*
...
- Uzupełnione notatką pod tabelą z objaśnieniami skrótów i oznaczeń istotności (* p < .05, ** p < .01)

Przykład nagłówka tabeli:
*Tabela 1*
*Statystyki opisowe i korelacje między zmiennymi głównymi (N = 200)*
...
- Czytelną legendę
- Słupki błędów (SD lub 95% CI) przy danych grupowych
...
Dopiero wspólna analiza zagadnień takich jak rozdział wyników - zasady, wykresy oraz pisanie językiem naukowym pokazuje pełny zakres omawianego zjawiska.## Bibliografia
