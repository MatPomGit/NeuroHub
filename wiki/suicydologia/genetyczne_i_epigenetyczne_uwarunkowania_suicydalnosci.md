...
- **Interakcja gen–środowisko (G×E)** – sytuacja, w której wpływ predyspozycji genetycznej zależy od warunków środowiskowych.

## Część analityczna

### 1. Co wiemy o dziedziczności suicydalności?
Badania rodzinne i bliźniąt sugerują umiarkowaną komponentę dziedziczną zachowań suicydalnych, częściowo niezależną od samego rozpoznania depresji. Oznacza to, że biologiczna podatność może dotyczyć bardziej cech pośrednich (np. impulsywność, nadreaktywność na stres, ból psychiczny) niż „samej decyzji” suicydalnej.

### 2. Genomika wieloczynnikowa
Współczesne wyniki GWAS wskazują na poligeniczny charakter ryzyka: wiele loci o niewielkim efekcie sumuje się w tzw. polygenic risk score (PRS). PRS może mieć zastosowanie badawcze, ale jego użyteczność kliniczna na poziomie pojedynczej osoby pozostaje obecnie ograniczona.

### 3. Epigenetyka: biologiczny „ślad” doświadczenia
Przewlekły stres, trauma i zaniedbanie mogą wpływać na metylację genów związanych z osią HPA, neuroplastycznością i układami neuroprzekaźnikowymi. To jeden z mechanizmów, przez które doświadczenie społeczne „wchodzi pod skórę” i zmienia podatność na kryzys suicydalny.

Istotne zastrzeżenie metodologiczne: część efektów epigenetycznych jest tkankowo specyficzna, zmienna w czasie i trudna do interpretacji przy pomiarze obwodowym (np. z krwi).

### 4. Model integracyjny: od genu do zachowania
Najbardziej użyteczny klinicznie jest model warstwowy:
1. **warstwa genetyczna** – podatność wyjściowa,
2. **warstwa epigenetyczna** – modulacja przez doświadczenie,
3. **warstwa psychologiczna** – style regulacji i poznawcze schematy,
4. **warstwa społeczna** – wsparcie, przemoc, dostęp do pomocy.

Suicydalność pojawia się najczęściej wtedy, gdy kilka warstw ulega jednoczesnej destabilizacji.

## Dobra praktyka i zła praktyka

### Dobra praktyka
W zespole kliniczno-badawczym informacje o obciążeniu rodzinnym i historii urazów są traktowane jako element szerszej oceny ryzyka. Dane biologiczne służą do personalizacji monitorowania i psychoedukacji, ale nie zastępują rozmowy klinicznej ani planu bezpieczeństwa.
