...
# Genogram i przekaz międzypokoleniowy
...
- **Lojalnościowe zobowiązanie** (*invisible loyalty*, Boszormenyi-Nagy) - niewidoczne poczucie lojalności wobec wzorców lub norm rodzinnych, które może kierować decyzjami osoby nawet wbrew jej świadomym intencjom.
- **Skrypt rodzinny** - zbiór ról, narracji i oczekiwań, które rodzina przekazuje swoim członkom: „w naszej rodzinie nie mówimy o emocjach", „kobiety z naszej rodziny są silne i nie proszą o pomoc".
- **Cutoff emocjonalny** - zerwanie kontaktu z rodziną lub jej częścią, które - zdaniem Bowena - nie rozwiązuje niezakończonej więzi emocjonalnej, lecz przenosi jej ciężar na inne relacje.
- **Synchroniczność pokoleniowa** - zjawisko, w którym podobne kryzysy (np. utrata pracy, choroba, rozstanie) pojawiają się w podobnym wieku u przedstawicieli różnych pokoleń tej samej rodziny.

## Analiza mechanizmów

### 1. Jak rysuje się genogram

Konwencja genogramu obejmuje: kwadraty dla mężczyzn, koła dla kobiet, linie poziome oznaczające małżeństwa/związki, linie pionowe oznaczające relacje rodzic–dziecko, a także symbole śmierci, rozstania, adopcji i bliźniąt. Do standardowych oznaczeń dodaje się komentarze dotyczące chorób, zawodów, ważnych dat i zdarzeń. Kolorem lub stylem linii zaznacza się jakość relacji: bliskie, konfliktowe, wyalienowane.

### 2. Wzorce powtarzające się - co ujawnia genogram

Analiza genogramu pozwala wykryć m.in.: powtarzające się diagnozy psychiatryczne w rodzinie, wzorce przedwczesnych śmierci, migracje zbieżne z kryzysami rodzinnymi, schematy wyboru partnerów (np. ciągłe wchodzenie w relacje z osobami uzależnionymi), role stale przypisywane określonym pozycjom (np. pierworodne córki zawsze pełnią funkcję opiekuńczą), a także daty synchroniczne (kryzysy w tym samym wieku co rodzic czy dziadek).

### 3. Przekaz niewerbalny i epigenetyczny

Przekaz międzypokoleniowy dokonuje się przez kanały werbalne (bezpośrednie komunikaty, „mantry" rodzinne) i pozawerbalne (modelowanie zachowań, klimat emocjonalny domu, wzorce przywiązania). Badania epigenetyczne (Yehuda i in., 2016) sugerują, że ekstremalny stres - np. trauma Holokaustu lub głód - może pozostawiać ślady w ekspresji genów przekazywanych potomstwu, choć mechanizmy te są wciąż intensywnie badane i nie należy ich przeceniać.

### 4. Genogram jako interwencja terapeutyczna
