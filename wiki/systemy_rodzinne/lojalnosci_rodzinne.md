...
# Lojalności rodzinne i ukryte zobowiązania
...
- **Relacyjna etyka** (*relational ethics*) - w ujęciu Boszormenyi-Nagya, zasady regulujące sprawiedliwość i równowagę między dawaniem a braniem w relacjach rodzinnych; zaburzenie tej równowagi jest źródłem wielu problemów klinicznych.
- **Rejestr zasług i długów** (*ledger of merits and debts*) - metaforyczny rachunek wzajemnych zobowiązań, krzywd i zasług w systemie rodzinnym, który rodzina nieświadomie prowadzi przez pokolenia.
- **Kontrakt pokoleniowy** - nieformalne, niepisane porozumienie między pokoleniami dotyczące oczekiwań, ról i wzajemnych zobowiązań.
- **Destruktywna uprawnieniowość** (*destructive entitlement*) - przekonanie (świadome lub nie), że skoro samemu doznało się krzywdy, jest się uprawnionym do zadawania jej innym; mechanizm transmisji przemocy między pokoleniami.
- **Uprawnieniowość konstruktywna** (*constructive entitlement*) - świadomość własnych potrzeb i praw, wypływająca z uznania doznanej krzywdy, która nie angażuje się w odwet, lecz w budowanie nowych, sprawiedliwych relacji.

## Analiza mechanizmów

### 1. Jak działają niewidzialne lojalności

Rodzina przekazuje swoim członkom - często nie wprost - oczekiwania dotyczące lojalności: „nie możesz być szczęśliwszy niż twój ojciec", „kobiety w naszej rodzinie poświęcają się dla innych", „nie możesz zdradzić rodziny przez sukces". Osoba, która realizuje własne cele i przekracza te granice, doświadcza przewlekłego poczucia winy lub sabotuje własne sukcesy. Boszormenyi-Nagy twierdził, że takie wzorce mogą działać przez kilka pokoleń.

### 2. Rejestr zasług i długów a sprawiedliwość rodzinna

Każda rodzina prowadzi - nieświadomie - rachunek wzajemnych zobowiązań. Gdy ktoś doświadczył rażącej niesprawiedliwości i nie otrzymał uznania ani zadośćuczynienia, „dług" może zostać przeniesiony na następne pokolenia. Dzieci i wnuki mogą nieświadomie próbować „spłacić" ten dług, albo przejąć rolę ofiary (identyfikując się ze skrzywdzonym przodkiem), albo odtwarzając wzorzec sprawcy (destruktywna uprawnieniowość).

### 3. Zacieranie granicy między lojalnością a szkodą

Paradoks lojalności polega na tym, że wierne wykonywanie jej dyktatu może szkodzić zarówno jednostce, jak i rodzinie. Córka, która rezygnuje z kariery, by opiekować się matką „zgodnie z tradycją", może doświadczać narastającej urazy i wyczerpania, co niszczy dokładnie tę relację, której miała służyć. Boszormenyi-Nagy proponował wyraźne rozróżnienie między lojalnością konstruktywną (opartą na wolnym wyborze i wzajemności) a lojalnością destruktywną (opartą na przymusie, nieświadomości i nierównowadze).

### 4. Terapia kontekstualna w praktyce
...
3. Boszormenyi-Nagy, I. (1987). *Foundations of Contextual Therapy*. Brunner/Mazel.
