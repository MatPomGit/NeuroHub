...
# Terapia narracyjna w kontekście systemu rodzinnego
...
- **Unikalne wyniki** (*unique outcomes*) - momenty w historii rodziny lub jednostki, gdy problem nie miał nad nimi władzy; punkty wyjścia do budowania alternatywnej narracji.
- **Re-autorstwo** (*re-authoring*) - proces tworzenia nowej, alternatywnej opowieści o sobie i rodzinie, opartej na unikalnych wynikach i wartościach, a nie na dominującym problemie.
- **Świadkowanie** (*witnessing*) - obecność i potwierdzenie alternatywnej narracji przez innych (terapeutę, bliskich, grupę); narracja utrwala się przez opowiadanie jej i słyszenie przez innych.
- **Mapy narracyjne** - struktury pytań używanych przez terapeutę narracyjnego: pytania o wpływ problemu, pytania o wartości, pytania o preferowaną tożsamość.

## Analiza mechanizmów

### 1. Jak narracje podtrzymują problemy

Rodziny nie doświadczają surowych faktów - doświadczają zdarzeń przez pryzmat znaczeń, które im nadają. Gdy rodzina mówi „zawsze tak było i zawsze tak będzie", wyklucza z pola widzenia wszystkie momenty, w których było inaczej. Narracja dominująca działa selektywnie: uwypukla zdarzenia zgodne z jej logiką, a marginalizuje te, które jej zaprzeczają. Terapia narracyjna odwraca ten proces: pyta aktywnie o wyjątki.

### 2. Zewnętrznienie jako zmiana językowa i terapeutyczna

„Lęk mnie opanowuje" vs. „Jesteś osobą, która zmaga się z Lękiem" - różnica pozornie semantyczna otwiera zupełnie inną przestrzeń terapeutyczną. Zewnętrznienie pozwala rodzinie stanąć razem przeciwko problemowi, zamiast identyfikować jednego z jej członków jako źródło trudności. W pracy z dziećmi zewnętrznienie jest szczególnie skuteczne: dziecko może walczyć z „Gniewem", który go odwiedza, zamiast być „dzieckiem z problemami z gniewem".

### 3. Re-autorstwo i konstruowanie tożsamości

Gdy unikalne wyniki są zidentyfikowane, terapia narracyjna pyta o ich znaczenie: „Co mówi o Tobie/Waszej rodzinie to, że mimo wszystko potrafiliście się wtedy wesprzeć?" Ten typ pytania zaprasza rodzinę do pisania nowej historii - opartej na wartościach i sile, a nie na problemie. Nowa narracja nie jest fałszywa ani naiwna - jest bardziej złożona i wielowymiarowa niż dominująca historia o dysfunkcji.

### 4. Kultura i społeczeństwo jako źródło narracji
...
3. Morgan, A. (2000). *What is Narrative Therapy? An Easy-to-Read Introduction*. Dulwich Centre Publications.
