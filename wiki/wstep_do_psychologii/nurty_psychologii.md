---
title: Główne nurty psychologii
...
W depresji pacjent uczy się identyfikować automatyczne myśli („Jestem bezwartościowy”), testować ich trafność i budować alternatywne interpretacje oparte na danych z rzeczywistości.

## 6. Podejście biologiczne i neuronauka

Współczesna psychologia korzysta z danych neurobiologicznych, genetycznych i psychofizjologicznych. Nie oznacza to redukcjonizmu: poziom biologiczny jest integrowany z poziomem psychologicznym i społecznym.
...
- psychoedukację,
- trening strategii wykonawczych,
- modyfikacje środowiskowe (np. strukturyzacja zadań),
- a czasem farmakoterapię.

Taki model jest zgodny z biopsychospołecznym rozumieniem zaburzenia.

## 7. Współczesny standard: integracja oparta na dowodach

W praktyce R&D i klinicznej najbardziej użyteczne jest pytanie nie „który nurt jest jedyny słuszny?”, lecz:

1. **Jaki jest problem kliniczny/badawczy?**
2. **Jakie interwencje mają najlepsze dowody dla tej populacji?**
3. **Jak dopasować metodę do osoby, kontekstu i ograniczeń systemowych?**
